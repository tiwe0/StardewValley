...
namespace StardewValley.ItemTypeDefinitions
{
	...
	public class FlooringDataDefinition : BaseItemDataDefinition
	{
		...
		public override bool Exists(string itemId)
		{
			...
			int legacyId;
			if (TryParseLegacyId(itemId, out legacyId))
			{
				return true;
			}
			string id;
			int index;
			ParseStandardId(itemId, out id, out index);
		...
		public override Item CreateItem(ParsedItemData data)
		{
			...
			int legacyId;
			if (TryParseLegacyId(data.ItemId, out legacyId))
			{
				return new Wallpaper(legacyId, true);
			}
			string id;
			int index;
			ParseStandardId(data.ItemId, out id, out index);
