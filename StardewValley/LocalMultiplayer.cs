...
namespace StardewValley
{
	public class LocalMultiplayer
	{
		...
		private static void GenerateDynamicMethodsForStatics()
		{
			...
			staticDefaultMethod = new DynamicMethod("SetStaticVarsToDefault", null, new Type[1] { typeof(object) }, typeof(Game1).Module, true);
			...
			staticSaveMethod = new DynamicMethod("SaveStaticVars", null, new Type[1] { typeof(object) }, typeof(Game1).Module, true);
			...
			staticLoadMethod = new DynamicMethod("LoadStaticVars", null, new Type[1] { typeof(object) }, typeof(Game1).Module, true);
			...
			{
				il.Emit(OpCodes.Ldloc, local.LocalIndex);
				il.Emit(OpCodes.Ldfld, StaticVarHolderType.GetField(field2.DeclaringType.Name + "_" + field2.Name));
				il.Emit(OpCodes.Stsfld, field2);
			}
			il.Emit(OpCodes.Ret);
