...
namespace StardewValley.Menus
{
	public class ChatTextBox : TextBox
	{
		...
		public override void RecieveTextInput(string text)
		{
			...
			{
				ChatSnippet lastSnippet = finalText.Last();
				...
				finalText.Last().message = Program.sdk.FilterDirtyWords(finalText.Last().message);
				updateWidth();
			}
		}
		...
		public override void Draw(SpriteBatch spriteBatch, bool drawShadow = true)
		{
			...
			{
				Game1.drawDialogueBox(base.X - 32, base.Y - 112 + 10, base.Width + 80, base.Height, false, true);
			}
