...
namespace StardewValley.Objects
{
	...
	public class Ring : Item
	{
			...
			: this()
		{
			...
			int seedOffset;
			if (!int.TryParse(itemId, out seedOffset))
			{
				seedOffset = 0;
			}
		...
		public override void drawTooltip(SpriteBatch spriteBatch, ref int x, ref int y, SpriteFont font, float alpha, StringBuilder overrideText)
		{
			...
			{
				Utility.drawWithShadow(spriteBatch, Game1.mouseCursors, new Vector2(x + 16 + 4, y + 16 + 4), new Rectangle(150, 428, 10, 10), Color.White, 0f, Vector2.Zero, 4f, false, 1f);
			...
			if (GetsEffectOfRing("859"))
			{
				Utility.drawWithShadow(spriteBatch, Game1.mouseCursors, new Vector2(x + 16 + 4, y + 16 + 4), new Rectangle(50, 428, 10, 10), Color.White, 0f, Vector2.Zero, 4f, false, 1f);
