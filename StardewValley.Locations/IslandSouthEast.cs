	...
	public class IslandSouthEast : IslandLocation
	{
		...
		public override void UpdateWhenCurrentLocation(GameTime time)
		{
			...
			if (!fishedWalnut && Game1.random.NextDouble() < 0.005)
			{
				...
				temporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64, 64), 150f, 8, 0, new Vector2(1216f, 1344f), false, Game1.random.NextBool(), 0.001f, 0.01f, Color.White, 1f, 0.003f, 0f, 0f));
			}
			if (!MermaidIsHere())
			{
				return;
		...
		public void OnFishWalnut()
		{
			if (!fishedWalnut.Value && Game1.IsMasterGame)
			{
				...
				Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite(28, 100f, 2, 1, tile * 64f, false, false)
				{
