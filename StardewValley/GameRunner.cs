...
namespace StardewValley
{
	public class GameRunner : Game
	{
		...
		public GameRunner()
		{
			...
			Game1.graphics.PreparingDeviceSettings += delegate([System.Runtime.CompilerServices.Nullable(2)] object sender, PreparingDeviceSettingsEventArgs args)
			{
			...
			base.Exiting += delegate([System.Runtime.CompilerServices.Nullable(2)] object sender, EventArgs args)
			{
		...
		public static void LoadInstance(InstanceGame instance, bool force = false)
		{
			...
			if ((force || LocalMultiplayer.IsLocalMultiplayer()) && instance.staticVarHolder != null)
			{
				...
				Options options;
				if (Game1.player != null && (bool)Game1.player.isCustomized && Game1.splitscreenOptions.TryGetValue(Game1.player.UniqueMultiplayerID, out options))
				{
