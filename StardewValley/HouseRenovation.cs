			...
			foreach (string key in data.Keys)
			{
				...
				using (List<RenovationValue>.Enumerator enumerator2 = renovation_data.RenovateActions.GetEnumerator())
				{
					while (enumerator2.MoveNext())
					{
						...
						_003C_003Ec__DisplayClass47_.action_data = enumerator2.Current;
						if (_003C_003Ec__DisplayClass47_.action_data.Type == "Value")
						{
							try
							{
								_003C_003Ec__DisplayClass47_2 _003C_003Ec__DisplayClass47_2 = new _003C_003Ec__DisplayClass47_2();
								_003C_003Ec__DisplayClass47_2.CS_0024_003C_003E8__locals1 = _003C_003Ec__DisplayClass47_;
								_003C_003Ec__DisplayClass47_2.field = (NetInt)farmhouse.GetType().GetField(_003C_003Ec__DisplayClass47_2.CS_0024_003C_003E8__locals1.action_data.Key).GetValue(farmhouse);
								if (_003C_003Ec__DisplayClass47_2.field == null)
								{
									valid = false;
									break;
								}
								renovation.onRenovation = (Action<HouseRenovation, int>)Delegate.Combine(renovation.onRenovation, new Action<HouseRenovation, int>(_003C_003Ec__DisplayClass47_2._003CGetAvailableRenovations_003Eg__OnRenovation_007C1));
								continue;
							}
							catch (Exception)
							{
						...
						if (_003C_003Ec__DisplayClass47_.action_data.Type == "Mail")
						{
							renovation.onRenovation = (Action<HouseRenovation, int>)Delegate.Combine(renovation.onRenovation, new Action<HouseRenovation, int>(_003C_003Ec__DisplayClass47_._003CGetAvailableRenovations_003Eg__OnRenovation_007C0));
						}
					}
				}
				if (valid)
