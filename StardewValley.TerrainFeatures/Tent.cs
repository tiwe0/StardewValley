...
namespace StardewValley.TerrainFeatures
{
	public class Tent : LargeTerrainFeature
	{
		...
		public override void onDestroy()
		{
			...
			for (int i = 0; i < 16; i++)
			{
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(112 + Game1.random.Next(4) * 8, 248, 8, 8), 9999f, 1, 1, Utility.getRandomPositionInThisRectangle(getBoundingBox(), Game1.random), false, false, tilePosition.Y * 64f / 10000f, 0.02f, Color.White, 4f, 0f, 0f, 0f)
				{
