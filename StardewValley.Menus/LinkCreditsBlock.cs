...
namespace StardewValley.Menus
{
	internal class LinkCreditsBlock : ICreditsBlock
	{
		...
		{
			SpriteText.drawString(b, text, topLeftX, topLeftY, 999999, widthToOccupy, 99999, 1f, 0.88f, false, -1, "", currentlyHovered ? SpriteText.color_Green : SpriteText.color_Cyan);
