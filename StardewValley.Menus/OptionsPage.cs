...
namespace StardewValley.Menus
{
	public class OptionsPage : IClickableMenu
	{
			...
			: base(x, y, width, height)
		{
			...
			_003C_003Ec__DisplayClass13_.index = options.Count;
			if (!Game1.game1.CanZoomScreenshots())
			{
				OptionsButton btn = new OptionsButton(Game1.content.LoadString("Strings\\UI:OptionsPage_ScreenshotHeader").Replace(":", ""), _003C_003Ec__DisplayClass13_._003C_002Ector_003Eg__TakeScreenshot_007C2);
		...
		private void waitForServerConnection(Action onConnection)
		{
			...
			_003C_003Ec__DisplayClass15_.onConnection = onConnection;
			if (Game1.server != null)
			{
				if (Game1.server.connected())
				{
					_003C_003Ec__DisplayClass15_.onConnection();
					return;
				}
				_003C_003Ec__DisplayClass15_.thisMenu = Game1.activeClickableMenu;
				Game1.activeClickableMenu = new ServerConnectionDialog(_003C_003Ec__DisplayClass15_._003CwaitForServerConnection_003Eg__OnConfirm_007C1, _003C_003Ec__DisplayClass15_._003CwaitForServerConnection_003Eg__OnClose_007C0);
			}
		}
		...
		private void showInviteCode()
		{
			...
			CS_0024_003C_003E8__locals0.thisMenu = Game1.activeClickableMenu;
			waitForServerConnection(delegate
			{
				Game1.activeClickableMenu = new InviteCodeDialog(Game1.server.getInviteCode(), CS_0024_003C_003E8__locals0._003CshowInviteCode_003Eg__OnClose_007C1);
			});
		}
