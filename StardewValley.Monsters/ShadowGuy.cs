...
namespace StardewValley.Monsters
{
	public class ShadowGuy : Monster
	{
		...
		public void castTeleport()
		{
			...
			{
				teleporting = true;
				teleportationPath = Utility.GetPointsOnLine((int)curTile.X, (int)curTile.Y, (int)possiblePoint.X, (int)possiblePoint.Y, true).GetEnumerator();
				coolDown = 20;
			}
		}
		...
		public override void behaviorAtGameTick(GameTime time)
		{
			...
			if (teleporting)
			{
				...
				if (coolDown <= 0)
				{
					...
					{
						Game1.multiplayer.broadcastSprites(base.currentLocation, new TemporaryAnimatedSprite(Sprite.textureName, Sprite.SourceRect, base.Position, false, 0.04f, Color.White));
