...
namespace StardewValley.ItemTypeDefinitions
{
	...
	public class ObjectDataDefinition : BaseItemDataDefinition
	{
		...
		public override ParsedItemData GetData(string itemId)
		{
			...
			return new ParsedItemData(this, itemId, data.SpriteIndex, data.Texture ?? "Maps\\springobjects", data.Name, TokenParser.ParseText(data.DisplayName), TokenParser.ParseText(data.Description), category, data.Type, data, false, data.ExcludeFromRandomSale);
		}
		...
		public virtual Object CreateFlavoredItem(Object.PreserveType preserveType, Object ingredient)
		{
			...
			case Object.PreserveType.AgedRoe:
				return CreateFlavoredAgedRoe(ingredient);
			case Object.PreserveType.Honey:
				return CreateFlavoredHoney(ingredient);
			case Object.PreserveType.Jelly:
				return CreateFlavoredJelly(ingredient);
			case Object.PreserveType.Juice:
				return CreateFlavoredJuice(ingredient);
			case Object.PreserveType.Pickle:
				return CreateFlavoredPickle(ingredient);
			case Object.PreserveType.Roe:
				return CreateFlavoredRoe(ingredient);
			case Object.PreserveType.Wine:
				return CreateFlavoredWine(ingredient);
			case Object.PreserveType.Bait:
				return CreateFlavoredBait(ingredient);
			case Object.PreserveType.DriedFruit:
				return CreateFlavoredDriedFruit(ingredient);
			case Object.PreserveType.DriedMushroom:
				return CreateFlavoredDriedMushroom(ingredient);
			case Object.PreserveType.SmokedFish:
				return CreateFlavoredSmokedFish(ingredient);
			default:
				return null;
			}
		}
