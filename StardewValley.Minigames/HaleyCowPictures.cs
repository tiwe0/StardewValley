...
namespace StardewValley.Minigames
{
	public class HaleyCowPictures : IMinigame
	{
		...
		public HaleyCowPictures()
		{
			...
			pictures = ((Game1.season == Season.Winter) ? content.Load<Texture2D>("LooseSprites\\cowPhotosWinter") : content.Load<Texture2D>("LooseSprites\\cowPhotos"));
		...
		public void draw(SpriteBatch b)
		{
			...
			if (numberOfPhotosSoFar > 1)
			{
				...
				Game1.player.FarmerRenderer.draw(b, Game1.player, 6, centerOfScreen + new Vector2(-208f, -248f) + new Vector2(16f, 16f) + new Vector2(64f, 66f) * 4f, 0.11f, true);
			...
			if (numberOfPhotosSoFar > 2)
			{
				...
				Game1.player.FarmerRenderer.draw(b, Game1.player, 89, centerOfScreen + new Vector2(-208f, -248f) - new Vector2(24f, 8f) + new Vector2(55f, 66f) * 4f, 0.21f, true);
