	...
	public class FarmhandMenu : LoadGameMenu
	{
		public class FarmhandSlot : SaveFileSlot
		{
				...
				: base(menu, farmer, null)
			{
				...
				if (Program.sdk.Networking != null)
				{
					...
					if (local_user_id != "" && farmer != null && farmer.userID.Value != "" && local_user_id != farmer.userID)
					{
		...
		public override void receiveLeftClick(int x, int y, bool playSound = true)
		{
			for (int i = 0; i < slotButtons.Count; i++)
			{
				...
				{
					FarmhandSlot slot = MenuSlots[currentItemIndex + i] as FarmhandSlot;
		...
		public override void performHoverAction(int x, int y)
		{
			...
			for (int i = 0; i < slotButtons.Count; i++)
			{
				...
				{
					FarmhandSlot farmhandSlot = MenuSlots[currentItemIndex + i] as FarmhandSlot;
		...
		private void loadClientOptions()
		{
			if (LocalMultiplayer.IsLocalMultiplayer())
			{
				...
				_003CloadClientOptions_003Eg__LoadOptions_007C16_0();
			}
			else
			{
				Task task = new Task(_003CloadClientOptions_003Eg__LoadOptions_007C16_0);
