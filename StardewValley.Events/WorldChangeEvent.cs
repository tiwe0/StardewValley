...
namespace StardewValley.Events
{
	public class WorldChangeEvent : BaseFarmEvent
	{
		...
		private void obliterateJojaMartDoor()
		{
			...
			for (int i = 0; i < 16; i++)
			{
				town.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(372, 1956, 10, 10), new Vector2(96f, 50f) * 64f + new Vector2(Game1.random.Next(-32, 64), 0f), false, 0.002f, Color.Gray)
				{
					alpha = 0.75f,
			...
			town.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(372, 1956, 10, 10), new Vector2(96f, 50f) * 64f + new Vector2(Game1.random.Next(-32, 64), 0f), false, 0f, Color.Gray)
			{
				alpha = 0.01f,
				interval = 99999f,
				layerDepth = 0.9f,
		...
		public void resetForPlayerEntry(Point targetTile)
		{
			...
			case 15:
			{
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(200, 89, 28, 32), new Vector2(39f, 32f) * 64f, false, 0f, Color.White)
				{
					animationLength = 2,
					interval = 700f,
				...
				{
					location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(184, 104, 14, 15), new Vector2(39 + j % 3, 34.1f + (float)(j / 3) * 0.5f) * 64f, false, 0f, Color.White)
					{
						animationLength = 1,
						interval = 700f,
						totalNumberOfLoops = 999,
						layerDepth = 0.1f + (float)j * 0.01f,
						scale = 4f
					});
				}
				...
				for (int i = 0; i < 20; i++)
				{
					...
					TemporaryAnimatedSprite parrot = new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(48 + Game1.random.Next(2) * 72, 96, 24, 24), start_point, false, 0f, Color.White)
					{
			...
			case 13:
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("Characters\\Willy", new Rectangle(0, 320, 16, 32), 120f, 3, 999, new Vector2(412f, 332f), false, false)
				{
					pingPong = true,
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("Characters\\Robin", new Rectangle(0, 192, 16, 32), 140f, 4, 999, new Vector2(704f, 256f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
			...
			case 12:
			{
				...
				{
					location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", lightningSourceRect, 9999f, 1, 999, drawPosition, false, Game1.random.NextBool(), (strikePosition.Y + 32f) / 10000f + 0.001f, 0.025f, Color.White, 4f, 0f, 0f, 0f)
					{
						light = true,
						lightRadius = 2f,
			...
			case 10:
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1349, 19, 28), 150f, 5, 999, new Vector2(3760f, 1056f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1377, 19, 28), 140f, 5, 999, new Vector2(2948f, 1088f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(390, 1405, 18, 32), 1000f, 2, 999, new Vector2(3144f, 1280f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
			...
			case 11:
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(6080f, 2880f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
			...
			case 0:
			{
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1349, 19, 28), 150f, 5, 999, new Vector2((targetTile.X - 3) * 64 + 8, (targetTile.Y - 1) * 64 - 32), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1377, 19, 28), 140f, 5, 999, new Vector2((targetTile.X + 3) * 64 - 16, (targetTile.Y - 2) * 64), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(390, 1405, 18, 32), 1000f, 2, 999, new Vector2(targetTile.X * 64 + 8, (targetTile.Y - 4) * 64), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				...
				TemporaryAnimatedSprite hole = new TemporaryAnimatedSprite("Buildings\\Greenhouse", new Rectangle(25, 133, 31, 19), 99999f, 1, 999, new Vector2(targetTile.X * 64, (targetTile.Y - 1) * 64 - 64) + new Vector2(-23f, 53f) * 4f, false, false)
				{
					scale = 4f,
					layerDepth = depthY + 0.0008f
				};
				location.temporarySprites.Add(hole);
				TemporaryAnimatedSprite raccoon = new TemporaryAnimatedSprite("Characters\\raccoon", new Rectangle(0, 32, 32, 32), 99999f, 1, 999, new Vector2(targetTile.X * 64, (targetTile.Y - 1) * 64 - 64) + new Vector2(-20f, 40f) * 4f, false, false)
				{
					scale = 4f,
					shakeIntensity = 1f,
			...
			case 1:
			{
				...
				sound = "junimoMeep1";
				Game1.currentLightSources.Add(new LightSource(4, new Vector2(targetTile.X, targetTile.Y) * 64f, 4f, Color.DarkGoldenrod, LightSource.LightContext.None, 0L));
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(targetTile.X * 64, (targetTile.Y - 1) * 64 - 64), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				TemporaryAnimatedSprite hole2 = new TemporaryAnimatedSprite("Buildings\\Greenhouse", new Rectangle(25, 133, 31, 19), 99999f, 1, 999, new Vector2(targetTile.X * 64, (targetTile.Y - 1) * 64 - 64) + new Vector2(-23f, 53f) * 4f, false, false)
				{
					scale = 4f,
					layerDepth = depthY2 + 0.0008f
				};
				location.temporarySprites.Add(hole2);
				TemporaryAnimatedSprite raccoon2 = new TemporaryAnimatedSprite("Characters\\raccoon", new Rectangle(0, 32, 32, 32), 99999f, 1, 999, new Vector2(targetTile.X * 64, (targetTile.Y - 1) * 64 - 64) + new Vector2(-20f, 40f) * 4f, false, false)
				{
					scale = 4f,
					shakeIntensity = 1f,
			...
			case 6:
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1349, 19, 28), 150f, 5, 999, new Vector2(1856f, 480f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1377, 19, 28), 140f, 5, 999, new Vector2(1280f, 512f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(390, 1405, 18, 32), 1500f, 2, 999, new Vector2(1544f, 192f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				...
				break;
			case 7:
				Utility.addSprinklesToLocation(location, targetTile.X, targetTile.Y, 9, 4, 10000, 200, Color.LightCyan, null, true);
				Utility.addStarsAndSpirals(location, targetTile.X, targetTile.Y, 9, 4, 15000, 150, Color.White);
				sound = "junimoMeep1";
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(1280f, 640f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(1408f, 640f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(1536f, 640f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(1664f, 640f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				break;
			case 2:
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1377, 19, 28), 100f, 5, 999, new Vector2(6656f, 5024f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1406, 22, 26), 700f, 2, 999, new Vector2(6888f, 5014f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(390, 1405, 18, 32), 1500f, 2, 999, new Vector2(6792f, 4864f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(335, 1410, 21, 21), 999f, 1, 9999, new Vector2(6912f, 5136f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
			...
			case 3:
				...
				Game1.player.activeDialogueEvents.TryAdd("cc_Minecart", 7);
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(6656f, 5056f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(6912f, 5056f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				break;
			case 4:
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(383, 1378, 28, 27), 400f, 2, 999, new Vector2(5504f, 1632f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					motion = new Vector2(0.5f, 0f)
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1406, 22, 26), 350f, 2, 999, new Vector2(6272f, 1632f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(358, 1415, 31, 20), 999f, 1, 9999, new Vector2(5888f, 1648f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(335, 1410, 21, 21), 999f, 1, 9999, new Vector2(6400f, 1648f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(390, 1405, 18, 32), 1500f, 2, 999, new Vector2(5824f, 1584f), false, false)
				{
					scale = 4f,
					layerDepth = 0.8f
				});
			...
			case 5:
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(5824f, 1648f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(6336f, 1648f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				break;
			case 8:
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(288, 1377, 19, 28), 100f, 5, 999, new Vector2(2880f, 288f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(387, 1340, 17, 37), 50f, 2, 99999, new Vector2(3040f, 160f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					yPeriodic = true,
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(335, 1410, 21, 21), 999f, 1, 9999, new Vector2(2816f, 368f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(390, 1405, 18, 32), 1500f, 2, 999, new Vector2(3200f, 368f), false, false)
				{
					scale = 4f,
					layerDepth = 1f
				});
			...
			case 9:
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(2880f, 368f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(294, 1432, 16, 16), 300f, 4, 999, new Vector2(3200f, 368f), false, false)
				{
					scale = 4f,
					layerDepth = 1f,
					xPeriodic = true,
			...
			case 14:
			{
				...
				Game1.currentLightSources.Add(new LightSource(4, new Vector2(targetTile.X, targetTile.Y) * 64f, 4f, Color.DarkGoldenrod, LightSource.LightContext.None, 0L));
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(0, 0, 24, 24), new Vector2(14f, 4.5f) * 64f, false, 0f, Color.White)
				{
					id = 777,
					scale = 4f,
					totalNumberOfLoops = 99999,
				...
				for (int k = 0; k < 16; k++)
				{
					...
					TemporaryAnimatedSprite t = new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Rectangle(49 + 16 * Game1.random.Next(3), 229, 16, 6), Utility.getRandomPositionInThisRectangle(rect, Game1.random) * 64f, Game1.random.NextBool(), 0f, Color.White)
					{
						...
						delayBeforeAnimationStart = 4000 + k * 250
					};
					...
					t = new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Rectangle(49 + 16 * Game1.random.Next(3), 229, 16, 6), Utility.getRandomPositionInThisRectangle(rect, Game1.random) * 64f, Game1.random.NextBool(), 0f, Color.White)
					{
						...
						layerDepth = 1f,
						drawAboveAlwaysFront = true,
						delayBeforeAnimationStart = 4500 + k * 250,
						yStopCoordinate = (rect.Bottom + 1) * 64
					};
					t.reachedStopCoordinate = t.bounce;
					location.TemporarySprites.Add(t);
				...
				for (int l = 0; l < 20; l++)
				{
					Vector2 start_point2 = new Vector2(Utility.RandomFloat(13f, 19f), 0f) * 64f;
					float x_offset = 1024f - start_point2.X;
					TemporaryAnimatedSprite parrot2 = new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(48 + Game1.random.Next(2) * 72, Game1.random.Next(2) * 48, 24, 24), start_point2, false, 0f, Color.White)
					{
						...
						layerDepth = 1f,
						drawAboveAlwaysFront = true,
						delayBeforeAnimationStart = 3500 + l * 250,
						alpha = 0f,
						alphaFade = -0.1f
					};
					DelayedAction.playSoundAfterDelay("batFlap", 3500 + l * 250);
					parrot2.reachedStopCoordinateSprite = ParrotBounce;
					location.temporarySprites.Add(parrot2);
				}
		...
		public virtual void ParrotFlyAway()
		{
			...
			location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(48, 0, 24, 24), new Vector2(14f, 4.5f) * 64f, false, 0f, Color.White)
			{
				id = 777,
				scale = 4f,
				totalNumberOfLoops = 99999,
