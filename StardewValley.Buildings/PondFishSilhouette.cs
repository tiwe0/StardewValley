...
namespace StardewValley.Buildings
{
	public class PondFishSilhouette
	{
		...
		public void Draw(SpriteBatch b)
		{
			...
			b.Draw(itemData.GetTexture(), Game1.GlobalToLocal(Game1.viewport, draw_position), itemData.GetSourceRect(), Color.Black * transparency, angle, origin, 4f * draw_scale, effect, position.Y / 10000f + 1E-06f);
		}
