	...
	public class TailorRecipeListTool : IClickableMenu
	{
		...
		public override void receiveLeftClick(int x, int y, bool playSound = true)
		{
			foreach (ClickableTextureComponent component in recipeComponents)
			{
				...
				try
				{
					...
					Color color;
					if (clothing != null && _recipeColors.TryGetValue(component.name, out color))
					{
		...
		public override void draw(SpriteBatch b)
		{
			...
			foreach (ClickableTextureComponent component in recipeComponents)
			{
				...
				{
					drawHorizontalPartition(b, component.bounds.Bottom - 32, true);
					...
					Color color;
					if (_recipeColors.TryGetValue(component.name, out color))
					{
						int size = 24;
