...
namespace StardewValley.Locations
{
	public class IslandFarmCave : IslandLocation
	{
		...
		protected override void resetLocalState()
		{
			...
			gourmand = new NPC(new AnimatedSprite("Characters\\Gourmand", 0, 32, 32), new Vector2(4f, 4f) * 64f, "IslandFarmCave", 2, "Gourmand", false, Game1.content.Load<Texture2D>("Portraits\\SafariGuy"));
