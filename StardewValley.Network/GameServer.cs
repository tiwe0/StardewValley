...
namespace StardewValley.Network
{
	public class GameServer : IGameServer, IBandwidthMonitor
	{
		...
		{
			return servers.Select((Server s) => s.canAcceptIPConnections()).Aggregate(false, (bool a, bool b) => a || b);
		}

		public bool canOfferInvite()
		{
			return servers.Select((Server s) => s.canOfferInvite()).Aggregate(false, (bool a, bool b) => a || b);
		}
		...
		public void checkFarmhandRequest(string userId, string connectionId, NetFarmerRoot farmer, Action<OutgoingMessage> sendMessage, Action approve)
		{
			...
			_003C_003Ec__DisplayClass42_.farmer = farmer;
			_003C_003Ec__DisplayClass42_._003C_003E4__this = this;
			_003C_003Ec__DisplayClass42_.connectionId = connectionId;
			_003C_003Ec__DisplayClass42_.userId = userId;
			_003C_003Ec__DisplayClass42_.sendMessage = sendMessage;
			_003C_003Ec__DisplayClass42_.approve = approve;
			if (_003C_003Ec__DisplayClass42_.farmer.Value == null)
			{
				rejectFarmhandRequest(_003C_003Ec__DisplayClass42_.userId, _003C_003Ec__DisplayClass42_.connectionId, _003C_003Ec__DisplayClass42_.farmer, _003C_003Ec__DisplayClass42_.sendMessage);
				return;
			}
			_003C_003Ec__DisplayClass42_.id = _003C_003Ec__DisplayClass42_.farmer.Value.UniqueMultiplayerID;
			if (isGameAvailable())
			{
				_003CcheckFarmhandRequest_003Eg__Check_007C42_0(ref _003C_003Ec__DisplayClass42_);
			}
			else
			{
				sendAvailableFarmhands(_003C_003Ec__DisplayClass42_.userId, _003C_003Ec__DisplayClass42_.connectionId, _003C_003Ec__DisplayClass42_.sendMessage);
			}
		}
