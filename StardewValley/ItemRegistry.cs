...
namespace StardewValley
{
	...
	public static class ItemRegistry
	{
		...
		public static void AddTypeDefinition(IItemDataDefinition definition)
		{
			...
			_003C_003Ec__DisplayClass17_.definition = definition;
			if (_003C_003Ec__DisplayClass17_.definition == null)
			{
				throw new ArgumentNullException("definition");
			}
			string identifier = _003C_003Ec__DisplayClass17_.definition.Identifier;
			if (string.IsNullOrWhiteSpace(identifier))
			{
				throw _003CAddTypeDefinition_003Eg__GetException_007C17_0("it has no identifier", ref _003C_003Ec__DisplayClass17_);
			}
			if (identifier.Length < 2 || identifier[0] != '(' || identifier[identifier.Length - 1] != ')')
			{
				throw _003CAddTypeDefinition_003Eg__GetException_007C17_0("its identifier must start with '(' and end with ')'", ref _003C_003Ec__DisplayClass17_);
			}
			if (identifier.IndexOf('(', 1) != -1 || identifier.IndexOf(')') != identifier.Length - 1)
			{
				throw _003CAddTypeDefinition_003Eg__GetException_007C17_0("its identifier can't contain '(' or ')' except as the first and last character respectively", ref _003C_003Ec__DisplayClass17_);
			}
			if (IdentifierLookup.ContainsKey(identifier))
			{
				throw _003CAddTypeDefinition_003Eg__GetException_007C17_0("its identifier is already registered", ref _003C_003Ec__DisplayClass17_);
			}
			ItemTypes.Add(_003C_003Ec__DisplayClass17_.definition);
			IdentifierLookup[identifier] = _003C_003Ec__DisplayClass17_.definition;
			ResetCache();
		}
		...
		public static IItemDataDefinition GetTypeDefinition(string identifier)
		{
			...
			IItemDataDefinition type;
			if (!IdentifierLookup.TryGetValue(identifier, out type))
			{
				return null;
			}
			return type;
		...
		{
			IItemDataDefinition typeDefinition = GetTypeDefinition(identifier);
		...
		public static TItemDataDefinition RequireTypeDefinition<TItemDataDefinition>(string identifier) where TItemDataDefinition : class, IItemDataDefinition
		{
			...
			TItemDataDefinition obj = definition as TItemDataDefinition;
			if (obj == null)
			{
		...
		public static ItemMetadata GetMetadata(string itemId)
		{
			...
			if (!CachedItems.TryGetValue(itemId, out metadata))
			{
				if (itemId[0] == '(')
				{
					int splitIndex = itemId.IndexOf(')') + 1;
