				...
				if (shotsLeft > 0)
				{
					if (nextShot > 0f)
					{
						...
						if (nextShot <= 0f)
						{
							...
							BasicProjectile projectile = new BasicProjectile(base.DamageToFarmer, firedProjectile, 0, 0, 0f, shot_velocity.X, shot_velocity.Y, base.Position, null, null, null, false, false, base.currentLocation, this);
