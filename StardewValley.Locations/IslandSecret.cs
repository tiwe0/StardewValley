	...
	public class IslandSecret : IslandLocation
	{
		...
		public override bool performAction(string[] action, Farmer who, Location tileLocation)
		{
			if (ArgUtility.Get(action, 0) == "BananaShrine")
			{
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("Maps\\springobjects", new Microsoft.Xna.Framework.Rectangle(304, 48, 16, 16), new Vector2(tileLocation.X, tileLocation.Y - 1) * 64f, false, 0f, Color.White)
					{
						id = 888,
						scale = 4f,
						layerDepth = ((float)tileLocation.Y + 1.2f) * 64f / 10000f
					});
					temporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\critters", new Microsoft.Xna.Framework.Rectangle(32, 352, 32, 32), 400f, 2, 999, new Vector2(15.5f, 20f) * 64f, false, false, 0.128f, 0f, Color.White, 4f, 0f, 0f, 0f)
					{
						id = 777,
