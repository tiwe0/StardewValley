...
namespace StardewValley.Locations
{
	public class AbandonedJojaMart : GameLocation
	{
		...
		{
			bool[] bundles;
			if (Game1.netWorldState.Value.Bundles.TryGetValue(36, out bundles) && !bundleMutex.IsLocked() && !Game1.eventUp && !Game1.MasterPlayer.hasOrWillReceiveMail("ccMovieTheater"))
			{
				bool[] array = bundles;
