...
namespace StardewValley.BellsAndWhistles
{
	public class Lexicon
	{
		...
		public static string getRandomPositiveAdjectiveForEventOrPerson(NPC n = null)
		{
			...
			if (n != null && n.Age != 0)
			{
				choices = Game1.content.LoadString("Strings\\Lexicon:RandomPositiveAdjective_Child").Split('#');
			}
			else
			{
				switch (n?.Gender)
				{
				case Gender.Male:
					choices = Game1.content.LoadString("Strings\\Lexicon:RandomPositiveAdjective_AdultMale").Split('#');
					break;
				case Gender.Female:
					choices = Game1.content.LoadString("Strings\\Lexicon:RandomPositiveAdjective_AdultFemale").Split('#');
					break;
				default:
					choices = Game1.content.LoadString("Strings\\Lexicon:RandomPositiveAdjective_PlaceOrEvent").Split('#');
					break;
				}
			}
