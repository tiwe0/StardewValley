...
namespace StardewValley.Menus
{
	public class SaveGameMenu : IClickableMenu, IDisposable
	{
		...
		public SaveGameMenu()
		{
			saveText = new SparklingText(Game1.dialogueFont, Game1.content.LoadString("Strings\\StringsFromCSFiles:SaveGameMenu.cs.11378"), Color.LimeGreen, Color.Black * 0.001f, false, 0.1, 1500, 32);
		...
		public override void draw(SpriteBatch b)
		{
			...
			else if (margin < 0 || Game1.IsClient)
			{
				if (Game1.IsMultiplayer)
				{
					...
					b.DrawString(Game1.dialogueFont, _stringBuilder, txtpos, Color.White);
