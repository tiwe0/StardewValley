	...
	public class BuildingPaintMenu : IClickableMenu
	{
		...
		public class ColorSliderPanel
		{
			...
			public virtual Rectangle Reposition(Rectangle start_rect)
			{
				...
				{
				case 0:
					hueSlider.SetValue(buildingPaintMenu.colorTarget.Color1Hue, true);
					break;
				case 1:
					hueSlider.SetValue(buildingPaintMenu.colorTarget.Color2Hue, true);
					break;
				default:
					hueSlider.SetValue(buildingPaintMenu.colorTarget.Color3Hue, true);
					break;
				}
				rectangle.Height += 24;
				...
				{
				case 0:
					saturationSlider.SetValue(buildingPaintMenu.colorTarget.Color1Saturation, true);
					break;
				case 1:
					saturationSlider.SetValue(buildingPaintMenu.colorTarget.Color2Saturation, true);
					break;
				default:
					saturationSlider.SetValue(buildingPaintMenu.colorTarget.Color3Saturation, true);
					break;
				}
				rectangle.Height += 24;
				...
				{
				case 0:
					lightnessSlider.SetValue(buildingPaintMenu.colorTarget.Color1Lightness, true);
					break;
				case 1:
					lightnessSlider.SetValue(buildingPaintMenu.colorTarget.Color2Lightness, true);
					break;
				default:
					lightnessSlider.SetValue(buildingPaintMenu.colorTarget.Color3Lightness, true);
					break;
				}
				rectangle.Height += 24;
				...
				{
					hueSlider.SetValue(hueSlider.min, true);
					saturationSlider.SetValue(saturationSlider.max, true);
					lightnessSlider.SetValue((lightnessSlider.min + lightnessSlider.max) / 2, true);
				}
			...
			public Color GetColorForValues(float hue_slider, float saturation_slider)
			{
				...
				int green;
				int blue;
				Utility.HSLtoRGB(hue_slider, saturation_slider / 100f, 0.5, out red, out green, out blue);
			...
			public Color GetColorForValues(float hue_slider, float saturation_slider, float lightness_slider)
			{
				...
				int green;
				int blue;
				Utility.HSLtoRGB(hue_slider, saturation_slider / 100f, Utility.Lerp(0.25f, 0.5f, (lightness_slider - (float)lightnessSlider.min) / (float)(lightnessSlider.max - lightnessSlider.min)), out red, out green, out blue);
				return new Color((byte)red, green, blue);
			}
