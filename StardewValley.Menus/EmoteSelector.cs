	...
	public class EmoteSelector : IClickableMenu
	{
			...
			: base(Game1.uiViewport.Width / 2 - (800 + IClickableMenu.borderWidth * 2) / 2, Game1.uiViewport.Height / 2 - (600 + IClickableMenu.borderWidth * 2) / 2 - 64, 800 + IClickableMenu.borderWidth * 2, 600 + IClickableMenu.borderWidth * 2 + 64)
		{
			...
			for (int i = 0; i < Farmer.EMOTES.Length; i++)
			{
				...
				{
					ClickableTextureComponent component = new ClickableTextureComponent(new Rectangle(0, 0, 80, 68), emoteTexture, EmoteMenu.GetEmoteNonBubbleSpriteRect(i), 4f, true)
					{
		...
		{
			IClickableMenu.drawTextureBox(b, Game1.menuTexture, new Rectangle(0, 256, 60, 60), xPositionOnScreen - 128 - 8, yPositionOnScreen + 128 - 8, 192, 164, Color.White, 1f, false);
			...
			foreach (ClickableTextureComponent component in emoteButtons)
			{
				...
				{
					IClickableMenu.drawTextureBox(b, Game1.menuTexture, new Rectangle(64, 320, 60, 60), component.bounds.X + 64 + 8, component.bounds.Y + 8, scrollView.Width / 3 - 64 - 16, component.bounds.Height - 16, Color.White, 1f, false);
