	...
	public class TailoringMenu : MenuWithInventory
	{
		...
		public override void receiveLeftClick(int x, int y, bool playSound = true)
		{
			...
			foreach (ClickableComponent c in equipmentIcons)
			{
				...
				case "Shirt":
				{
					...
					{
						Item old_item3 = Game1.player.shirtItem.Value;
			...
			if (Game1.GetKeyboardState().IsKeyDown(Keys.LeftShift) && oldHeldItem != base.heldItem && base.heldItem != null)
			{
				if (!(base.heldItem.QualifiedItemId == "(O)428"))
				{
					...
					if (clothing == null || !clothing.dyeable)
					{
		...
		public Item CraftItem(Item left_item, Item right_item)
		{
			...
			if (recipe != null)
			{
				...
				item = ItemRegistry.Create(crafted_item_id);
					...
					else
					{
						...
						if (!(item is Hat))
						{
							...
							if (clothing == null)
							{
								...
								if (crafted_object != null && crafted_object.QualifiedItemId == "(O)71")
								{
