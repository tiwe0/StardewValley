	...
	public class CarpenterMenu : IClickableMenu
	{
		...
		public class BlueprintEntry
		{
			...
			public string GetDisplayNameForBuildingToUpgrade()
			{
				...
				if (!IsUpgrade || !Game1.buildingData.TryGetValue(Data.BuildingToUpgrade, out otherData))
				{
					return null;
				}
		...
		private void resetBounds()
		{
			...
			foreach (Building building in TargetLocation.buildings)
			{
				...
				if ((building.CanBePainted() || building.CanBeReskinned(true)) && HasPermissionsToPaint(building))
				{
		...
		public virtual void UpdateAppearanceButtonVisibility()
		{
			...
			{
				appearanceButton.visible = currentBuilding.CanBeReskinned(true);
			}
		}
		...
		public override void performHoverAction(int x, int y)
		{
			...
			else
			{
				...
				Vector2 tile = new Vector2((Game1.viewport.X + Game1.getOldMouseX(false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(false)) / 64);
				...
				if (data != null)
				{
					int stickOutTilesHigh = (data.SourceRect.IsEmpty ? b.texture.Value.Height : b.GetData().SourceRect.Height) * 4 / 64 - (int)b.tilesHigh;
					if ((float)((int)b.tileY - stickOutTilesHigh) > tile.Y)
					{
						b = null;
					}
				}
				if (upgrading)
				{
					if (b != null)
					{
						b.color = ((b.buildingType == Blueprint.UpgradeFrom) ? (Color.Lime * 0.8f) : (Color.Red * 0.8f));
					}
				}
				else if (demolishing)
				{
				...
				else if (painting && b != null && (b.CanBePainted() || b.CanBeReskinned(true)) && HasPermissionsToPaint(b))
				{
					b.color = Color.Lime * 0.8f;
				}
			}
		...
		protected bool VerifyTileAccessibility(int tileX, int tileY, Vector2 buildingPosition)
		{
			...
			if (!buildingToMove.isTilePassable(new Vector2((int)buildingToMove.tileX + relativeX, (int)buildingToMove.tileY + relativeY)))
			{
				return false;
			}
		...
		public virtual bool ConfirmBuildingAccessibility(Vector2 buildingPosition)
		{
			...
			if (buildingToMove.buildingType != "Farmhouse")
			{
				return true;
			}
		...
		public override void receiveLeftClick(int x, int y, bool playSound = true)
		{
			...
			if (!onFarm)
			{
				...
				if (appearanceButton.containsPoint(x, y) && appearanceButton.visible && currentBuilding.CanBeReskinned(true))
				{
					BuildingSkinMenu skinMenu = new BuildingSkinMenu(currentBuilding, true);
					Game1.playSound("smallSelect");
			...
			if (demolishing)
			{
				_003C_003Ec__DisplayClass57_1 CS_0024_003C_003E8__locals1 = new _003C_003Ec__DisplayClass57_1();
				CS_0024_003C_003E8__locals1._003C_003E4__this = this;
				CS_0024_003C_003E8__locals1.farm = TargetLocation;
				CS_0024_003C_003E8__locals1.destroyed = CS_0024_003C_003E8__locals1.farm.getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(false)) / 64));
				if (CS_0024_003C_003E8__locals1.destroyed == null)
				{
					return;
				}
				CS_0024_003C_003E8__locals1.interior = CS_0024_003C_003E8__locals1.destroyed.GetIndoors();
				CS_0024_003C_003E8__locals1.cabin = CS_0024_003C_003E8__locals1.interior as Cabin;
				if (CS_0024_003C_003E8__locals1.destroyed != null)
				{
					if (CS_0024_003C_003E8__locals1.cabin != null && !Game1.IsMasterGame)
					{
						Game1.addHUDMessage(new HUDMessage(Game1.content.LoadString("Strings\\UI:Carpenter_CantDemolish_LockFailed"), 3));
						CS_0024_003C_003E8__locals1.destroyed = null;
						return;
					}
					if (!CanDemolishThis(CS_0024_003C_003E8__locals1.destroyed))
					{
						CS_0024_003C_003E8__locals1.destroyed = null;
						return;
					}
					if (!Game1.IsMasterGame && !hasPermissionsToDemolish(CS_0024_003C_003E8__locals1.destroyed))
					{
						CS_0024_003C_003E8__locals1.destroyed = null;
						return;
					}
				}
				Cabin cabin = CS_0024_003C_003E8__locals1.cabin;
				if (cabin != null && cabin.HasOwner && CS_0024_003C_003E8__locals1.cabin.owner.isCustomized.Value)
				{
					Game1.currentLocation.createQuestionDialogue(Game1.content.LoadString("Strings\\UI:Carpenter_DemolishCabinConfirm", CS_0024_003C_003E8__locals1.cabin.owner.Name), Game1.currentLocation.createYesNoResponses(), delegate(Farmer f, string answer)
					{
						if (answer == "Yes")
						{
							Game1.activeClickableMenu = CS_0024_003C_003E8__locals1._003C_003E4__this;
							Game1.player.team.demolishLock.RequestLock(CS_0024_003C_003E8__locals1._003CreceiveLeftClick_003Eg__ContinueDemolish_007C3, CS_0024_003C_003E8__locals1._003C_003E4__this._003CreceiveLeftClick_003Eg__BuildingLockFailed_007C57_2);
						}
						else
						{
							DelayedAction.functionAfterDelay(CS_0024_003C_003E8__locals1._003C_003E4__this.returnToCarpentryMenu, 500);
						}
					});
				}
				else if (CS_0024_003C_003E8__locals1.destroyed != null)
				{
					Game1.player.team.demolishLock.RequestLock(CS_0024_003C_003E8__locals1._003CreceiveLeftClick_003Eg__ContinueDemolish_007C3, _003CreceiveLeftClick_003Eg__BuildingLockFailed_007C57_2);
				}
				return;
			}
			if (upgrading)
			{
				Building toUpgrade = TargetLocation.getBuildingAt(new Vector2((Game1.viewport.X + Game1.getOldMouseX(false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(false)) / 64));
				if (toUpgrade != null && toUpgrade.buildingType == Blueprint.UpgradeFrom)
				{
					ConsumeResources();
			...
			if (painting)
			{
				Vector2 tile_position = new Vector2((Game1.viewport.X + Game1.getMouseX(false)) / 64, (Game1.viewport.Y + Game1.getMouseY(false)) / 64);
				...
				if (paint_building != null)
				{
					...
					SetChildMenu(paint_building.CanBePainted() ? ((IClickableMenu)new BuildingPaintMenu(paint_building)) : ((IClickableMenu)new BuildingSkinMenu(paint_building, true)));
				}
				return;
			}
			if (moving)
			{
				if (buildingToMove == null)
				{
					buildingToMove = TargetLocation.getBuildingAt(new Vector2((Game1.viewport.X + Game1.getMouseX(false)) / 64, (Game1.viewport.Y + Game1.getMouseY(false)) / 64));
					if (buildingToMove != null)
					{
				...
				Vector2 buildingPosition = new Vector2((Game1.viewport.X + Game1.getMouseX(false)) / 64, (Game1.viewport.Y + Game1.getMouseY(false)) / 64);
		...
		public bool tryToBuild()
		{
			...
			Vector2 tileLocation = new Vector2((Game1.viewport.X + Game1.getOldMouseX(false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(false)) / 64);
			Building building;
			if (TargetLocation.buildStructure(currentBuilding.buildingType.Value, tileLocation, Game1.player, out building, Blueprint.MagicalConstruction))
			{
		...
		public Location GetInitialBuildingPlacementViewport(GameLocation location)
		{
			if (TargetViewportCenterOnTile.HasValue)
			{
				...
				return _003CGetInitialBuildingPlacementViewport_003Eg__CenterOnTile_007C64_0((int)tile.X, (int)tile.Y);
			}
			Building building = location.getBuildingByName("FarmHouse") ?? location.buildings.FirstOrDefault();
			if (building != null)
			{
				return _003CGetInitialBuildingPlacementViewport_003Eg__CenterOnTile_007C64_0(building.tileX.Value + building.tilesWide.Value / 2, building.tileY.Value + building.tilesHigh.Value / 2);
			}
			Layer layer = location.Map.Layers[0];
			return _003CGetInitialBuildingPlacementViewport_003Eg__CenterOnTile_007C64_0(layer.LayerWidth / 2, layer.LayerHeight / 2);
		}
		...
		public override void draw(SpriteBatch b)
		{
			...
			if (!onFarm)
			{
				...
				currentBuilding.drawInMenu(b, xPositionOnScreen + maxWidthOfBuildingViewer / 2 - (int)currentBuilding.tilesWide * 64 / 2 - 64 + offset.X, yPositionOnScreen + maxHeightOfBuildingViewer / 2 - sourceRect.Height * 4 / 2 + offset.Y);
				b.End();
				...
				{
				case LocalizedContentManager.LanguageCode.es:
					descriptionWidth = maxWidthOfDescription + 64 + ((blueprint.Id == "Deluxe Barn") ? 96 : 0);
					break;
				case LocalizedContentManager.LanguageCode.it:
					descriptionWidth = maxWidthOfDescription + 96;
					break;
				case LocalizedContentManager.LanguageCode.fr:
					descriptionWidth = maxWidthOfDescription + 96 + ((blueprint.Id == "Slime Hutch" || blueprint.Id == "Deluxe Coop" || blueprint.Id == "Deluxe Barn") ? 72 : 0);
					break;
				case LocalizedContentManager.LanguageCode.ko:
					descriptionWidth = maxWidthOfDescription + 96 + ((blueprint.Id == "Slime Hutch") ? 64 : ((blueprint.Id == "Deluxe Coop") ? 96 : ((blueprint.Id == "Deluxe Barn") ? 112 : ((blueprint.Id == "Big Barn") ? 64 : 0))));
					break;
				default:
			...
			else
			{
				...
				{
					Vector2 mousePositionTile2 = new Vector2((Game1.viewport.X + Game1.getOldMouseX(false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(false)) / 64);
					for (int y4 = 0; y4 < currentBuilding.tilesHigh.Value; y4++)
					{
						for (int x3 = 0; x3 < currentBuilding.tilesWide.Value; x3++)
						{
							int sheetIndex3 = currentBuilding.getTileSheetIndexForStructurePlacementTile(x3, y4);
					...
					foreach (BuildingPlacementTile additionalPlacementTile in currentBuilding.GetAdditionalPlacementTiles())
					{
						...
						foreach (Point point in additionalPlacementTile.TileArea.GetPoints())
						{
							int x4 = point.X;
							int y3 = point.Y;
							int sheetIndex4 = currentBuilding.getTileSheetIndexForStructurePlacementTile(x4, y3);
				...
				{
					Vector2 mousePositionTile = new Vector2((Game1.viewport.X + Game1.getOldMouseX(false)) / 64, (Game1.viewport.Y + Game1.getOldMouseY(false)) / 64);
