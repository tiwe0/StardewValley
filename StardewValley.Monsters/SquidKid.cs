...
namespace StardewValley.Monsters
{
	public class SquidKid : Monster
	{
		...
		{
			base.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(Sprite.textureName, new Rectangle(0, 64, 16, 16), 70f, 7, 0, base.Position + new Vector2(0f, -32f), false, false)
			{
				scale = 4f
			});
			base.currentLocation.localSound("fireball");
			base.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(362, 30f, 6, 1, base.Position + new Vector2(-16 + Game1.random.Next(64), Game1.random.Next(64) - 32), false, Game1.random.NextBool())
			{
		...
		public override void behaviorAtGameTick(GameTime time)
		{
			...
			if ((bool)isHardModeMonster)
			{
				...
				if (firingTimer <= 0f && numFireballsLeft > 0)
				{
					...
					Vector2 trajectory2 = Utility.getVelocityTowardPoint(standingPixel, new Vector2(playerBounds.X, playerBounds.Y) + new Vector2(Game1.random.Next(-128, 128)), 8f);
					BasicProjectile projectile2 = new BasicProjectile(15, 10, 2, 4, 0f, trajectory2.X, trajectory2.Y, standingPixel - new Vector2(32f, 0f), null, null, null, true, false, base.currentLocation, this);
			...
			else if (withinPlayerThreshold() && lastFireball == 0f && Game1.random.NextDouble() < 0.01)
			{
				...
				Vector2 trajectory = Utility.getVelocityTowardPlayer(standingPixel2, 8f, base.Player);
				BasicProjectile projectile = new BasicProjectile(15, 10, 3, 4, 0f, trajectory.X, trajectory.Y, new Vector2(standingPixel2.X - 32, standingPixel2.Y), null, null, null, true, false, base.currentLocation, this);
