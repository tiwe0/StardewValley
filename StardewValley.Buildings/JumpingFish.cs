...
namespace StardewValley.Buildings
{
	public class JumpingFish
	{
		...
		public void Splash()
		{
			if (_pond != null && Game1.currentLocation.buildings.Contains(_pond))
			{
				Game1.playSound("dropItemInWater");
				Game1.currentLocation.TemporarySprites.Add(new TemporaryAnimatedSprite(28, 100f, 2, 1, position + new Vector2(-0.5f, -0.5f) * 64f, false, false)
				{
		...
		public void Draw(SpriteBatch b)
		{
			...
			b.Draw(itemData.GetTexture(), Game1.GlobalToLocal(Game1.viewport, draw_position), itemData.GetSourceRect(), Color.White, drawn_angle, origin, 4f * draw_scale, effect, position.Y / 10000f + 1E-06f);
