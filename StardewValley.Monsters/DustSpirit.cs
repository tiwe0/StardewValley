...
namespace StardewValley.Monsters
{
	public class DustSpirit : Monster
	{
		...
		public override void shedChunks(int number, float scale)
		{
			...
			Game1.createRadialDebris(base.currentLocation, Sprite.textureName, new Rectangle(0, 16, 16, 16), 8, standingPixel.X, standingPixel.Y, number, base.TilePoint.Y, Color.White, (base.Health <= 0) ? 4f : 2f);
		}
		...
		public override void behaviorAtGameTick(GameTime time)
		{
			...
			if (yJumpOffset == 0)
			{
				if (Game1.random.NextDouble() < 0.01)
				{
					...
					Game1.multiplayer.broadcastSprites(base.currentLocation, new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 128, 64, 64), 40f, 4, 0, standingPixel + new Vector2(-21f, 0f), false, false)
					{
					...
					{
						Object obj;
						if (base.currentLocation.objects.TryGetValue(v2, out obj) && (obj.IsBreakableStone() || obj.IsTwig()))
						{
