...
namespace StardewValley.Menus
{
	public class GameMenu : IClickableMenu
	{
		...
		public static string getLabelOfTabFromIndex(int index)
		{
			...
			if (!TabTranslationKeys.TryGetValue(index, out translationKey))
			{
				return "";
			}
		...
		public override void draw(SpriteBatch b)
		{
			if (!invisible)
			{
				...
				Game1.drawDialogueBox(xPositionOnScreen, yPositionOnScreen, pages[currentTab].width, pages[currentTab].height, false, true);
				b.End();
