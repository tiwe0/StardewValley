...
namespace StardewValley.Minigames
{
	public class GrandpaStory : IMinigame
	{
		...
		public void draw(SpriteBatch b)
		{
			...
			{
				SpriteText.drawString(b, Game1.content.LoadString("Strings\\StringsFromCSFiles:GrandpaStory.cs.12059"), (int)Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 0, 0, -200).X, (int)Utility.getTopLeftPositionForCenteringOnScreen(Game1.viewport, 0, 0, 0, -50).Y, 999, -1, 999, 1f, 1f, false, -1, "", SpriteText.color_White);
			}
			else if (scene == 4)
			{
