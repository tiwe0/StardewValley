...
namespace StardewValley
{
	...
	public class Object : Item
	{
		...
		public override string DisplayName
		{
			get
			{
				...
				if ((bool)isRecipe)
				{
					...
					if (CraftingRecipe.craftingRecipes.TryGetValue(displayName, out rawCraftingData))
					{
		...
		public virtual bool performToolAction(Tool t)
		{
			...
			{
				Chest chest2 = heldObject.Value as Chest;
			...
			{
				Object tileObj;
				if (location.objects.TryGetValue(tileLocation.Value, out tileObj) && tileObj.Equals(this))
				{
					if (location.farmers.Count > 0)
					{
						Game1.createRadialDebris(location, 12, (int)tileLocation.X, (int)tileLocation.Y, Game1.random.Next(4, 10), false);
					}
			...
			if (IsWeeds() && t.isHeavyHitter())
			{
				...
				if (shakeTimer <= 0)
				{
					minutesUntilReady.Value -= damage2;
				}
			...
			else
			{
				...
				if (name.Contains("SupplyCrate") && t.isHeavyHitter())
				{
					...
					if (MinutesUntilReady <= 0)
					{
						...
						Random r2 = Utility.CreateRandom(Game1.uniqueIDForThisGame, (double)tileLocation.X * 777.0, (double)tileLocation.Y * 7.0);
						...
						case 0:
							...
							{
							case 0:
								Game1.createMultipleObjectDebris("(O)770", x, y, r2.Next(3, 6), location);
								break;
							case 1:
								Game1.createMultipleObjectDebris("(O)371", x, y, r2.Next(5, 8), location);
								break;
							case 2:
								Game1.createMultipleObjectDebris("(O)535", x, y, r2.Next(2, 5), location);
								break;
							case 3:
								Game1.createMultipleObjectDebris("(O)241", x, y, r2.Next(1, 3), location);
								break;
							case 4:
								Game1.createMultipleObjectDebris("(O)395", x, y, r2.Next(1, 3), location);
								break;
							case 5:
								Game1.createMultipleObjectDebris("(O)286", x, y, r2.Next(3, 6), location);
								break;
							default:
								Game1.createMultipleObjectDebris("(O)286", x, y, r2.Next(3, 6), location);
								break;
						...
						case 1:
							...
							case 1:
								...
								break;
							case 2:
								Game1.createMultipleObjectDebris("(O)749", x, y, r2.Next(2, 5), location);
								break;
							case 3:
								Game1.createMultipleObjectDebris("(O)253", x, y, r2.Next(1, 3), location);
								break;
							case 4:
								Game1.createMultipleObjectDebris("(O)237", x, y, r2.Next(1, 3), location);
								break;
							case 5:
								Game1.createMultipleObjectDebris("(O)246", x, y, r2.Next(4, 8), location);
								break;
							case 6:
								Game1.createMultipleObjectDebris("(O)247", x, y, r2.Next(2, 5), location);
								break;
							case 7:
								Game1.createMultipleObjectDebris("(O)245", x, y, r2.Next(4, 8), location);
								break;
							case 8:
								Game1.createMultipleObjectDebris("(O)287", x, y, r2.Next(3, 6), location);
								break;
							default:
								Game1.createMultipleObjectDebris("MixedFlowerSeeds", x, y, r2.Next(4, 6), location);
								break;
							}
							break;
						default:
							...
							case 0:
								...
								break;
							case 1:
								Game1.createMultipleObjectDebris("(O)920", x, y, r2.Next(5, 8), location);
								break;
							case 2:
								Game1.createMultipleObjectDebris("(O)749", x, y, r2.Next(2, 5), location);
								break;
							case 3:
								Game1.createMultipleObjectDebris("(O)253", x, y, r2.Next(2, 4), location);
								break;
							case 4:
								Game1.createMultipleObjectDebris(r2.Choose("(O)904", "(O)905"), x, y, r2.Next(1, 3), location);
								break;
							case 5:
								Game1.createMultipleObjectDebris("(O)246", x, y, r2.Next(4, 8), location);
								Game1.createMultipleObjectDebris("(O)247", x, y, r2.Next(2, 5), location);
							...
							case 6:
								...
								break;
							case 7:
								Game1.createMultipleObjectDebris("(O)288", x, y, r2.Next(3, 6), location);
								break;
							default:
								Game1.createMultipleObjectDebris("MixedFlowerSeeds", x, y, r2.Next(5, 6), location);
								break;
							}
							break;
						}
			...
			if (base.QualifiedItemId == "(O)590" || base.QualifiedItemId == "(O)SeedSpot")
			{
				if (t is Hoe)
				{
					...
					if (t.getLastFarmerToUse().stats.Get("ArtifactSpotsDug") > 2 && r.NextDouble() < 0.008 + ((!t.getLastFarmerToUse().mailReceived.Contains("DefenseBookDropped")) ? ((double)t.getLastFarmerToUse().stats.Get("ArtifactSpotsDug") * 0.002) : 0.005))
					{
						...
						Vector2 position2 = TileLocation * 64f;
					...
					{
						location.makeHoeDirt(tileLocation.Value, true);
					}
			...
			if (Type == "Crafting" && !(t is MeleeWeapon) && t.isHeavyHitter())
			{
				...
				if ((int)fragility == 1)
				{
					Game1.createRadialDebris(location, 12, (int)tileLocation.X, (int)tileLocation.Y, Game1.random.Next(3, 6), false);
					Game1.createRadialDebris(location, 14, (int)tileLocation.X, (int)tileLocation.Y, Game1.random.Next(3, 6), false);
					DelayedAction.functionAfterDelay(delegate
					{
						Game1.createRadialDebris(location, 12, (int)tileLocation.X, (int)tileLocation.Y, Game1.random.Next(2, 5), false);
						Game1.createRadialDebris(location, 14, (int)tileLocation.X, (int)tileLocation.Y, Game1.random.Next(2, 5), false);
					}, 80);
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite(12, new Vector2(tileLocation.X * 64f, tileLocation.Y * 64f), Color.White, 8, Game1.random.NextBool(), 50f));
					performRemoveAction();
					location.objects.Remove(tileLocation.Value);
				...
				if (IsTapper() && location.terrainFeatures.TryGetValue(tileLocation.Value, out terrainFeature))
				{
		...
		public virtual bool onExplosion(Farmer who)
		{
			...
			if (IsWeeds())
			{
				fragility.Value = 0;
				cutWeed(who);
				location.removeObject(tileLocation.Value, false);
			}
			if (IsTwig())
			{
				fragility.Value = 0;
		...
		public virtual void ApplySprinkler(Vector2 tile)
		{
			GameLocation location = Location;
			TerrainFeature terrainFeature;
			if (!(location.doesTileHavePropertyNoNull((int)tile.X, (int)tile.Y, "NoSprinklers", "Back") == "T") && location.terrainFeatures.TryGetValue(tile, out terrainFeature))
			{
				HoeDirt dirt = terrainFeature as HoeDirt;
				if (dirt != null && (int)dirt.state != 2)
				{
					dirt.state.Value = 1;
				}
			}
		...
		public virtual void ApplySprinklerAnimation()
		{
			...
			if (radius != 0)
			{
				if (radius == 1)
				{
					location.temporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Microsoft.Xna.Framework.Rectangle(0, 1984, 192, 192), 60f, 3, 100, tileLocation.Value * 64f + new Vector2(-64f, -64f), false, false)
					{
				...
				else if (radius > 0)
				{
					...
					location.temporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Microsoft.Xna.Framework.Rectangle(0, 2176, 320, 320), 60f, 4, 100, tileLocation.Value * 64f + new Vector2(32f, 32f) + new Vector2(-160f, -160f) * scale, false, false)
					{
						color = Color.White * 0.4f,
						delayBeforeAnimationStart = Game1.random.Next(1000),
						id = tileX * 4000 + tileY,
			...
			else
			{
				...
				location.temporarySprites.Add(new TemporaryAnimatedSprite(29, tileLocation.Value * 64f + new Vector2(0f, -48f), Color.White * 0.5f, 4, false, 60f, 100)
				{
					delayBeforeAnimationStart = delay,
					id = tileX * 4000 + tileY
				});
				location.temporarySprites.Add(new TemporaryAnimatedSprite(29, tileLocation.Value * 64f + new Vector2(48f, 0f), Color.White * 0.5f, 4, false, 60f, 100)
				{
		...
		public virtual void DayUpdate()
		{
			...
			if (machineData != null)
			{
				...
				if (heldObject.Value == null && MachineDataUtility.TryGetMachineOutputRule(this, machineData, MachineOutputTrigger.DayUpdate, null, null, location, out outputRule, out triggerRule, out ruleIgnoringCount, out triggerIgnoringCount))
				{
					OutputMachine(machineData, outputRule, null, null, location, false);
				}
			}
			switch (base.QualifiedItemId)
			{
			...
			case "(BC)272":
			{
				...
				{
					pair.Value.pet(Game1.player, true);
				}
				break;
			}
			...
			case "(BC)165":
			{
				...
				{
					if (kvp.Value.GetHarvestType() != FarmAnimalHarvestType.HarvestWithTool || kvp.Value.currentProduce.Value == null)
					{
						continue;
					}
					Chest chest = heldObject.Value as Chest;
					if (chest != null)
					{
			...
			case "(BC)156":
				...
				if (location.canSlimeHatchHere())
				{
					...
					if (slime != null)
					{
						...
						Vector2 openSpot = Utility.recursiveFindOpenTileForCharacter(slime, location, tileLocation.Value + new Vector2(0f, 1f), 10, false);
		...
		public bool PlaceInMachine(MachineData machineData, Item inputItem, bool probe, Farmer who, bool showMessages = true, bool playSounds = true)
		{
			...
			if (!MachineDataUtility.HasAdditionalRequirements(autoLoadFrom ?? who.Items, machineData.AdditionalConsumedItems, out failedRequirement))
			{
		...
		private void playCustomMachineLoadEffects()
		{
			if (base.ItemId == "FishSmoker")
			{
				for (int i = 0; i < 12; i++)
				{
					Location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), 9999f, 1, 1, new Vector2((float)((int)TileLocation.X * 64) + 18f, ((float)(int)TileLocation.Y - 1.15f) * 64f), false, false)
					{
		...
		public virtual bool OutputMachine(MachineData machine, MachineOutputRule outputRule, Item inputItem, Farmer who, GameLocation location, bool probe)
		{
			...
			MachineOutputRule ruleIgnoringCount;
			MachineOutputTriggerRule triggerIgnoringCount;
			if (outputRule == null && !MachineDataUtility.TryGetMachineOutputRule(this, machine, MachineOutputTrigger.ItemPlacedInMachine, inputItem, who, location, out outputRule, out triggerRule, out ruleIgnoringCount, out triggerIgnoringCount))
			{
				return false;
			}
		...
		public virtual void updateWhenCurrentLocation(GameTime time)
		{
			...
			if (_hasHeldObject)
			{
				...
				if (heldObject.QualifiedItemId == "(O)913" && IsSprinkler())
				{
		...
		public override bool canBeTrashed()
		{
			...
			{
				ObjectData data;
				if (Game1.objectData.TryGetValue(base.ItemId, out data))
				{
		...
		public virtual void performRemoveAction()
		{
			...
			if (environment != null)
			{
				...
				TerrainFeature terrainFeature;
				if (IsTapper() && environment.terrainFeatures != null && environment.terrainFeatures.TryGetValue(tileLocation, out terrainFeature))
				{
					Tree tree = terrainFeature as Tree;
					if (tree != null)
					{
		...
		public virtual bool performDropDownAction(Farmer who)
		{
			...
			MachineOutputRule ruleIgnoringCount;
			MachineOutputTriggerRule triggerIgnoringCount;
			if (MachineDataUtility.TryGetMachineOutputRule(this, machineData, MachineOutputTrigger.MachinePutDown, null, who, location, out outputRule, out triggerRule, out ruleIgnoringCount, out triggerIgnoringCount))
			{
				OutputMachine(machineData, outputRule, null, who, location, false);
				return false;
			}
			string qualifiedItemId = base.QualifiedItemId;
			if (!(qualifiedItemId == "(BC)96"))
		...
		private void totemWarp(Farmer who)
		{
			...
			for (int i = 0; i < 12; i++)
			{
				Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite(354, Game1.random.Next(25, 75), 6, 1, new Vector2(Game1.random.Next((int)who.Position.X - 256, (int)who.Position.X + 192), Game1.random.Next((int)who.Position.Y - 256, (int)who.Position.Y + 192)), false, Game1.random.NextBool()));
			}
			...
			{
				Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite(6, new Vector2(x, playerTile.Y) * 64f, Color.White, 8, false, 50f)
				{
					layerDepth = 1f,
		...
		private void treasureTotem(Farmer who, GameLocation gameLocation)
		{
			...
			for (int x = (int)center.X - radius; (float)x < center.X + (float)radius; x++)
			{
				for (int y = (int)center.Y - radius; (float)y < center.Y + (float)radius; y++)
				{
					...
					if (Math.Round(Utility.distance(x, center.X, y, center.Y)) <= (double)(radius - 1))
					{
						Utility.makeTemporarySpriteJuicier(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Microsoft.Xna.Framework.Rectangle(144, 249, 7, 7), Game1.random.Next(100, 200), 6, 1, new Vector2(x, y) * 64f + new Vector2(32 + Game1.random.Next(-16, 16), 32 + Game1.random.Next(-16, 16)), false, false, 0.001f, 0f, (Game1.random.NextDouble() < 0.5) ? new Color(255, 255, 100) : Color.White, 4f, 0f, 0f, 0f), gameLocation);
					}
				}
			}
		}
		...
		private void rainTotem(Farmer who)
		{
			...
			{
				new FarmerSprite.AnimationFrame(57, 2000, false, false, Farmer.canMoveNow, true)
			});
			for (int i = 0; i < 6; i++)
			{
				Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(648, 1045, 52, 33), 9999f, 1, 999, who.Position + new Vector2(0f, -128f), false, false, 1f, 0.01f, Color.White * 0.8f, 2f, 0.01f, 0f, 0f)
				{
					motion = new Vector2((float)Game1.random.Next(-10, 11) / 10f, -2f),
					delayBeforeAnimationStart = i * 200
				});
				Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(648, 1045, 52, 33), 9999f, 1, 999, who.Position + new Vector2(0f, -128f), false, false, 1f, 0.01f, Color.White * 0.8f, 1f, 0.01f, 0f, 0f)
				{
		...
		private void readBook(GameLocation location)
		{
			...
			Game1.player.FarmerSprite.animateOnce(new FarmerSprite.AnimationFrame[1]
			{
				new FarmerSprite.AnimationFrame(57, 1000, false, false, Farmer.canMoveNow, true)
				{
			...
			Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Book_Animation", new Microsoft.Xna.Framework.Rectangle(0, 0, 20, 20), 10f, 45, 1, Game1.player.getStandingPosition() + new Vector2(-48f, -156f), false, false, Game1.player.getDrawLayer() + 0.001f, 0f, Color.White, 4f, 0f, 0f, 0f)
			{
				holdLastFrame = true,
				id = 1987654
			});
			...
			if (c.HasValue)
			{
				Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Book_Animation", new Microsoft.Xna.Framework.Rectangle(0, 20, 20, 20), 10f, 45, 1, Game1.player.getStandingPosition() + new Vector2(-48f, -156f), false, false, Game1.player.getDrawLayer() + 0.0012f, 0f, c.Value, 4f, 0f, 0f, 0f)
				{
					holdLastFrame = true,
					id = 1987654
				});
			...
			if (Game1.player.stats.Get(itemId) != 0 && base.ItemId != "Book_PriceCatalogue" && base.ItemId != "Book_AnimalCatalogue")
			{
				...
				bool foundAny = false;
				foreach (string s2 in GetContextTags())
				{
					if (s2.StartsWith("book_xp"))
					{
						foundAny = true;
						string whichSkill = s2.Split('_')[2];
		...
		public virtual bool performUseAction(GameLocation location)
		{
					...
					case "(O)261":
					{
						...
						if (base.QualifiedItemId == "(O)681")
						{
							Game1.player.FarmerSprite.animateOnce(new FarmerSprite.AnimationFrame[2]
							{
								...
								new FarmerSprite.AnimationFrame((short)Game1.player.FarmerSprite.CurrentFrame, 0, false, false, rainTotem, true)
							});
						}
						else
						{
							...
							{
								new FarmerSprite.AnimationFrame(57, 2000, false, false),
								new FarmerSprite.AnimationFrame((short)Game1.player.FarmerSprite.CurrentFrame, 0, false, false, totemWarp, true)
							});
						}
						TemporaryAnimatedSprite sprite = new TemporaryAnimatedSprite(0, 9999f, 1, 999, Game1.player.Position + new Vector2(0f, -96f), false, false, false, 0f)
						{
			...
			if (base.QualifiedItemId == "(O)911")
			{
				...
				if (warpError == null)
				{
					...
					{
						Horse curHorse = character as Horse;
			...
			if (base.QualifiedItemId == "(O)879")
			{
				...
				Game1.player.FarmerSprite.animateOnce(new FarmerSprite.AnimationFrame[2]
				{
					...
					new FarmerSprite.AnimationFrame((short)Game1.player.FarmerSprite.CurrentFrame, 0, false, false, MonsterMusk, true)
				});
				for (int i = 0; i < 3; i++)
				{
		...
		public virtual bool isActionable(Farmer who)
		{
			if (!isTemporarilyInvisible)
			{
				return checkForAction(who, true);
			}
			return false;
		}
		...
		protected virtual void grabItemFromAutoGrabber(Item item, Farmer who)
		{
			...
			if (chest != null)
			{
				if (who.couldInventoryAcceptThisItem(item))
				{
					...
					chest.clearNulls();
					Game1.activeClickableMenu = new ItemGrabMenu(chest.Items, false, true, InventoryMenu.highlightAllItems, chest.grabItemFromInventory, null, grabItemFromAutoGrabber, false, true, true, true, true, 1, this, -1, this);
				}
				if (chest.isEmpty())
				{
					showNextIndex.Value = false;
		...
		protected virtual bool CheckForActionOnAutoGrabber(Farmer who, bool justCheckingForActivity = false)
		{
			...
			{
				Game1.activeClickableMenu = new ItemGrabMenu(chest.Items, false, true, InventoryMenu.highlightAllItems, chest.grabItemFromInventory, null, grabItemFromAutoGrabber, false, true, true, true, true, 1, null, -1, this);
				return true;
			}
			return false;
		}
		...
		protected virtual bool CheckForActionOnMiniObelisk(Farmer who, bool justCheckingForActivity = false)
		{
			...
			foreach (Vector2 v in array)
			{
				if (!location.IsTileBlockedBy(v, CollisionMask.All, CollisionMask.All))
				{
					for (int i = 0; i < 12; i++)
					{
						location.temporarySprites.Add(new TemporaryAnimatedSprite(354, Game1.random.Next(25, 75), 6, 1, new Vector2(Game1.random.Next((int)who.Position.X - 256, (int)who.Position.X + 192), Game1.random.Next((int)who.Position.Y - 256, (int)who.Position.Y + 192)), false, Game1.random.NextBool()));
					}
					...
					for (int x = playerTile.X + 8; x >= playerTile.X - 8; x--)
					{
						location.temporarySprites.Add(new TemporaryAnimatedSprite(6, new Vector2(x, playerTile.Y) * 64f, Color.White, 8, false, 50f)
						{
							layerDepth = 1f,
							delayBeforeAnimationStart = j * 25,
							motion = new Vector2(-0.25f, 0f)
		...
		protected virtual bool CheckForActionOnBlessedStatue(Farmer who, GameLocation location, bool justCheckingForActivitiy = false)
		{
			...
			if (!who.hasBuffWithNameContainingString("statue_of_blessings_") && !who.hasBeenBlessedByStatueToday)
			{
				...
				location.critters.Add(new Butterfly(location, TileLocation + new Vector2(1f, 0f), false, false, 163));
				location.critters.Add(new Butterfly(location, TileLocation + new Vector2(0.33f, 0.25f), false, false, 163));
				location.critters.Add(new Butterfly(location, TileLocation + new Vector2(1.58f, 0.25f), false, false, 163));
				location.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Microsoft.Xna.Framework.Rectangle(221, 225, 15, 31), 9000f, 1, 1, TileLocation * 64f + new Vector2(1f, -16f) * 4f, false, false, Math.Max(0f, ((TileLocation.Y + 1f) * 64f - 20f) / 10000f) + TileLocation.X * 1E-05f, 0.02f, Color.White, 4f, 0f, 0f, 0f));
				for (int i = 0; i < 6; i++)
				{
					Utility.makeTemporarySpriteJuicier(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Microsoft.Xna.Framework.Rectangle(144, 249, 7, 7), Game1.random.Next(100, 200), 6, 1, TileLocation * 64f + new Vector2(32 + Game1.random.Next(-64, 64), Game1.random.Next(-64, 64)), false, false, Math.Max(0f, ((TileLocation.Y + 1f) * 64f - 24f) / 10000f) + TileLocation.X * 1E-05f, 0f, (Game1.random.NextDouble() < 0.5) ? new Color(255, 180, 210) : Color.White, 4f, 0f, 0f, 0f), location);
				}
				return true;
			}
			return false;
		...
		protected virtual bool CheckForActionOnFluteBlock(Farmer who, bool justCheckingForActivity = false)
		{
			...
			int.TryParse(preservedParentSheetIndex.Value, out preservedParentSheetInt);
			switch (preservedParentSheetInt)
			{
			case 2300:
			...
			if (who.freeSpotsInInventory() > 0)
			{
				...
				if (piecesHay > 0)
				{
					...
					if (i != null)
					{
						...
						piecesOfHayToRemove = Math.Min(piecesOfHayToRemove, (int)i.animalLimit - alreadyHay);
		...
		protected bool CheckForActionOnMachine(Farmer who, bool justCheckingForActivity = false)
		{
			...
			if ((bool)readyForHarvest)
			{
				...
				{
					MachineOutputRule outputRule = machineData2.OutputRules?.FirstOrDefault((MachineOutputRule p) => p.Id == lastOutputRuleId.Value);
					if (outputRule != null && outputRule.RecalculateOnCollect)
					{
						Object prevOutput = heldObject.Value;
						heldObject.Value = null;
						OutputMachine(machineData2, outputRule, lastInputItem.Value, who, location, false);
						if (heldObject.Value == null)
						{
				...
				if (who.IsLocalPlayer)
				{
					...
					MachineDataUtility.UpdateStats(machineData2?.StatsToIncrementWhenHarvested, objectThatWasHeld, objectThatWasHeld.Stack);
				}
				heldObject.Value = null;
				readyForHarvest.Value = false;
				showNextIndex.Value = false;
				...
				MachineOutputRule ruleIgnoringCount;
				MachineOutputTriggerRule triggerIgnoringCount;
				if (MachineDataUtility.TryGetMachineOutputRule(this, machineData2, MachineOutputTrigger.OutputCollected, objectThatWasHeld.getOne(), who, location, out outputCollectedRule, out triggerRule, out ruleIgnoringCount, out triggerIgnoringCount))
				{
					OutputMachine(machineData2, outputCollectedRule, lastInputItem.Value, who, location, false);
				}
				TerrainFeature terrainFeature;
				if (IsTapper() && location.terrainFeatures.TryGetValue(tileLocation.Value, out terrainFeature))
				{
					(terrainFeature as Tree)?.UpdateTapperProduct(this, objectThatWasHeld);
				}
				if (machineData2 != null && machineData2.ExperienceGainOnHarvest != null)
				{
					string[] expSplit = machineData2.ExperienceGainOnHarvest.Split(' ');
					for (int i = 0; i < expSplit.Length; i += 2)
					{
						int skill = Farmer.getSkillNumberFromName(expSplit[i]);
						int amount;
						string error2;
						if (skill != -1 && ArgUtility.TryGetInt(expSplit, i + 1, out amount, out error2))
						{
		...
		{
			ICue cue;
			Game1.sounds.PlayLocal(audioName, Location, tileLocation.Value, pitch, context, out cue);
		}
		...
		public virtual int GetRadiusForScarecrow()
		{
			...
			{
				int radius;
				if (context_tag != null && context_tag.StartsWith("crow_scare_radius_") && int.TryParse(context_tag.Substring("crow_scare_radius".Length + 1), out radius))
				{
					return radius;
				}
			}
		...
		public virtual Task<bool> AttemptAutoLoad(Farmer who)
		{
			GameLocation location = Location;
			Object fromObj;
			if (location != null && location.objects.TryGetValue(new Vector2(TileLocation.X, TileLocation.Y - 1f), out fromObj))
			{
		...
		public virtual bool AttemptAutoLoad(IInventory inventory, Farmer who)
		{
			...
			{
				if (performObjectDropInAction(item, false, who))
				{
					autoLoadFrom = null;
					return true;
				}
		...
		public virtual void farmerAdjacentAction(Farmer who, bool diagonal = false)
		{
			...
			case "(O)464":
				if ((internalSound == null || ((int)Game1.currentGameTime.TotalGameTime.TotalMilliseconds - lastNoteBlockSoundTime >= 1000 && !internalSound.IsPlaying)) && !Game1.dialogueUp && !diagonal)
				{
					...
					(location as IslandSouthEast)?.OnFlutePlayed(preservedParentSheetInt);
				}
				return;
			case "(O)463":
				if ((internalSound == null || (Game1.currentGameTime.TotalGameTime.TotalMilliseconds - (double)lastNoteBlockSoundTime >= 1000.0 && !internalSound.IsPlaying)) && !Game1.dialogueUp && !diagonal)
				{
					...
					int.TryParse(preservedParentSheetIndex.Value, out preservedParentSheetInt2);
					Game1.playSound("drumkit" + preservedParentSheetInt2, out internalSound);
					scale.Y = 1.3f;
					shakeTimer = 200;
					lastNoteBlockSoundTime = (int)Game1.currentGameTime.TotalGameTime.TotalMilliseconds;
				}
			...
			case "(BC)29":
			{
				...
				foreach (Vector2 offset in adjacentTilesOffsets)
				{
					...
					if (!location.IsTileOccupiedBy(v2) && location.isTilePassable(new Location((int)v2.X, (int)v2.Y), Game1.viewport) && location.isCharacterAtTile(v2) == null)
					{
						...
						Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite(352, 400f, 2, 1, v2 * new Vector2(64f, 64f), false, false));
		...
		public virtual bool countsForShippedCollection()
		{
			...
			{
				ObjectData data;
				if (Game1.objectData.TryGetValue(base.ItemId, out data) && data.ExcludeFromShippingCollection)
				{
					return false;
				}
				return true;
		...
		public static bool isPotentialBasicShipped(string itemId, int category, string objectType)
		{
			...
			default:
				...
				{
					ObjectData data;
					if (Game1.objectData.TryGetValue(itemId, out data) && data.ExcludeFromShippingCollection)
					{
						return false;
					}
					return true;
		...
		public override IEnumerable<Buff> GetFoodOrDrinkBuffs()
		{
			...
			ObjectData data;
			if ((int)edibility <= -300 || !Game1.objectData.TryGetValue(base.ItemId, out data))
			{
				yield break;
			}
		...
		public virtual void drawPlacementBounds(SpriteBatch spriteBatch, GameLocation location)
		{
			...
			if (Utility.isThereAnObjectHereWhichAcceptsThisItem(location, this, x, y))
			{
				...
				if (pot == null || !pot.IsPlantableItem(this))
				{
					return;
				}
			}
		...
		public virtual void drawAsProp(SpriteBatch b)
		{
			...
			if ((bool)bigCraftable)
			{
				...
				b.Draw(texture, destination, itemData2.GetSourceRect(indexOffset, base.ParentSheetIndex), Color.White, 0f, Vector2.Zero, SpriteEffects.None, Math.Max(0f, (float)((y + 1) * 64 - 1) / 10000f) + (IsTapper() ? 0.0015f : 0f));
		...
		public virtual void draw(SpriteBatch spriteBatch, int x, int y, float alpha = 1f)
		{
			...
			if ((bool)bigCraftable)
			{
				...
				Microsoft.Xna.Framework.Rectangle destination = new Microsoft.Xna.Framework.Rectangle((int)(position2.X - scaleFactor.X / 2f) + ((shakeTimer > 0) ? Game1.random.Next(-1, 2) : 0), (int)(position2.Y - scaleFactor.Y / 2f) + ((shakeTimer > 0) ? Game1.random.Next(-1, 2) : 0), (int)(64f + scaleFactor.X), (int)(128f + scaleFactor.Y / 2f));
				...
				if (heldObject.Value != null)
				{
					...
					{
						offset2 = FarmAnimal.GetAnimalDataFromEgg(heldObject.Value, location)?.IncubatorParentSheetOffset ?? 1;
					}
				}
				if (_machineAnimationFrame >= 0 && _machineAnimation != null)
				{
					offset2 = _machineAnimationFrame;
				}
				Mannequin mannequin = this as Mannequin;
				if (mannequin != null)
				{
					offset2 = mannequin.facing.Value;
				}
				if (IsTapper())
				{
				...
				if (base.QualifiedItemId == "(BC)272")
				{
					...
					spriteBatch.Draw(texture3, destination, itemData2.GetSourceRect(1, base.ParentSheetIndex), Color.White * alpha, 0f, Vector2.Zero, SpriteEffects.None, draw_layer);
					spriteBatch.Draw(texture3, position2 + new Vector2(8.5f, 12f) * 4f, itemData2.GetSourceRect(2, base.ParentSheetIndex), Color.White * alpha, (float)Game1.currentGameTime.TotalGameTime.TotalSeconds * -1.5f, new Vector2(7.5f, 15.5f), 4f, SpriteEffects.None, draw_layer + 1E-05f);
					return;
				}
				spriteBatch.Draw(itemData2.GetTexture(), destination, itemData2.GetSourceRect(offset2, base.ParentSheetIndex), Color.White * alpha, 0f, Vector2.Zero, SpriteEffects.None, draw_layer);
				if (base.QualifiedItemId == "(BC)17" && MinutesUntilReady > 0)
				{
			...
			else if (!Game1.eventUp || (Game1.CurrentEvent != null && !Game1.CurrentEvent.isTileWalkedOn(x, y)))
			{
				...
				if (IsSprinkler())
				{
					if (heldObject.Value != null)
					{
						...
						ParsedItemData heldItemData2 = ItemRegistry.GetDataOrErrorItem(heldObject.Value.QualifiedItemId);
						spriteBatch.Draw(heldItemData2.GetTexture(), Game1.GlobalToLocal(Game1.viewport, new Vector2(x * 64 + 32 + ((shakeTimer > 0) ? Game1.random.Next(-1, 2) : 0), y * 64 + 32 + ((shakeTimer > 0) ? Game1.random.Next(-1, 2) : 0)) + offset), heldItemData2.GetSourceRect(1), Color.White * alpha, 0f, new Vector2(8f, 8f), (scale.Y > 1f) ? getScale().Y : 4f, flipped ? SpriteEffects.FlipHorizontally : SpriteEffects.None, (float)(isPassable() ? bounds.Top : bounds.Bottom) / 10000f + 1E-05f);
					}
			...
			ColoredObject coloredObj = heldObject.Value as ColoredObject;
			if (coloredObj != null)
			{
		...
		public virtual void draw(SpriteBatch spriteBatch, int xNonTile, int yNonTile, float layerDepth, float alpha = 1f)
		{
			...
			if ((bool)bigCraftable)
			{
				...
				ParsedItemData itemData2 = ItemRegistry.GetDataOrErrorItem(base.QualifiedItemId);
				spriteBatch.Draw(itemData2.GetTexture(), destination, itemData2.GetSourceRect(indexOffset, base.ParentSheetIndex), Color.White * alpha, 0f, Vector2.Zero, SpriteEffects.None, layerDepth);
				if (base.QualifiedItemId == "(BC)17" && MinutesUntilReady > 0)
				{
		...
		public override bool canBePlacedHere(GameLocation l, Vector2 tile, CollisionMask collisionMask = CollisionMask.All, bool showError = false)
		{
			...
			TerrainFeature terrainFeature;
			if (IsTapper() && l.terrainFeatures.TryGetValue(tile, out terrainFeature))
			{
				Tree tree = terrainFeature as Tree;
				if (tree != null && !l.objects.ContainsKey(tile) && (tree.GetData()?.CanBeTapped() ?? false))
				{
					return true;
				}
			}
			TerrainFeature terrainFeature2;
			if (base.QualifiedItemId == "(O)805" && l.terrainFeatures.TryGetValue(tile, out terrainFeature2) && terrainFeature2 is Tree)
			{
				return true;
			}
			if (base.QualifiedItemId == "(O)419")
			{
				...
				if (l.terrainFeatures.TryGetValue(tile, out terrainFeature3))
				{
					Tree tree2 = terrainFeature3 as Tree;
			...
			if (isWildTreeSeed(base.ItemId))
			{
				...
				if (!canPlaceWildTreeSeed(l, tile, out deniedMessage3))
				{
					if (showError && deniedMessage3 != null)
					{
						Game1.showRedMessage(deniedMessage3);
					}
					return false;
				}
				return true;
			...
			if ((int)category == -74)
			{
				...
				if (dirt2?.crop != null || (dirt2 == null && l.terrainFeatures.TryGetValue(tile, out value)))
				{
					return false;
				}
				...
				if (IsTeaSapling())
				{
					...
					if (!l.CheckItemPlantRules(base.QualifiedItemId, isFreeGardenPot, (bool)l.isOutdoors || l.IsGreenhouse, out deniedMessage))
					{
				...
				if (this.HasTypeObject())
				{
					...
					if (dirt2 != null && l.CanItemBePlacedHere(tile, true, collisionMask) && dirt2.canPlantThisSeedHere(base.ItemId))
					{
						return true;
					}
				}
			...
			if ((int)category == -19)
			{
				...
				{
					return (l.getObjectAtTile((int)tile.X, (int)tile.Y) as IndoorPot)?.IsPlantableItem(this) ?? true;
				}
				return false;
			}
			if (l != null)
		...
		{
			MachineData data;
			if (!Game1.content.Load<Dictionary<string, MachineData>>("Data\\Machines").TryGetValue(base.QualifiedItemId, out data))
			{
				return null;
			}
			return data;
		...
		private bool canPlaceWildTreeSeed(GameLocation location, Vector2 tile, out string deniedMessage)
		{
			...
			return location.CheckItemPlantRules(base.QualifiedItemId, false, location is Farm || location.doesTileHaveProperty((int)tile.X, (int)tile.Y, "Diggable", "Back") != null || location.doesEitherTileOrTileIndexPropertyEqual((int)tile.X, (int)tile.Y, "CanPlantTrees", "Back", "T"), out deniedMessage);
		}
		...
		public virtual bool placementAction(GameLocation location, int x, int y, Farmer who = null)
		{
			...
			if (!bigCraftable && !(this is Furniture))
			{
				...
				{
					string deniedMessage2;
					if (!canPlaceWildTreeSeed(location, placementTile, out deniedMessage2))
					{
						if (deniedMessage2 == null)
						{
							deniedMessage2 = Game1.content.LoadString("Strings\\StringsFromCSFiles:Object.cs.13021");
						}
						Game1.showRedMessage(deniedMessage2);
						return false;
					}
				...
				case "(O)286":
				{
					...
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite(base.ParentSheetIndex, 100f, 1, 24, placementTile * 64f, true, false, location, who)
					{
						shakeIntensity = 0.5f,
					...
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 53f, 5, 9, placementTile * 64f + new Vector2(5f, 3f) * 4f, true, false, (float)(y + 7) / 10000f, 0f, Color.Yellow, 4f, 0f, 0f, 0f)
					{
						id = idNum
					});
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 53f, 5, 9, placementTile * 64f + new Vector2(5f, 3f) * 4f, true, true, (float)(y + 7) / 10000f, 0f, Color.Orange, 4f, 0f, 0f, 0f)
					{
						delayBeforeAnimationStart = 100,
						id = idNum
					});
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 53f, 5, 9, placementTile * 64f + new Vector2(5f, 3f) * 4f, true, false, (float)(y + 7) / 10000f, 0f, Color.White, 3f, 0f, 0f, 0f)
					{
						delayBeforeAnimationStart = 200,
						id = idNum
					});
				...
				case "(O)287":
				{
					...
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 53f, 5, 9, placementTile * 64f, true, false, (float)(y + 7) / 10000f, 0f, Color.Yellow, 4f, 0f, 0f, 0f)
					{
						id = idNum
					});
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 53f, 5, 9, placementTile * 64f, true, false, (float)(y + 7) / 10000f, 0f, Color.Orange, 4f, 0f, 0f, 0f)
					{
						delayBeforeAnimationStart = 100,
						id = idNum
					});
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 53f, 5, 9, placementTile * 64f, true, false, (float)(y + 7) / 10000f, 0f, Color.White, 3f, 0f, 0f, 0f)
					{
						delayBeforeAnimationStart = 200,
						id = idNum
					});
				...
				case "(O)288":
				{
					...
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 53f, 5, 9, placementTile * 64f + new Vector2(5f, 0f) * 4f, true, false, (float)(y + 7) / 10000f, 0f, Color.Yellow, 4f, 0f, 0f, 0f)
					{
						id = idNum
					});
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 53f, 5, 9, placementTile * 64f + new Vector2(5f, 0f) * 4f, true, true, (float)(y + 7) / 10000f, 0f, Color.Orange, 4f, 0f, 0f, 0f)
					{
						delayBeforeAnimationStart = 100,
						id = idNum
					});
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 53f, 5, 9, placementTile * 64f + new Vector2(5f, 0f) * 4f, true, false, (float)(y + 7) / 10000f, 0f, Color.White, 3f, 0f, 0f, 0f)
					{
						delayBeforeAnimationStart = 200,
						id = idNum
					});
				...
				case "(O)895":
				{
					...
					location.playSound("thudStep");
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Microsoft.Xna.Framework.Rectangle(spriteX, 397, 16, 16), 2400f, 1, 1, placementTile * 64f, false, false, -1f, 0f, Color.White, 4f, 0f, 0f, 0f)
					{
						shakeIntensity = 0.5f,
						shakeIntensityChange = 0.002f,
						extraInfoForEndBehavior = idNum,
					...
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Microsoft.Xna.Framework.Rectangle(spriteX, 397, 16, 16), 800f, 1, 0, placementTile * 64f, false, false, -1f, 0f, Color.White, 4f, 0f, 0f, 0f)
					{
					...
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 40f, 5, 5, placementTile * 64f + new Vector2(11f, 12f) * 4f, true, false, (float)(y + 7) / 10000f, 0f, Color.Yellow, 4f, 0f, 0f, 0f)
					{
						id = idNum
					});
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 40f, 5, 5, placementTile * 64f + new Vector2(11f, 12f) * 4f, true, true, (float)(y + 7) / 10000f, 0f, Color.Orange, 4f, 0f, 0f, 0f)
					{
						delayBeforeAnimationStart = 100,
						id = idNum
					});
					Game1.multiplayer.broadcastSprites(location, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(598, 1279, 3, 4), 40f, 5, 5, placementTile * 64f + new Vector2(11f, 12f) * 4f, true, false, (float)(y + 7) / 10000f, 0f, Color.White, 3f, 0f, 0f, 0f)
					{
						delayBeforeAnimationStart = 200,
						id = idNum
					});
				...
				case "(O)805":
				{
					...
					{
						Tree tree2 = terrainFeature5 as Tree;
						if (tree2 != null)
						{
				...
				case "(O)419":
				{
					...
					if (location.terrainFeatures.TryGetValue(placementTile, out terrainFeature4))
					{
						Tree tree = terrainFeature4 as Tree;
						if (tree != null && !tree.stopGrowingMoss.Value)
						{
							tree.hasMoss.Value = false;
							tree.stopGrowingMoss.Value = true;
							Game1.playSound("slosh");
							Game1.playSound("glug");
							Utility.makeTemporarySpriteJuicier(new TemporaryAnimatedSprite(21, tree.Tile * 64f + new Vector2(0f, -64f), new Color(165, 100, 255), 8, false, 80f, 1, -1, (tree.Tile.Y + 1.25f) * 64f / 10000f, 128), location);
							return true;
						}
					}
					return false;
			...
			else
			{
				if (IsTapper())
				{
					...
					{
						Tree tree3 = terrainFeature6 as Tree;
						if (tree3 != null && (int)tree3.growthStage >= 5 && !tree3.stump && !location.objects.ContainsKey(placementTile) && (!tree3.isTemporaryGreenRainTree || Game1.season != Season.Summer))
						{
				...
				if (HasContextTag("torch_item"))
				{
					...
					Torch torch = new Torch(base.ItemId, true);
					torch.shakeTimer = 25;
				...
				{
					AnimalHouse animalHouse = location as AnimalHouse;
					if (animalHouse == null || !animalHouse.name.Contains("Barn"))
					{
			...
			TerrainFeature terrainFeature3;
			if (base.Category == -19 && location.terrainFeatures.TryGetValue(placementTile, out terrainFeature3))
			{
				HoeDirt dirt3 = terrainFeature3 as HoeDirt;
				if (dirt3 != null && dirt3.crop != null && (base.QualifiedItemId == "(O)369" || base.QualifiedItemId == "(O)368") && (int)dirt3.crop.currentPhase != 0)
				{
			...
			if (isSapling())
			{
				...
				{
					HoeDirt dirt2 = terrainFeature2 as HoeDirt;
								...
								if (base.Category == -74)
								{
									foreach (Object o in location.Objects.Values)
									{
										...
										chest.GetMutex().RequestLock(delegate
										{
											...
											{
												Item item = items[0];
												if (item.Category == -19 && ((HoeDirt)terrainFeature).plant(item.ItemId, who, true))
												{
													item.Stack--;
													if (item.Stack <= 0)
													{
