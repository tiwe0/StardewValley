...
namespace StardewValley.TerrainFeatures
{
	...
	public class ResourceClump : TerrainFeature
	{
		...
		public override bool performToolAction(Tool t, int damage, Vector2 tileLocation)
		{
			...
			Game1.createRadialDebris(Game1.currentLocation, radialDebris, (int)tileLocation.X + Game1.random.Next((int)width / 2 + 1), (int)tileLocation.Y + Game1.random.Next((int)height / 2 + 1), Game1.random.Next(4, 9), false);
			if (health.Value <= 0f)
			{
		...
		public bool destroy(Tool t, GameLocation location, Vector2 tileLocation)
		{
			...
			case 602:
			{
				...
				int numChunks2 = (((int)parentSheetIndex == 602) ? 8 : 2);
				Random r;
				...
				Game1.multiplayer.broadcastSprites(Game1.currentLocation, new TemporaryAnimatedSprite(23, tileLocation * 64f, Color.White, 4, false, 140f, 0, 128, -1f, 128));
				Game1.multiplayer.broadcastSprites(Game1.currentLocation, new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(385, 1522, 127, 79), 2000f, 1, 1, tileLocation * 64f + new Vector2(0f, 49f), false, false, 1E-05f, 0.016f, Color.White, 1f, 0f, 0f, 0f));
			...
			case 758:
			{
				...
				{
					Game1.createRadialDebris(Game1.currentLocation, 390, (int)tileLocation.X, (int)tileLocation.Y, numChunks, false, -1, true);
				}
				...
				Game1.multiplayer.broadcastSprites(Game1.currentLocation, new TemporaryAnimatedSprite(48, tileLocation * 64f, c, 5, false, 180f, 0, 128, -1f, 128)
				{
					alphaFade = 0.01f
				});
				return true;
			...
			case 622:
				...
				Game1.multiplayer.broadcastSprites(Game1.currentLocation, new TemporaryAnimatedSprite(5, (tileLocation + new Vector2(1f, 0f)) * 64f, Color.White, 8, false, 110f));
				Game1.multiplayer.broadcastSprites(Game1.currentLocation, new TemporaryAnimatedSprite(5, (tileLocation + new Vector2(1f, 1f)) * 64f, Color.White, 8, true, 80f));
				Game1.multiplayer.broadcastSprites(Game1.currentLocation, new TemporaryAnimatedSprite(5, (tileLocation + new Vector2(0f, 1f)) * 64f, Color.White, 8, false, 90f));
				Game1.multiplayer.broadcastSprites(Game1.currentLocation, new TemporaryAnimatedSprite(5, tileLocation * 64f + new Vector2(32f, 32f), Color.White, 8, false, 70f));
				return true;
			case 44:
			case 46:
			{
