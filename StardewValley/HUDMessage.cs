	...
	public class HUDMessage
	{
		...
		public virtual void draw(SpriteBatch b, int i, ref int heightUsed)
		{
			...
			if (noIcon)
			{
				...
				int height2 = (int)Game1.dialogueFont.MeasureString(message).Y + 64;
			...
			Object obj = messageSubject as Object;
			b.Draw(mouseCursors, position, (obj != null && obj.sellToStorePrice(-1L) > 500) ? new Rectangle(163, 399, 26, 24) : new Rectangle(293, 360, 26, 24), Color.White * transparency, 0f, Vector2.Zero, 4f, SpriteEffects.None, 1f);
