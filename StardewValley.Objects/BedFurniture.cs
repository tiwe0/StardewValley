...
namespace StardewValley.Objects
{
	public class BedFurniture : Furniture
	{
		...
		public virtual bool CanModifyBed(Farmer who)
		{
			...
			FarmHouse farmhouse = location as FarmHouse;
			if (farmhouse != null && farmhouse.owner != who && farmhouse.owner.team.GetSpouse(farmhouse.owner.UniqueMultiplayerID) != who.UniqueMultiplayerID)
			{
				return false;
			}
			return true;
		...
		public override int GetAdditionalFurniturePlacementStatus(GameLocation location, int x, int y, Farmer who = null)
		{
			...
			_003C_003Ec__DisplayClass24_.x = x;
			_003C_003Ec__DisplayClass24_.y = y;
			_003C_003Ec__DisplayClass24_.location = location;
			if (bedType == BedType.Double)
			{
				if (!_003CGetAdditionalFurniturePlacementStatus_003Eg__IsBedsideClear_007C24_0(-1, ref _003C_003Ec__DisplayClass24_))
				{
					return -1;
				}
			}
			else if (!_003CGetAdditionalFurniturePlacementStatus_003Eg__IsBedsideClear_007C24_0(-1, ref _003C_003Ec__DisplayClass24_) && !_003CGetAdditionalFurniturePlacementStatus_003Eg__IsBedsideClear_007C24_0(getTilesWide(), ref _003C_003Ec__DisplayClass24_))
			{
				return -1;
			}
			return base.GetAdditionalFurniturePlacementStatus(_003C_003Ec__DisplayClass24_.location, _003C_003Ec__DisplayClass24_.x, _003C_003Ec__DisplayClass24_.y, who);
		}
		...
		public override bool placementAction(GameLocation location, int x, int y, Farmer who = null)
		{
			...
			FarmHouse farmhouse = location as FarmHouse;
			if (farmhouse != null && ((bedType == BedType.Child && farmhouse.upgradeLevel < 2) || (bedType == BedType.Double && farmhouse.upgradeLevel < 1)))
			{
