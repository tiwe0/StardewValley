	...
	public class NumberSelectionMenu : IClickableMenu
	{
		...
		public override void gamePadButtonHeld(Buttons b)
		{
			...
			if (currentlySnappedComponent.myID == 102)
			{
				...
				tempNumber2 = Math.Min(tempNumber2, Math.Min(maxValue, max_affordable));
			...
			{
				int tempNumber = currentValue - step_size;
				tempNumber = Math.Max(tempNumber, minValue);
				if (tempNumber != currentValue)
				{
