...
namespace StardewValley
{
	...
	public class GameLocation : INetObject<NetFields>, IEquatable<GameLocation>, IAnimalLocation, IHaveModData
	{
		...
		{
			return CheckItemPlantRules(itemId, false, IsGreenhouse || IsFarm || (GetData()?.CanPlantHere ?? false) || (Object.isWildTreeSeed(itemId) && IsOutdoors && doesTileHavePropertyNoNull(tileX, tileY, "Type", "Back") == "Dirt") || (map?.Properties.ContainsKey("ForceAllowTreePlanting") ?? false), out deniedMessage);
		}
		...
		public virtual void MakeMapModifications(bool force = false)
		{
			...
			case "MasteryCave":
			{
				...
				_003C_003Ec__DisplayClass160_0 _003C_003Ec__DisplayClass160_ = default(_003C_003Ec__DisplayClass160_0);
				_003C_003Ec__DisplayClass160_.levelsNotSpent = levelsAchieved - (int)Game1.stats.Get("masteryLevelsSpent");
				_003CMakeMapModifications_003Eg__ShowSkillMastery_007C160_0(4, new Vector2(54f, 98f), ref _003C_003Ec__DisplayClass160_);
				_003CMakeMapModifications_003Eg__ShowSkillMastery_007C160_0(2, new Vector2(84f, 82f), ref _003C_003Ec__DisplayClass160_);
				_003CMakeMapModifications_003Eg__ShowSkillMastery_007C160_0(0, new Vector2(116f, 82f), ref _003C_003Ec__DisplayClass160_);
				_003CMakeMapModifications_003Eg__ShowSkillMastery_007C160_0(0, new Vector2(116f, 82f), ref _003C_003Ec__DisplayClass160_);
				_003CMakeMapModifications_003Eg__ShowSkillMastery_007C160_0(1, new Vector2(148f, 82f), ref _003C_003Ec__DisplayClass160_);
				_003CMakeMapModifications_003Eg__ShowSkillMastery_007C160_0(3, new Vector2(179f, 98f), ref _003C_003Ec__DisplayClass160_);
			...
			case "WizardHouseBasement":
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\terraria_cat", new Microsoft.Xna.Framework.Rectangle(0, 106, 14, 22), new Vector2(16.6f, 2.5f) * 64f, false, 0f, Color.White)
					{
						animationLength = 8,
						interval = 100f,
		...
		public virtual bool ApplyCachedMultiplayerMap(Dictionary<string, CachedMultiplayerMap> cached_data, string requested_map_path)
		{
			...
			if (cached_data.TryGetValue(NameOrUniqueName, out data))
			{
		...
		public virtual void OnTerrainFeatureAdded(TerrainFeature feature, Vector2 location)
		{
			if (feature != null)
			{
				...
				if (flooring == null)
				{
					(feature as HoeDirt)?.OnAdded(this, location);
				}
				else
				{
		...
		public virtual void OnTerrainFeatureRemoved(TerrainFeature feature)
		{
			...
			if (flooring == null)
			{
				...
				if (dirt == null)
				{
					(feature as LargeTerrainFeature)?.onDestroy();
				}
				else
				{
					dirt.OnRemoved();
		...
		private Season? LoadSeasonOverride()
		{
			...
			if (map != null && map.Properties.TryGetValue("SeasonOverride", out propertyValue) && !string.IsNullOrWhiteSpace(propertyValue))
			{
				Season season;
		...
		private void updateFishSplashAnimation()
		{
			...
			fishSplashAnimation = new TemporaryAnimatedSprite(51, new Vector2(fishSplashPoint.X * 64, fishSplashPoint.Y * 64), Color.White, 10, false, 80f, 999999)
			{
		...
		private void updateOrePanAnimation()
		{
			...
			orePanAnimation = new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(432, 1435, 16, 16), new Vector2(orePanPoint.X * 64 + 32, orePanPoint.Y * 64 + 32), false, 0f, Color.White)
			{
		...
		public void cleanUpTileForMapOverride(Point tile)
		{
			...
			Object o;
			if (Objects.TryGetValue(tileVector, out o))
			{
		...
		public void ApplyMapOverride(Map override_map, string override_key, Microsoft.Xna.Framework.Rectangle? source_rect = null, Microsoft.Xna.Framework.Rectangle? dest_rect = null, Action<Point> perTileCustomAction = null)
		{
			...
			map_width = 0;
			map_height = 0;
			for (int layer_index3 = 0; layer_index3 < map.Layers.Count; layer_index3++)
			{
				map_width = Math.Max(map_width, map.Layers[layer_index3].LayerWidth);
				map_height = Math.Max(map_height, map.Layers[layer_index3].LayerHeight);
			}
			bool layersDirty = false;
			for (int layer_index2 = 0; layer_index2 < override_map.Layers.Count; layer_index2++)
			{
				Layer original_layer = map.GetLayer(override_map.Layers[layer_index2].Id);
				if (original_layer == null)
				{
					original_layer = new Layer(override_map.Layers[layer_index2].Id, map, new Size(map_width, map_height), override_map.Layers[layer_index2].TileSize);
		...
		public virtual void HandleGrassGrowth(int dayOfMonth)
		{
			if (dayOfMonth == 1)
			{
				...
				{
					terrainFeatures.RemoveWhere(delegate(KeyValuePair<Vector2, TerrainFeature> pair)
					{
						HoeDirt hoeDirt = pair.Value as HoeDirt;
						return hoeDirt != null && hoeDirt.crop == null && Game1.random.NextDouble() < 0.8;
					});
				}
				...
				if (Game1.IsSpring && Game1.stats.DaysPlayed > 1)
				{
					...
					if (this is Farm || HasMapPropertyWithValue("SpawnRandomGrassOnNewYear"))
					{
						for (int i = 0; i < 15; i++)
						{
							...
							Object o;
							objects.TryGetValue(location, out o);
						...
						if (paths != null)
						{
							for (int x = 0; x < paths.LayerWidth; x++)
							{
								for (int y = 0; y < paths.LayerHeight; y++)
								{
									...
									Object o2;
									objects.TryGetValue(location2, out o2);
									if (o2 == null && getTileIndexAt(new Point(x, y), "Paths") == 22 && isTileLocationOpen(location2) && !IsTileOccupiedBy(location2))
									{
										terrainFeatures.Add(location2, new Grass(1, 4));
									}
								}
							}
						}
		...
		public Warp isCollidingWithWarp(Microsoft.Xna.Framework.Rectangle position, Character character)
		{
			...
			foreach (Warp w in warps)
			{
				...
				if (!(targetName == "BoatTunnel"))
				{
					...
					{
						return new Warp(w.X, w.Y, VolcanoDungeon.GetLevelName(0), w.TargetX, w.TargetY, false);
					}
				}
				else if (character is NPC)
				{
					return new Warp(w.X, w.Y, "IslandSouth", 17, 43, false);
				}
				return w;
			}
			return null;
		...
		public virtual Warp isCollidingWithDoors(Microsoft.Xna.Framework.Rectangle position, Character character = null)
		{
			for (int i = 0; i < 4; i++)
			{
				...
				foreach (KeyValuePair<Point, string> pair in doors.Pairs)
				{
					...
					{
						Warp warp2 = getWarpFromDoor(door, character);
						if (warp2 != null)
						{
							return warp2;
						}
		...
		public virtual Warp getWarpFromDoor(Point door, Character character = null)
		{
			foreach (Building building in buildings)
			{
				if (door == building.getPointForHumanDoor())
				{
					...
					if (interior != null)
					{
						return new Warp(door.X, door.Y, interior.NameOrUniqueName, interior.warps[0].X, interior.warps[0].Y - 1, false);
					}
				}
			}
			...
			case "WarpBoatTunnel":
				if (!(character is NPC))
				{
					return new Warp(door.X, door.Y, "BoatTunnel", 6, 11, false);
				}
				return new Warp(door.X, door.Y, "IslandSouth", 17, 43, false);
			case "LockedDoorWarp":
			case "Warp":
			case "WarpMensLocker":
			case "WarpWomensLocker":
			{
				...
				string error;
				string locationName;
				if (!ArgUtility.TryGetPoint(split, 1, out tile, out error) || !ArgUtility.TryGet(split, 3, out locationName, out error))
				{
				...
				{
					return new Warp(door.X, door.Y, locationName, tile.X, tile.Y, false);
				}
				return new Warp(door.X, door.Y, "IslandSouth", 17, 43, false);
			}
			default:
		...
		{
			return isCollidingPosition(position, viewport, character is Farmer, 0, false, character, false);
		}
		...
		{
			return isCollidingPosition(position, viewport, character is Farmer, damagesFarmer, glider, character, false);
		}
		...
		public virtual Microsoft.Xna.Framework.Rectangle GetBuildableRectangle()
		{
			if (!_buildableTileRect.HasValue)
			{
				...
				_buildableTileRect = (TryGetMapPropertyAs("ValidBuildRect", out area, false) ? area : Microsoft.Xna.Framework.Rectangle.Empty);
		...
		public virtual bool isCollidingPosition(Microsoft.Xna.Framework.Rectangle position, xTile.Dimensions.Rectangle viewport, bool isFarmer, int damagesFarmer, bool glider, Character character, bool pathfinding, bool projectile = false, bool ignoreCharacterRequirement = false, bool skipCollisionEffects = false)
		{
			...
			if (!glider)
			{
				...
				{
					foreach (FarmAnimal animal3 in animals.Values)
					{
						Microsoft.Xna.Framework.Rectangle animalBounds = animal3.GetBoundingBox();
				...
				if (buildings.Count > 0)
				{
					foreach (Building b in buildings)
					{
						...
						if (!(character is FarmAnimal) && !(character is JunimoHarvester))
						{
							if (character is NPC)
							{
								Microsoft.Xna.Framework.Rectangle door2 = b.getRectForHumanDoor();
								door2.Height += 64;
				...
				if (resourceClumps.Count > 0)
				{
					...
					{
						Microsoft.Xna.Framework.Rectangle bounds2 = resourceClump.getBoundingBox();
			...
			if (!glider)
			{
				...
				{
					Object value3;
					if (objects.TryGetValue(corner, out value3) && value3 != null)
					{
				...
				_TestCornersTiles(nextTopRight, nextTopLeft, nextBottomRight, nextBottomLeft, nextTopMid, nextBottomMid, null, null, null, null, null, null, nextLargerThanTile, delegate(Vector2 corner)
				{
					...
					if (terrainFeatures.TryGetValue(corner, out value2) && value2 != null && value2.getBoundingBox().Intersects(position) && !pathfinding && character != null && !skipCollisionEffects)
					{
				...
				if (_TestCornersTiles(nextTopRight, nextTopLeft, nextBottomRight, nextBottomLeft, nextTopMid, nextBottomMid, currentTopRight, currentTopLeft, currentBottomRight, currentBottomLeft, currentTopMid, currentBottomMid, nextLargerThanTile, (Vector2 corner) => (terrainFeatures.TryGetValue(corner, out value) && value != null && value.getBoundingBox().Intersects(position) && !value.isPassable(character)) ? true : false))
				{
					return true;
				}
			}
			...
			else
			{
				...
				int level;
				if (((bool)isFarm || MineShaft.IsGeneratedLevel(this, out level) || this is IslandLocation) && character != null && !character.Name.Contains("NPC") && !character.EventActor && !glider)
				{
					Tile t3;
					...
					{
						t3 = back_layer.Tiles[(int)tile.X, (int)tile.Y];
						return (t3 != null && t3.Properties.ContainsKey("NPCBarrier")) ? true : false;
					}))
					{
						return true;
					}
			...
			if (!isFarmer || !Game1.player.isRafting)
			{
				...
				if (_TestCornersTiles(nextTopRight, nextTopLeft, nextBottomRight, nextBottomLeft, nextTopMid, nextBottomMid, currentTopRight, currentTopLeft, currentBottomRight, currentBottomLeft, currentTopMid, currentBottomMid, nextLargerThanTile, delegate(Vector2 tile)
				{
					t2 = back_layer.Tiles[(int)tile.X, (int)tile.Y];
					return (t2 != null && t2.Properties.ContainsKey("TemporaryBarrier")) ? true : false;
				}))
				{
					return true;
				}
			...
			if (!isFarmer || !Game1.player.isRafting)
			{
				...
				if ((animal == null || !animal.IsActuallySwimming()) && _TestCornersTiles(nextTopRight, nextTopLeft, nextBottomRight, nextBottomLeft, nextTopMid, nextBottomMid, currentTopRight, currentTopLeft, currentBottomRight, currentBottomLeft, currentTopMid, currentBottomMid, nextLargerThanTile, delegate(Vector2 tile)
				{
					Tile tile4 = back_layer.Tiles[(int)tile.X, (int)tile.Y];
					if (tile4 != null)
					{
						bool flag3 = tile4.TileIndexProperties.ContainsKey("Passable");
						if (!flag3)
						{
							flag3 = tile4.Properties.ContainsKey("Passable");
						}
						if (flag3)
						{
					...
					if (_TestCornersTiles(nextTopRight, nextTopLeft, nextBottomRight, nextBottomLeft, nextTopMid, nextBottomMid, currentTopRight, currentTopLeft, currentBottomRight, currentBottomLeft, currentTopMid, currentBottomMid, nextLargerThanTile, delegate(Vector2 tile)
					{
						...
						if (tmp != null)
						{
							if (projectile && this is VolcanoDungeon)
							{
								...
								if (tile3 != null)
								{
									if (tile3.TileIndexProperties.ContainsKey("Water"))
									{
										return false;
									}
									if (tile3.Properties.ContainsKey("Water"))
									{
										return false;
									}
								}
		...
		public Point getWarpPointTarget(Point warpPointLocation, Character character = null)
		{
			...
			foreach (KeyValuePair<Point, string> v in doors.Pairs)
			{
				...
				default:
				{
					...
					defaultInterpolatedStringHandler.AppendFormatted(NameOrUniqueName);
					defaultInterpolatedStringHandler.AppendLiteral(" (");
					defaultInterpolatedStringHandler.AppendFormatted(v.Key);
					defaultInterpolatedStringHandler.AppendLiteral(") has unknown warp property '");
				...
				string error;
				string locationName;
				if (!ArgUtility.TryGetPoint(action, 1, out tile, out error) || !ArgUtility.TryGet(action, 3, out locationName, out error))
				{
		...
		public void switchOutNightTiles()
		{
			...
			for (int i = 0; i < split.Length; i += 4)
			{
				...
				Point position;
				int tileIndex;
				if (!ArgUtility.TryGet(split, i, out layerId, out error) || !ArgUtility.TryGetPoint(split, i + 1, out position, out error) || !ArgUtility.TryGetInt(split, i + 3, out tileIndex, out error))
				{
				...
				else if ((tileIndex != 726 && tileIndex != 720) || !Game1.MasterPlayer.mailReceived.Contains("pamHouseUpgrade"))
				{
					...
					if (tile == null)
					{
						...
						defaultInterpolatedStringHandler.AppendLiteral(")");
						LogMapPropertyError("NightTiles", split, defaultInterpolatedStringHandler.ToStringAndClear());
					}
					else
					{
			...
			if (newLocationMusic == null)
			{
				...
				if (!PlayedNewLocationContextMusic)
				{
					if (newLocationContext.DefaultMusic != null)
					{
						...
						{
							Game1.changeMusicTrack(newLocationContext.DefaultMusic, true);
		...
		public virtual void checkForMusic(GameTime time)
		{
			...
			if (isMusicTownMusic.HasValue && isMusicTownMusic.Value && !Game1.eventUp && Game1.timeOfDay < 1800 && (Game1.isMusicContextActiveButNotPlaying() || Game1.IsPlayingOutdoorsAmbience))
			{
				...
				{
					MusicContext context3 = GetData()?.MusicContext ?? MusicContext.Default;
					Game1.changeMusicTrack(townMusicTrack, false, context3);
					Game1.IsPlayingBackgroundMusic = true;
			...
			if (IsOutdoors && !IsRainingHere() && !Game1.eventUp)
			{
				...
				if (!isNight)
				{
					LocationContextData context2 = GetLocationContext();
					if (context2.DayAmbience != null)
					{
						Game1.changeMusicTrack(context2.DayAmbience, true);
					}
					else
					{
						switch (GetSeason())
				...
				else
				{
					...
					{
						Game1.changeMusicTrack(context.NightAmbience, true);
					}
					else
					{
						switch (GetSeason())
		...
		public virtual string GetLocationSpecificMusic()
		{
			...
			if (musicFields.Length != 0)
			{
				if (musicFields.Length > 1)
				{
					...
					int endTime;
					string musicId;
					if (!ArgUtility.TryGetInt(musicFields, 0, out startTime, out error) || !ArgUtility.TryGetInt(musicFields, 1, out endTime, out error) || !ArgUtility.TryGet(musicFields, 2, out musicId, out error))
					{
		...
		public bool moveObject(int oldX, int oldY, int newX, int newY, string unlessItemId)
		{
			...
			Object o;
			if (objects.TryGetValue(oldObjectLocation, out o) && !objects.ContainsKey(newObjectLocation) && (unlessItemId == null || !ItemRegistry.HasItemId(o, unlessItemId)))
			{
		...
		{
			_003C_003Ec__DisplayClass266_0 _003C_003Ec__DisplayClass266_ = default(_003C_003Ec__DisplayClass266_0);
			_003C_003Ec__DisplayClass266_._003C_003E4__this = this;
			_003C_003Ec__DisplayClass266_.action = action;
			_003C_003Ec__DisplayClass266_.playerStandingPosition = playerStandingPosition;
			...
			try
			{
				string actionType;
				string error;
				if (!ArgUtility.TryGet(_003C_003Ec__DisplayClass266_.action, 0, out actionType, out error))
				{
					_003CperformTouchAction_003Eg__LogError_007C266_0(error, ref _003C_003Ec__DisplayClass266_);
					return;
				}
				Action<GameLocation, string[], Farmer, Vector2> actionHandler;
				if (registeredTouchActions.TryGetValue(actionType, out actionHandler))
				{
					actionHandler(this, _003C_003Ec__DisplayClass266_.action, Game1.player, _003C_003Ec__DisplayClass266_.playerStandingPosition);
					return;
				}
				switch (actionType)
				{
				case "MagicalSeal":
				{
					...
					for (int i = 0; i < 40; i++)
					{
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(666, 1851, 8, 8), 25f, 4, 2, new Vector2(3f, 19f) * 64f + new Vector2(-8 + i % 4 * 16, -(i / 4) * 64 / 4), false, false)
						{
						...
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(666, 1851, 8, 8), 25f, 4, 2, new Vector2(3f, 17f) * 64f + new Vector2(-8 + i % 4 * 16, i / 4 * 64 / 4), false, false)
						{
							layerDepth = 0.1152f + (float)i / 10000f,
				...
				case "PlayEvent":
				{
					...
					if (!ArgUtility.TryGet(_003C_003Ec__DisplayClass266_.action, 1, out eventId, out error) || !ArgUtility.TryGetOptionalBool(_003C_003Ec__DisplayClass266_.action, 2, out checkPreconditions, out error, true) || !ArgUtility.TryGetOptionalBool(_003C_003Ec__DisplayClass266_.action, 3, out checkSeen, out error, true) || !ArgUtility.TryGetOptionalRemainder(_003C_003Ec__DisplayClass266_.action, 4, out fallbackAction))
					{
						_003CperformTouchAction_003Eg__LogError_007C266_0(error, ref _003C_003Ec__DisplayClass266_);
					}
					else if (!Game1.PlayEvent(eventId, checkPreconditions, checkSeen) && fallbackAction != null)
					{
						performAction(fallbackAction, Game1.player, new Location((int)_003C_003Ec__DisplayClass266_.playerStandingPosition.X, (int)_003C_003Ec__DisplayClass266_.playerStandingPosition.Y));
					}
					break;
				}
				case "Warp":
				{
					...
					Point tile2;
					string mailRequired;
					if (!ArgUtility.TryGet(_003C_003Ec__DisplayClass266_.action, 1, out locationToWarp2, out error) || !ArgUtility.TryGetPoint(_003C_003Ec__DisplayClass266_.action, 2, out tile2, out error) || !ArgUtility.TryGetOptional(_003C_003Ec__DisplayClass266_.action, 4, out mailRequired, out error))
					{
						_003CperformTouchAction_003Eg__LogError_007C266_0(error, ref _003C_003Ec__DisplayClass266_);
					}
				...
				case "MagicWarp":
				{
					...
					if (!ArgUtility.TryGet(_003C_003Ec__DisplayClass266_.action, 1, out locationToWarp, out error) || !ArgUtility.TryGetPoint(_003C_003Ec__DisplayClass266_.action, 2, out tile, out error) || !ArgUtility.TryGetOptional(_003C_003Ec__DisplayClass266_.action, 4, out mailRequired2, out error))
					{
						_003CperformTouchAction_003Eg__LogError_007C266_0(error, ref _003C_003Ec__DisplayClass266_);
					}
					else if (mailRequired2 == null || Game1.player.mailReceived.Contains(mailRequired2))
					{
						for (int j = 0; j < 12; j++)
						{
							Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite(354, Game1.random.Next(25, 75), 6, 1, new Vector2(Game1.random.Next((int)Game1.player.position.X - 256, (int)Game1.player.position.X + 192), Game1.random.Next((int)Game1.player.position.Y - 256, (int)Game1.player.position.Y + 192)), false, Game1.random.NextBool()));
						}
						playSound("wand");
						...
						{
							Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite(6, new Vector2(x, playerTile.Y) * 64f, Color.White, 8, false, 50f)
							{
								layerDepth = 1f,
				...
				{
					if (_003C_003Ec__DisplayClass266_.action.Length <= 1 || Game1.eventUp)
					{
						break;
					}
					StringBuilder s = new StringBuilder();
					for (int k = 1; k < _003C_003Ec__DisplayClass266_.action.Length; k++)
					{
						s.Append(_003C_003Ec__DisplayClass266_.action[k]);
						if (k < _003C_003Ec__DisplayClass266_.action.Length - 1)
						{
							s.Append(" ");
						}
					}
					...
					string message = doesTileHaveProperty((int)_003C_003Ec__DisplayClass266_.playerStandingPosition.X / 64, (int)_003C_003Ec__DisplayClass266_.playerStandingPosition.Y / 64, "LockedDoorMessage", "Buildings");
					if (message != null)
					{
				...
				case "Door":
				{
					for (int l = 1; l < _003C_003Ec__DisplayClass266_.action.Length && (!(_003C_003Ec__DisplayClass266_.action[l] == "Sebastian") || !IsGreenRainingHere() || Game1.year != 1); l++)
					{
						if (Game1.player.getFriendshipHeartLevelForNPC(_003C_003Ec__DisplayClass266_.action[l]) < 2 && l == _003C_003Ec__DisplayClass266_.action.Length - 1)
						{
							Game1.player.Position -= Game1.player.getMostRecentMovementVector() * 2f;
							Game1.player.yVelocity = 0f;
							Game1.player.Halt();
							...
							if ((!Game1.player.mailReceived.Contains("doorUnlock" + _003C_003Ec__DisplayClass266_.action[1]) || (_003C_003Ec__DisplayClass266_.action.Length != 2 && !Game1.player.mailReceived.Contains("doorUnlock" + _003C_003Ec__DisplayClass266_.action[2]))) && (_003C_003Ec__DisplayClass266_.action.Length != 3 || !Game1.player.mailReceived.Contains("doorUnlock" + _003C_003Ec__DisplayClass266_.action[2])))
							{
								if (_003C_003Ec__DisplayClass266_.action.Length == 2)
								{
									NPC character = Game1.getCharacterFromName(_003C_003Ec__DisplayClass266_.action[1]);
								...
								{
									NPC character2 = Game1.getCharacterFromName(_003C_003Ec__DisplayClass266_.action[1]);
									NPC character3 = Game1.getCharacterFromName(_003C_003Ec__DisplayClass266_.action[2]);
									Game1.drawObjectDialogue(Game1.content.LoadString("Strings\\Locations:DoorUnlock_NotFriend_Couple", character2.displayName, character3.displayName));
								}
							}
							break;
						}
						if (l != _003C_003Ec__DisplayClass266_.action.Length - 1 && Game1.player.getFriendshipHeartLevelForNPC(_003C_003Ec__DisplayClass266_.action[l]) >= 2)
						{
							Game1.player.mailReceived.Add("doorUnlock" + _003C_003Ec__DisplayClass266_.action[l]);
							break;
						}
						if (l == _003C_003Ec__DisplayClass266_.action.Length - 1 && Game1.player.getFriendshipHeartLevelForNPC(_003C_003Ec__DisplayClass266_.action[l]) >= 2)
						{
				...
				case "FaceDirection":
				{
					string npcName;
					int direction;
					if (!ArgUtility.TryGet(_003C_003Ec__DisplayClass266_.action, 1, out npcName, out error) || !ArgUtility.TryGetInt(_003C_003Ec__DisplayClass266_.action, 2, out direction, out error))
					{
						_003CperformTouchAction_003Eg__LogError_007C266_0(error, ref _003C_003Ec__DisplayClass266_);
					}
					else
				...
				case "Emote":
				{
					string npcName2;
					int emote;
					if (!ArgUtility.TryGet(_003C_003Ec__DisplayClass266_.action, 1, out npcName2, out error) || !ArgUtility.TryGetInt(_003C_003Ec__DisplayClass266_.action, 2, out emote, out error))
					{
						_003CperformTouchAction_003Eg__LogError_007C266_0(error, ref _003C_003Ec__DisplayClass266_);
					}
					else
					{
						getCharacterFromName(npcName2)?.doEmote(emote);
					}
					break;
				}
				case "legendarySword":
				...
				case "PoolEntrance":
					if (!Game1.player.swimming)
					{
						...
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite(27, 100f, 4, 0, new Vector2(Game1.player.Position.X, Game1.player.StandingPixel.Y - 40), false, false)
						{
							layerDepth = 1f,
					...
					else
					{
						Game1.player.jump();
						Game1.player.swimTimer = 800;
						Game1.player.position.X = _003C_003Ec__DisplayClass266_.playerStandingPosition.X * 64f;
						playSound("pullItemFromWater");
						Game1.player.yVelocity = 8f;
		...
		public virtual void UpdateWhenCurrentLocation(GameTime time)
		{
			...
			for (int m = 0; m < furniture.Count; m++)
			{
				furniture[m].updateWhenCurrentLocation(time);
			}
			AmbientLocationSounds.update(time);
			if (critters != null)
			{
				for (int n = critters.Count - 1; n >= 0; n--)
				{
					if (critters[n].update(time, this))
					{
						critters.RemoveAt(n);
					}
				}
			...
			if (fishSplashAnimation != null)
			{
				...
				if (frenzy && Game1.random.NextDouble() < 0.005)
				{
					...
					{
						TemporarySprites.Add(new TemporaryAnimatedSprite(28, 100f, 2, 1, pos, false, false)
						{
					...
					TemporarySprites.Add(new TemporaryAnimatedSprite(fishData.GetTextureName(), fishData.GetSourceRect(), position, flip, 0f, Color.White)
					{
						...
						reachedStopCoordinateSprite = delegate(TemporaryAnimatedSprite x)
						{
							...
							ICue cue2;
							Game1.sounds.PlayLocal("dropItemInWater", this, position / 64f, null, SoundContext.Default, out cue2);
			...
			if (orePanAnimation != null)
			{
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(432, 1435, 16, 16), orePanAnimation.position + new Vector2(Game1.random.Next(-32, 32), Game1.random.Next(-32, 32)), false, 0.02f, Color.White * 0.8f)
					{
						scale = 2f,
						animationLength = 6,
						interval = 100f
			...
			for (int j = _activeTerrainFeatures.Count - 1; j >= 0; j--)
			{
			...
			if (Game1.gameMode == 3 && this == Game1.currentLocation)
			{
				...
				foreach (Farmer farmer in farmers)
				{
					...
					{
						Vector2 offset2 = directionsTileVectorsWithDiagonals[num];
						Vector2 v = playerPos + offset2;
						Object obj;
						if (objects.TryGetValue(v, out obj))
						{
							obj.farmerAdjacentAction(farmer, offset2.X != 0f && offset2.Y != 0f);
						}
					}
				}
				if (Game1.player != null)
				{
					...
					_003C_003Ec__DisplayClass270_1 _003C_003Ec__DisplayClass270_ = default(_003C_003Ec__DisplayClass270_1);
					_003C_003Ec__DisplayClass270_.player_position = Game1.player.Tile;
					Object sign = null;
					if (direction >= 0 && direction < 4)
					{
						Vector2 offset = Utility.DirectionsTileVectors[direction];
						sign = _003CUpdateWhenCurrentLocation_003Eg__CheckForSign_007C270_2((int)offset.X, (int)offset.Y, ref _003C_003Ec__DisplayClass270_);
					}
					if (sign == null)
					{
						sign = _003CUpdateWhenCurrentLocation_003Eg__CheckForSign_007C270_2(0, -1, ref _003C_003Ec__DisplayClass270_) ?? _003CUpdateWhenCurrentLocation_003Eg__CheckForSign_007C270_2(0, 1, ref _003C_003Ec__DisplayClass270_) ?? _003CUpdateWhenCurrentLocation_003Eg__CheckForSign_007C270_2(-1, 0, ref _003C_003Ec__DisplayClass270_) ?? _003CUpdateWhenCurrentLocation_003Eg__CheckForSign_007C270_2(1, 0, ref _003C_003Ec__DisplayClass270_) ?? _003CUpdateWhenCurrentLocation_003Eg__CheckForSign_007C270_2(-1, -1, ref _003C_003Ec__DisplayClass270_) ?? _003CUpdateWhenCurrentLocation_003Eg__CheckForSign_007C270_2(1, -1, ref _003C_003Ec__DisplayClass270_) ?? _003CUpdateWhenCurrentLocation_003Eg__CheckForSign_007C270_2(-1, 1, ref _003C_003Ec__DisplayClass270_) ?? _003CUpdateWhenCurrentLocation_003Eg__CheckForSign_007C270_2(1, 1, ref _003C_003Ec__DisplayClass270_);
					}
					if (sign != null)
					{
		...
		public virtual void monsterDrop(Monster monster, int x, int y, Farmer who)
		{
			...
			for (int j = 0; j < extraDrops.Count; j++)
			{
				debrisToAdd.Add(monster.ModifyMonsterLoot(new Debris(extraDrops[j], new Vector2(x, y), playerPosition)));
			}
			...
			if (who.isWearingRing("526"))
			{
				...
				{
					Item tmp3 = extraDrops[i].getOne();
					tmp3.Stack = extraDrops[i].Stack;
					tmp3.HasBeenInInventory = false;
					debrisToAdd.Add(monster.ModifyMonsterLoot(new Debris(tmp3, new Vector2(x, y), playerPosition)));
				}
			}
			...
			if (who.stats.Get("Book_Void") != 0 && Game1.random.NextDouble() < 0.03 && debrisToAdd != null && monster != null)
			{
				foreach (Debris d in debrisToAdd)
				{
					if (d.item != null)
					{
						Item tmp2 = d.item.getOne();
						if (tmp2 != null)
						{
							tmp2.Stack = d.item.Stack;
		...
		{
			return damageMonster(areaOfEffect, minDamage, maxDamage, isBomb, 1f, 0, 0f, 1f, false, who, isProjectile);
		}
			...
			if (!monster.isGlider && !(who.CurrentTool is Slingshot) && !monster.ignoreDamageLOS.Value)
			{
				...
				if (Math.Abs(farmerStandingPoint.X - monsterStandingPoint.X) + Math.Abs(farmerStandingPoint.Y - monsterStandingPoint.Y) > 1)
				{
					...
					while (xDif != 0 || yDif != 0)
					{
						...
						Object obj;
						if ((objects.TryGetValue(pointInQuestion, out obj) && !obj.isPassable()) || BlocksDamageLOS((int)pointInQuestion.X, (int)pointInQuestion.Y))
						{
							return false;
						}
					}
		...
		public bool damageMonster(Microsoft.Xna.Framework.Rectangle areaOfEffect, int minDamage, int maxDamage, bool isBomb, float knockBackModifier, int addedPrecision, float critChance, float critMultiplier, bool triggerMonsterInvincibleTimer, Farmer who, bool isProjectile = false)
		{
			...
			for (int i = characters.Count - 1; i >= 0; i--)
			{
				...
				if (monster.IsInvisible || monster.isInvincible() || (!isBomb && !isProjectile && !isMonsterDamageApplicable(who, monster) && !isMonsterDamageApplicable(who, monster, false)))
				{
					continue;
				}
				int num;
				...
				{
					Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite(362, Game1.random.Next(50, 120), 6, 1, new Vector2(monsterBox.Center.X - 32, monsterBox.Center.Y - 32), false, false));
				}
				if (monster.Health <= 0)
				{
				...
				else if (damageAmount > 0)
				{
					...
					if (crit)
					{
						...
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite(362, Game1.random.Next(15, 50), 6, 1, standPos - new Vector2(32f, 32f), false, Game1.random.NextBool())
						{
							scale = 0.75f,
							alpha = (crit ? 0.75f : 0.5f)
						});
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite(362, Game1.random.Next(15, 50), 6, 1, standPos - new Vector2(32 + Game1.random.Next(-21, 21) + 32, 32 + Game1.random.Next(-21, 21)), false, Game1.random.NextBool())
						{
							scale = 0.5f,
		...
		private void onMonsterKilled(Farmer who, Monster monster, Microsoft.Xna.Framework.Rectangle monsterBox)
		{
			...
			if (who != null && !(this is SlimeHutch))
			{
				...
				if (slime == null || (bool)slime.firstGeneration)
				{
			...
			if (who != null && who.CurrentTool != null)
			{
				MeleeWeapon weapon = who.CurrentTool as MeleeWeapon;
		...
		public virtual void DayUpdate(int dayOfMonth)
		{
			...
			for (int i = characters.Count - 1; i >= 0; i--)
			{
				...
				else
				{
					...
					if (monster != null && monster.wildernessFarmMonster)
					{
						characters.RemoveAt(i);
					}
				}
			...
			{
				KeyValuePair<Vector2, TerrainFeature> pair2 = array2[k];
				if (!isTileOnMap(pair2.Key))
				{
					terrainFeatures.Remove(pair2.Key);
				}
				else
				{
					pair2.Value.dayUpdate();
				}
			}
			array2 = map_features;
			foreach (KeyValuePair<Vector2, TerrainFeature> pair3 in array2)
			{
				(pair3.Value as HoeDirt)?.updateNeighbors();
			}
			if (largeTerrainFeatures != null)
			{
			...
			objects.Lock();
			foreach (KeyValuePair<Vector2, Object> pair5 in objects.Pairs)
			{
				pair5.Value.DayUpdate();
				if (pair5.Value.destroyOvernight)
				{
					pair5.Value.performRemoveAction();
					objects.Remove(pair5.Key);
				}
			}
			objects.Unlock();
			...
			if (map != null && ((bool)isOutdoors || map.Properties.ContainsKey("ForceSpawnForageables")) && !map.Properties.ContainsKey("skipWeedGrowth"))
			{
				if (Game1.dayOfMonth % 7 == 0 && !(this is Farm))
				{
					...
					{
						KeyValuePair<Vector2, Object> pair4 = array4[k];
						if ((bool)pair4.Value.isSpawnedObject && !ignoreRectangle.Contains(Utility.Vector2ToPoint(pair4.Key)))
						{
							objects.Remove(pair4.Key);
						}
					}
				...
				if (pathsLayer != null && !(this is Farm))
				{
					for (int x = 0; x < map.Layers[0].LayerWidth; x++)
					{
						for (int y = 0; y < map.Layers[0].LayerHeight; y++)
						{
							...
							bool isFruitTree;
							if (!TryGetTreeIdForTile(pathsLayer.Tiles[x, y], out treeId, out growthStageOnLoad, out growthStageOnRegrow, out isFruitTree) || !Game1.random.NextBool())
							{
								continue;
							}
			...
			terrainFeatures.RemoveWhere(delegate(KeyValuePair<Vector2, TerrainFeature> pair)
			{
				HoeDirt hoeDirt = pair.Value as HoeDirt;
				Object value;
				return hoeDirt != null && (hoeDirt.crop == null || (bool)hoeDirt.crop.forageCrop) && (!objects.TryGetValue(pair.Key, out value) || value == null || !value.IsSpawnedObject || !value.isForage()) && Game1.random.NextBool(GetDirtDecayChance(pair.Key));
			});
			lightLevel.Value = 0f;
		...
		{
			double chance;
			if (TryGetMapPropertyAs("DirtDecayChance", out chance, false))
			{
				return chance;
			}
			if (IsGreenhouse)
		...
		public void RespawnStumpsFromMapProperty()
		{
			...
			for (int i = 0; i < stumpData.Length; i += 3)
			{
				Vector2 tile;
				string error;
				if (!ArgUtility.TryGetVector2(stumpData, i, out tile, out error))
				{
				...
				if (!foundStump)
				{
					...
					removeObject(tile + new Vector2(1f, 0f), false);
					removeObject(tile + new Vector2(1f, 1f), false);
					removeObject(tile + new Vector2(0f, 1f), false);
				}
			}
		}
		...
		public void addLightGlows()
		{
			...
			for (int i = 0; i < split.Length; i += 4)
			{
				...
				Vector2 position;
				int tileIndex;
				if (!ArgUtility.TryGet(split, i, out layerId, out error) || !ArgUtility.TryGetVector2(split, i + 1, out position, out error) || !ArgUtility.TryGetInt(split, i + 3, out tileIndex, out error))
				{
		...
		{
			string value;
			if (!TryGetMapProperty(propertyName, out value))
			{
				return null;
			}
			return value;
		...
		{
			string value;
			if (!TryGetMapProperty(propertyName, out value) || value == null)
			{
		...
		{
			string raw;
			if (!TryGetMapProperty(key, out raw))
			{
				if (required)
				{
		...
		public bool TryGetMapPropertyAs(string key, out Point parsed, bool required = false)
		{
			...
			string error;
			if (!ArgUtility.TryGetPoint(fields, 0, out parsed, out error))
			{
		...
		public bool TryGetMapPropertyAs(string key, out Vector2 parsed, bool required = false)
		{
			...
			string error;
			if (!ArgUtility.TryGetVector2(fields, 0, out parsed, out error))
			{
				LogMapPropertyError(key, fields, error);
				parsed = Vector2.Zero;
				return false;
		...
		public bool TryGetMapPropertyAs(string key, out Microsoft.Xna.Framework.Rectangle parsed, bool required = false)
		{
			...
			string error;
			if (!ArgUtility.TryGetRectangle(fields, 0, out parsed, out error))
			{
				LogMapPropertyError(key, fields, error);
				parsed = Microsoft.Xna.Framework.Rectangle.Empty;
				return false;
		...
		{
			string rawValue;
			if (map != null && Map.Properties.TryGetValue(propertyName, out rawValue))
			{
				if (rawValue == null)
				{
					return false;
		...
		public void setFireplace(bool on, int tileLocationX, int tileLocationY, bool playSound = true, int xOffset = 0, int yOffset = 0)
		{
			...
			if (on)
			{
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(276, 1985, 12, 11), new Vector2(tileLocationX, tileLocationY) * 64f + new Vector2(32f, -32f) + new Vector2(xOffset, yOffset), false, 0f, Color.White)
					{
						interval = 50f,
					...
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(276, 1985, 12, 11), new Vector2(tileLocationX + 1, tileLocationY) * 64f + new Vector2(-16f, -32f) + new Vector2(xOffset, yOffset), false, 0f, Color.White)
					{
		...
		public void addWoodpecker(double chance, bool onlyIfOnScreen = false)
		{
			...
			for (int i = 0; i < 3; i++)
			{
				...
				if (!Utility.TryGetRandom(terrainFeatures, out tile, out feature))
				{
					continue;
				}
		...
		public void addSquirrels(double chance, bool onlyIfOnScreen = false)
		{
			...
			for (int i = 0; i < 3; i++)
			{
				Vector2 pos;
				TerrainFeature feature;
				if (!Utility.TryGetRandom(terrainFeatures, out pos, out feature))
				{
					continue;
				}
				Tree tree = feature as Tree;
				if (tree == null || (int)tree.growthStage < 5 || (bool)tree.stump)
				{
					continue;
				}
		...
		public void tryAddPrismaticButterfly()
		{
			...
			critters.Add(new Butterfly(this, prism_v, false, false, 394, true)
			{
				stayInbounds = true
			});
		}
		...
		public void addFrog()
		{
			...
			for (int i = 0; i < 3; i++)
			{
				...
				for (int j = 0; j < distanceToCheck; j++)
				{
					...
					{
						critters.Add(new Frog(v, true, flip));
						return;
					}
				}
			}
		...
		public void refurbishMapPortion(Microsoft.Xna.Framework.Rectangle areaToRefurbish, string refurbishedMapName, Point mapReaderStartPoint)
		{
			...
			foreach (Point toTile in areaToRefurbish.GetPoints())
			{
				...
				if (fromBackTile != null)
				{
					...
					foreach (string propertyName2 in fromBackTile.Properties.Keys)
					{
						toBackLayer.Tiles[toTile.X, toTile.Y].Properties.Add(propertyName2, fromBackTile.Properties[propertyName2]);
					}
				}
		...
		public void performGreenRainUpdate()
		{
				...
				for (int x = 0; x < pathsLayer.LayerWidth; x++)
				{
					for (int y = 0; y < pathsLayer.LayerHeight; y++)
					{
						...
						if (tile != null && tile.TileIndexProperties.ContainsKey("GreenRain"))
						{
							...
							{
								terrainFeatures.Add(tilePos, (this is Forest) ? new Tree("12", 5, true) : new Tree((10 + (Game1.random.NextBool(0.1) ? 2 : Game1.random.Choose(1, 0))).ToString(), 5, true));
							}
						}
					}
				}
			...
			for (int j = 0; j < trees.Length; j += 3)
			{
				Vector2 position;
				string error;
				int treeType;
				if (!ArgUtility.TryGetVector2(trees, j, out position, out error) || !ArgUtility.TryGetInt(trees, j + 2, out treeType, out error))
				{
			...
			for (int k = 0; k < array.Length; k++)
			{
				(array[k] as Tree)?.onGreenRainDay();
			}
			int mapArea = map.Layers[0].LayerWidth * map.Layers[0].LayerHeight;
			spawnWeedsAndStones(mapArea / 16, true, false);
			spawnWeedsAndStones(mapArea / 8, true);
			for (int i = 0; i < mapArea / 4; i++)
			{
				...
				Object bottomRight;
				Object bottomLeft;
				if (objects.TryGetValue(v, out topLeft) && topLeft.IsWeeds() && objects.TryGetValue(v + new Vector2(1f, 0f), out topRight) && topRight.IsWeeds() && objects.TryGetValue(v + new Vector2(1f, 1f), out bottomRight) && bottomRight.IsWeeds() && objects.TryGetValue(v + new Vector2(0f, 1f), out bottomLeft) && bottomLeft.IsWeeds())
				{
					objects.Remove(v);
		...
		public void setUpLocationSpecificFlair()
		{
			...
			Color c;
			if (TryGetAmbientLightFromMap(out c))
			{
				if (c == Color.White)
				{
					c = Color.Black;
				...
				Color night;
				if (TryGetAmbientLightFromMap(out night, "AmbientNightLight"))
				{
			...
			if (!IsOutdoors && IsGreenRainingHere() && !InIslandContext() && IsRainingHere())
			{
				...
				Game1.screenGlowOnce(new Color(0, 255, 50) * 0.5f, true, 1f);
			}
			switch ((string)name)
			{
			case "JoshHouse":
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Microsoft.Xna.Framework.Rectangle(386, 334, 36, 28), 40f, 3, 999999, new Vector2(246.5f, 317f) * 4f, false, false, 0.136001f, 0f, Color.White, 2f, 0f, 0f, 0f));
				}
				break;
			case "LewisBasement":
			{
			...
			case "LeoTreeHouse":
				...
				temporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\critters", new Microsoft.Xna.Framework.Rectangle(71, 334, 12, 11), new Vector2(304f, 32f), false, 0f, Color.White)
				{
					layerDepth = 0.001f,
					interval = 700f,
					animationLength = 3,
				...
				temporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\critters", new Microsoft.Xna.Framework.Rectangle(47, 334, 12, 11), new Vector2(112f, -25.6f), true, 0f, Color.White)
				{
					layerDepth = 0.001f,
					interval = 300f,
					animationLength = 3,
				...
				temporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\critters", new Microsoft.Xna.Framework.Rectangle(71, 334, 12, 11), new Vector2(224f, -25.6f), false, 0f, Color.White)
				{
					layerDepth = 0.001f,
					interval = 800f,
					animationLength = 3,
			...
			case "Sunroom":
				...
				{
					critters = new List<Critter>();
					critters.Add(new Butterfly(this, getRandomTile()).setStayInbounds(true));
			...
			case "ScienceHouse":
				if (Game1.random.NextBool() && Game1.player.currentLocation != null && (bool)Game1.player.currentLocation.isOutdoors)
				{
					...
					if (p != null && p.TilePoint.Y == 18)
					{
						...
						{
						case 0:
							toSay = (IsRainingHere() ? "Strings\\SpeechBubbles:ScienceHouse_Robin_Raining1" : "Strings\\SpeechBubbles:ScienceHouse_Robin_NotRaining1");
							break;
						case 1:
							toSay = (IsSnowingHere() ? "Strings\\SpeechBubbles:ScienceHouse_Robin_Snowing" : "Strings\\SpeechBubbles:ScienceHouse_Robin_NotSnowing");
							break;
						case 2:
							...
							break;
						case 3:
							toSay = (IsRainingHere() ? "Strings\\SpeechBubbles:ScienceHouse_Robin_Raining2" : "Strings\\SpeechBubbles:ScienceHouse_Robin_NotRaining2");
							break;
						default:
			...
			case "CommunityCenter":
				...
				{
					setFireplace(true, 31, 8, false);
					setFireplace(true, 32, 8, false);
					setFireplace(true, 33, 8, false);
				}
				break;
			case "AnimalShop":
				setFireplace(true, 3, 14, false);
				if (Game1.random.NextBool())
				{
					NPC p2 = Game1.getCharacterFromName("Marnie");
					if (p2 != null && p2.TilePoint.Y == 14)
					{
						string toSay2;
						switch (Game1.random.Next(5))
						{
						...
						case 2:
							...
							break;
						case 3:
							toSay2 = (IsRainingHere() ? "Strings\\SpeechBubbles:AnimalShop_Marnie_Raining" : "Strings\\SpeechBubbles:AnimalShop_Marnie_NotRaining");
							break;
						default:
			...
			case "Hospital":
			{
				...
				if (p4 != null && p4.currentLocation == this && !p4.isDivorcedFrom(Game1.player))
				{
					...
					{
					case 0:
						toSay4 = "Strings\\SpeechBubbles:Hospital_Maru_Greeting1";
						break;
					case 1:
						toSay4 = "Strings\\SpeechBubbles:Hospital_Maru_Greeting2";
						break;
					case 2:
						toSay4 = "Strings\\SpeechBubbles:Hospital_Maru_Greeting3";
						break;
					case 3:
						toSay4 = "Strings\\SpeechBubbles:Hospital_Maru_Greeting4";
						break;
					default:
						toSay4 = "Strings\\SpeechBubbles:Hospital_Maru_Greeting5";
						break;
					}
					if (Game1.player.spouse == "Maru")
					{
						toSay4 = "Strings\\SpeechBubbles:Hospital_Maru_Spouse";
						p4.showTextAboveHead(Game1.content.LoadString(toSay4), SpriteText.color_Red);
					}
					else
					{
						p4.showTextAboveHead(Game1.content.LoadString(toSay4));
					}
				}
				break;
			}
			case "LeahHouse":
			{
				NPC j = Game1.getCharacterFromName("Leah");
				if (IsFallHere() || IsWinterHere() || IsRainingHere())
				{
					setFireplace(true, 11, 4, false);
				}
				if (j != null && j.currentLocation == this && !j.isDivorcedFrom(Game1.player))
				{
					string toSay5;
					...
					j.showTextAboveHead(Game1.content.LoadString(toSay5, Game1.player.Name));
				}
				break;
			}
			case "ElliottHouse":
			{
				...
				if (e != null && e.currentLocation == this && !e.isDivorcedFrom(Game1.player))
				{
					...
					{
					case 0:
						toSay6 = "Strings\\SpeechBubbles:ElliottHouse_Elliott_Greeting1";
						break;
					case 1:
						toSay6 = "Strings\\SpeechBubbles:ElliottHouse_Elliott_Greeting2";
						break;
					default:
						toSay6 = "Strings\\SpeechBubbles:ElliottHouse_Elliott_Greeting3";
						break;
					}
					e.faceTowardFarmerForPeriod(3000, 15, false, Game1.player);
					e.showTextAboveHead(Game1.content.LoadString(toSay6, Game1.player.Name));
				}
				break;
			}
			case "JojaMart":
				...
				if (Game1.random.NextBool())
				{
					...
					{
						string toSay7 = "Strings\\SpeechBubbles:JojaMart_Morris_Greeting";
						p5.showTextAboveHead(Game1.content.LoadString(toSay7));
					}
				}
				break;
			case "SandyHouse":
			{
				...
				if (p6 != null && p6.currentLocation == this)
				{
					...
					{
					case 0:
						toSay8 = "Strings\\SpeechBubbles:SandyHouse_Sandy_Greeting1";
						break;
					case 1:
						toSay8 = "Strings\\SpeechBubbles:SandyHouse_Sandy_Greeting2";
						break;
					case 2:
						toSay8 = "Strings\\SpeechBubbles:SandyHouse_Sandy_Greeting3";
						break;
					case 3:
						toSay8 = "Strings\\SpeechBubbles:SandyHouse_Sandy_Greeting4";
						break;
					default:
						toSay8 = "Strings\\SpeechBubbles:SandyHouse_Sandy_Greeting5";
						break;
					}
					p6.showTextAboveHead(Game1.content.LoadString(toSay8));
				}
				break;
			}
			case "ManorHouse":
			{
				...
				{
					string toSay9 = ((Game1.timeOfDay < 1200) ? "Morning" : ((Game1.timeOfDay < 1700) ? "Afternoon" : "Evening"));
					le.faceTowardFarmerForPeriod(3000, 15, false, Game1.player);
					le.showTextAboveHead(Game1.content.LoadString("Strings\\SpeechBubbles:ManorHouse_Lewis_" + toSay9));
				}
				break;
			}
			case "Saloon":
				...
				{
					setFireplace(true, 22, 17, false);
				}
				if (Game1.random.NextDouble() < 0.25)
				{
					NPC p7 = Game1.getCharacterFromName("Gus");
					if (p7 != null && p7.TilePoint.Y == 18 && p7.currentLocation == this)
					{
						string toSay10;
						switch (Game1.random.Next(5))
						{
						case 0:
							...
							break;
						case 1:
							toSay10 = (IsSummerHere() ? "Summer" : "NotSummer");
							break;
						case 2:
							toSay10 = (IsSnowingHere() ? "Snowing1" : "NotSnowing1");
							break;
						case 3:
							toSay10 = (IsRainingHere() ? "Raining" : "NotRaining");
							break;
						default:
							toSay10 = (IsSnowingHere() ? "Snowing2" : "NotSnowing2");
							break;
						}
						if (Game1.random.NextDouble() < 0.001)
						{
						...
						p7.showTextAboveHead(Game1.content.LoadString("Strings\\SpeechBubbles:Saloon_Gus_" + toSay10));
					}
				}
			...
			case "ArchaeologyHouse":
			{
				...
				if (g != null && g.currentLocation == this)
				{
					...
					g.showTextAboveHead(Game1.content.LoadString("Strings\\SpeechBubbles:ArchaeologyHouse_Gunther_" + toSay12));
				}
				break;
			}
			case "Greenhouse":
				...
				break;
			case "SeedShop":
				setFireplace(true, 25, 13, false);
				if (Game1.random.NextBool() && Game1.player.TilePoint.Y > 10)
				{
					NPC p8 = Game1.getCharacterFromName("Pierre");
					if (p8 != null && p8.TilePoint.Y == 17 && p8.currentLocation == this)
					{
						string toSay11;
						switch (Game1.random.Next(5))
						{
						case 0:
							toSay11 = (IsWinterHere() ? "Winter" : "NotWinter");
							break;
						case 1:
							toSay11 = (IsSummerHere() ? "Summer" : "NotSummer");
							break;
						case 2:
							toSay11 = "Greeting1";
							break;
						case 3:
							...
							break;
						default:
							toSay11 = (IsRainingHere() ? "Raining" : "NotRaining");
							break;
						}
						if (Game1.random.NextDouble() < 0.001)
						{
							toSay11 = "RareGreeting";
						}
						string dialogue = Game1.content.LoadString("Strings\\SpeechBubbles:SeedShop_Pierre_" + toSay11);
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(167, 1714, 19, 14), 100f, 3, 999999, new Vector2(2f, 3f) * 64f + new Vector2(7f, 12f) * 4f, false, false, 0.0002f, 0f, Color.White, 4f, 0f, 0f, 0f)
					{
						id = 688
					});
				}
		...
		protected virtual void resetLocalState()
		{
			...
			string clamp;
			if (TryGetMapProperty("ViewportClamp", out clamp))
			{
				try
				{
			...
			if (!(this is Farm))
			{
				...
				{
					if (temporarySprites[n].clearOnAreaEntry())
					{
			...
			for (int m = Game1.player.questLog.Count - 1; m >= 0; m--)
			{
				Game1.player.questLog[m].adjustGameLocation(this);
			}
			if (!isOutdoors)
			{
			...
			if (!ignoreLights)
			{
				...
				for (int l = 0; l < lights.Length; l += 3)
				{
					Point tile3;
					string error3;
					int textureIndex;
					if (!ArgUtility.TryGetPoint(lights, l, out tile3, out error3) || !ArgUtility.TryGetInt(lights, l + 2, out textureIndex, out error3))
					{
						LogMapPropertyError("Light", lights, error3);
					}
					else
					{
						Game1.currentLightSources.Add(new LightSource(textureIndex, new Vector2(tile3.X * 64 + 32, tile3.Y * 64 + 32), 1f, LightSource.LightContext.MapLight, 0L));
					}
				}
				if (!Game1.isTimeToTurnOffLighting(this) && !Game1.isRaining)
				{
					string[] windowLights = GetMapPropertySplitBySpaces("WindowLight");
					for (int k = 0; k < windowLights.Length; k += 3)
					{
						Point tile4;
						string error4;
						int textureIndex2;
						if (!ArgUtility.TryGetPoint(windowLights, k, out tile4, out error4) || !ArgUtility.TryGetInt(windowLights, k + 2, out textureIndex2, out error4))
						{
							LogMapPropertyError("WindowLight", windowLights, error4);
						}
						else
						{
							Game1.currentLightSources.Add(new LightSource(textureIndex2, new Vector2(tile4.X * 64 + 32, tile4.Y * 64 + 32), 1f, LightSource.LightContext.WindowLight, 0L));
						}
					}
			...
			if ((bool)isOutdoors || (bool)treatAsOutdoors)
			{
				...
				for (int j = 0; j < sounds.Length; j += 3)
				{
					Vector2 tile;
					string error;
					int soundId;
					if (!ArgUtility.TryGetVector2(sounds, j, out tile, out error) || !ArgUtility.TryGetInt(sounds, j + 2, out soundId, out error))
					{
			...
			if (Game1.timeOfDay < night_tiles_time && (!IsRainingHere() || name.Equals("SandyHouse")))
			{
				...
				for (int i = 0; i < dayTiles.Length; i += 4)
				{
					...
					Point position;
					int tileIndex;
					if (!ArgUtility.TryGet(dayTiles, i, out layerId, out error2) || !ArgUtility.TryGetPoint(dayTiles, i + 1, out position, out error2) || !ArgUtility.TryGetInt(dayTiles, i + 3, out tileIndex, out error2))
					{
						LogMapPropertyError("DayTiles", dayTiles, error2);
					}
					else if (tileIndex != 720 || !Game1.MasterPlayer.mailReceived.Contains("pamHouseUpgrade"))
					{
						Tile tile2 = map.RequireLayer(layerId).Tiles[position.X, position.Y];
						if (tile2 != null)
						{
							tile2.TileIndex = tileIndex;
						}
					}
				}
			}
			...
			foreach (SpecialOrder s in Game1.player.team.specialOrders)
			{
				...
				foreach (OrderObjective objective in s.objectives)
				{
					...
					if (donateObjective != null && donateObjective.dropBoxGameLocation != null && donateObjective.GetDropboxLocationName() == Name)
					{
				...
				foreach (string builder in Game1.netWorldState.Value.Builders.Keys)
				{
					...
					if (builderData.buildingLocation.Value == NameOrUniqueName && builderData.daysUntilBuilt.Value > 0)
					{
						...
						if (buildCharacter != null && buildCharacter.currentLocation.Equals(this))
						{
							...
							if (b != null)
							{
								temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(399, 262, ((int)b.daysOfConstructionLeft == 1) ? 29 : 9, 43), new Vector2((int)b.tileX + (int)b.tilesWide / 2, (int)b.tileY + (int)b.tilesHigh / 2) * 64f + new Vector2(-16f, -144f), false, 0f, Color.White)
								{
									id = 16846,
									scale = 4f,
									interval = 999999f,
		...
		private bool TryGetAmbientLightFromMap(out Color color, string propertyName = "AmbientLight")
		{
			...
			if (fields.Length != 0)
			{
				...
				int g;
				int b;
				if (ArgUtility.TryGetInt(fields, 0, out r, out error) && ArgUtility.TryGetInt(fields, 1, out g, out error) && ArgUtility.TryGetInt(fields, 2, out b, out error))
				{
		...
		{
			LightSource i;
			sharedLights.TryGetValue(identifier, out i);
			return i;
		}
		...
		public virtual bool IsTileOccupiedBy(Vector2 tile, CollisionMask collisionMask = CollisionMask.All, CollisionMask ignorePassables = CollisionMask.None, bool useFarmerTile = false)
		{
			...
			Object o;
			if (collisionMask.HasFlag(CollisionMask.Objects) && objects.TryGetValue(tile, out o) && (!ignorePassables.HasFlag(CollisionMask.Objects) || !o.isPassable()))
			{
				return true;
			}
			if (collisionMask.HasFlag(CollisionMask.Furniture))
			{
				Furniture f2 = GetFurnitureAt(tile);
			...
			TerrainFeature feature;
			if ((collisionMask.HasFlag(CollisionMask.TerrainFeatures) || collisionMask.HasFlag(CollisionMask.Flooring)) && terrainFeatures.TryGetValue(tile, out feature) && feature.getBoundingBox().Intersects(tileRect))
			{
		...
		{
			Object obj;
			if (objects.TryGetValue(tile, out obj))
			{
		...
		public void playTerrainSound(Vector2 tileLocation, Character who = null, bool showTerrainDisturbAnimation = true)
		{
			...
			if (Game1.currentLocation.terrainFeatures.TryGetValue(tileLocation, out terrainFeature) && terrainFeature is Flooring)
			{
			...
			else if (who != null && showTerrainDisturbAnimation && GetSeason() == Season.Winter && currentStep.Equals("grassyStep"))
			{
				...
				Game1.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(247, 407, 6, 6), 2000f, 1, 10000, new Vector2(who.Position.X, who.Position.Y) + offset2, false, false, 0.0001f, 0.001f, Color.White, 1f, 0.01f, 0f, 0f));
			}
			if (who != null)
			{
				Farmer f = who as Farmer;
				if (f != null && f.boots.Value != null && f.boots.Value.ItemId == "853")
				{
		...
		public virtual bool checkAction(Location tileLocation, xTile.Dimensions.Rectangle viewport, Farmer who)
		{
					...
					if (objects.TryGetValue(tilePos, out obj) && (obj.Type == "Crafting" || obj.Type == "interactive"))
					{
						...
						if (objects.TryGetValue(tilePos, out obj))
						{
							if (who.CurrentItem != null)
							{
								...
								bool probe_returned_true = obj.performObjectDropInAction(who.CurrentItem, true, who);
			...
			if (largeTerrainFeatures != null)
			{
				foreach (LargeTerrainFeature f2 in largeTerrainFeatures)
				{
					if (f2.getBoundingBox().Intersects(tileRect) && f2.performUseAction(f2.Tile))
					{
						Game1.haltAfterCheck = false;
						return true;
					}
			...
			foreach (Furniture f in furniture)
			{
				if (f.boundingBox.Value.Contains((int)(tilePos.X * 64f), (int)(tilePos.Y * 64f)) && (int)f.furniture_type != 12)
				{
					if (didRightClick)
					{
						if (who.ActiveObject != null && f.performObjectDropInAction(who.ActiveObject, false, who))
						{
							return true;
						}
			...
			if (paintingFound != null)
			{
				if (didRightClick)
				{
					if (who.ActiveObject != null && paintingFound.performObjectDropInAction(who.ActiveObject, false, who))
					{
						return true;
					}
			...
			if (Game1.didPlayerJustRightClick(true) && animals.Length > 0 && CheckInspectAnimal(tileRect, who))
			{
				return true;
			}
			return false;
		...
		public virtual bool LowPriorityLeftClick(int x, int y, Farmer who)
		{
			...
			if (Game1.didPlayerJustRightClick(true) && CheckInspectAnimal(tileRect, who))
			{
				return true;
			}
			return false;
		...
		protected virtual void removeQueuedFurniture(Guid guid)
		{
			...
			if (!furniture.TryGetValue(guid, out furnitureItem) || !who.couldInventoryAcceptThisItem(furnitureItem))
			{
				return;
			}
		...
		public virtual bool leftClick(int x, int y, Farmer who)
		{
			...
			Object clickedObj;
			if (objects.TryGetValue(clickTile, out clickedObj) && clickedObj.clicked(who))
			{
		...
		public virtual bool shouldShadowBeDrawnAboveBuildingsLayer(Vector2 p)
		{
			...
			TerrainFeature feature;
			if (terrainFeatures.TryGetValue(p, out feature) && feature is HoeDirt)
			{
				return true;
			}
		...
		{
			FarmHouse home2 = this as FarmHouse;
			if (home2 == null)
			{
				IslandFarmHouse home = this as IslandFarmHouse;
				if (home != null && (!onlyUnlocked || home.fridgePosition != Point.Zero))
				{
					return home.fridge.Value;
				}
			}
			else if (!onlyUnlocked || home2.fridgePosition != Point.Zero)
			{
				return home2.fridge.Value;
			}
			return null;
		}
		...
		public virtual Point? GetFridgePosition()
		{
			...
			{
				IslandFarmHouse home = this as IslandFarmHouse;
				if (home != null && home.fridgePosition != Point.Zero)
				{
					return home.fridgePosition;
				}
			}
			else if (home2.fridgePosition != Point.Zero)
			{
				return home2.fridgePosition;
			}
			return null;
		}
		...
		public void ActivateKitchen()
		{
			...
			{
				if (item != null && (bool)item.bigCraftable)
				{
			...
			new MultipleMutexRequest(muticies, delegate(MultipleMutexRequest request)
			{
				...
				Game1.activeClickableMenu = new CraftingPage((int)topLeftPositionForCenteringOnScreen.X, (int)topLeftPositionForCenteringOnScreen.Y, 800 + IClickableMenu.borderWidth * 2, 600 + IClickableMenu.borderWidth * 2, true, true, list);
		...
		public virtual bool CheckGarbage(string id, Vector2 tile, Farmer who, bool playAnimations = true, bool reactNpcs = true, Action<string> logError = null)
		{
			...
			TryGetGarbageItem(id, who.DailyLuck, out item, out selected, out garbageRandom, logError);
			if (playAnimations)
			{
				...
				TemporaryAnimatedSprite lidSprite = new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Microsoft.Xna.Framework.Rectangle(22 + xSourceOffset, 0, 16, 10), tile * 64f + new Vector2(0f, -6f) * 4f, false, 0f, Color.White)
				{
					...
					reachedStopCoordinate = delegate
					{
						...
						for (int j = 0; j < 3; j++)
						{
							temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), tile * 64f + new Vector2(j * 6, -3 + garbageRandom.Next(3)) * 4f, false, 0.02f, Color.DimGray)
							{
								alpha = 0.85f,
				...
				for (int i = 0; i < 5; i++)
				{
					TemporaryAnimatedSprite particleSprite = new TemporaryAnimatedSprite("LooseSprites\\Cursors2", new Microsoft.Xna.Framework.Rectangle(22 + garbageRandom.Next(4) * 4, 32, 4, 4), tile * 64f + new Vector2(Game1.random.Next(13), -3 + Game1.random.Next(3)) * 4f, false, 0f, Color.White)
					{
						interval = 500f,
		...
		public virtual bool TryGetGarbageItem(string id, double dailyLuck, out Item item, out GarbageCanItemData selected, out Random garbageRandom, Action<string> logError = null)
		{
			...
			GarbageCanEntryData data;
			if (!allData.GarbageCans.TryGetValue(id, out data))
			{
				data = null;
			}
		...
		{
			_003C_003Ec__DisplayClass389_0 CS_0024_003C_003E8__locals0 = new _003C_003Ec__DisplayClass389_0();
			CS_0024_003C_003E8__locals0._003C_003E4__this = this;
			CS_0024_003C_003E8__locals0.action = action;
			CS_0024_003C_003E8__locals0.tileLocation = tileLocation;
			CS_0024_003C_003E8__locals0.who = who;
			if (ShouldIgnoreAction(CS_0024_003C_003E8__locals0.action, CS_0024_003C_003E8__locals0.who, CS_0024_003C_003E8__locals0.tileLocation))
			{
				return false;
			}
			string actionType;
			string error;
			if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 0, out actionType, out error))
			{
				return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
			}
			if (CS_0024_003C_003E8__locals0.who.IsLocalPlayer)
			{
				Func<GameLocation, string[], Farmer, Point, bool> actionHandler;
				if (registeredTileActions.TryGetValue(actionType, out actionHandler))
				{
					return actionHandler(this, CS_0024_003C_003E8__locals0.action, CS_0024_003C_003E8__locals0.who, new Point(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y));
				}
				switch (actionType)
				{
				case "None":
				...
				case "BuildingGoldClock":
				{
					...
					CS_0024_003C_003E8__locals0.who.currentLocation.createQuestionDialogue(Game1.content.LoadString("Strings\\1_6_Strings:GoldClock_" + (clockOn ? "Off" : "On")), CS_0024_003C_003E8__locals0.who.currentLocation.createYesNoResponses(), "GoldClock");
					break;
				}
				case "Bobbers":
				...
				case "SpecialWaterDroppable":
					...
					{
						if (CS_0024_003C_003E8__locals0.who?.ActiveObject?.QualifiedItemId == "(O)103")
						{
							_003C_003Ec__DisplayClass389_0 _003C_003Ec__DisplayClass389_ = CS_0024_003C_003E8__locals0;
							localSound("throwDownITem");
							_003C_003Ec__DisplayClass389_.who.reduceActiveItemByOne();
							TemporaryAnimatedSprite tempSprite2 = new TemporaryAnimatedSprite(103, 9999f, 1, 1, _003C_003Ec__DisplayClass389_.who.position.Value + new Vector2(0f, -128f), false, false, false)
							{
								motion = new Vector2(4f, -4f),
								acceleration = new Vector2(0f, 0.3f),
								yStopCoordinate = (int)_003C_003Ec__DisplayClass389_.who.position.Y,
								id = 777
							};
							_003C_003Ec__DisplayClass389_.who.freezePause = 4000;
							tempSprite2.reachedStopCoordinate = delegate
							{
								_003C_003Ec__DisplayClass389_._003C_003E4__this.removeTemporarySpritesWithID(777);
								_003C_003Ec__DisplayClass389_._003C_003E4__this.temporarySprites.Add(new TemporaryAnimatedSprite(28, 300f, 2, 1, tempSprite2.position, false, false)
								{
									color = Color.OrangeRed
								});
								_003C_003Ec__DisplayClass389_._003C_003E4__this.localSound("dropItemInWater");
								DelayedAction.functionAfterDelay(delegate
								{
									_003C_003Ec__DisplayClass389_._003C_003E4__this.localSound("terraria_boneSerpent");
									_003C_003Ec__DisplayClass389_._003C_003E4__this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\terraria_cat", new Microsoft.Xna.Framework.Rectangle(128, 96, 32, 32), 70f, 4, 5, tempSprite2.position + new Vector2(-5f, -3f) * 4f, false, true, 0.99f, 0f, Color.White, 4f, 0f, 0f, 0f));
									_003C_003Ec__DisplayClass389_._003C_003E4__this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\terraria_cat", new Microsoft.Xna.Framework.Rectangle(128, 96, 32, 32), 60f, 4, 5, tempSprite2.position + new Vector2(-5f, 7f) * 4f, false, false, 1f, 0f, Color.White, 4f, 0f, 0f, 0f));
									_003C_003Ec__DisplayClass389_._003C_003E4__this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\terraria_cat", new Microsoft.Xna.Framework.Rectangle(134, 2, 21, 38), 9999f, 1, 1, tempSprite2.position, false, false, 0.98f, 0f, Color.White, 4f, 0f, 0f, 0f)
									{
										xPeriodic = true,
									...
									for (int m = 0; m < 13; m++)
									{
										_003C_003Ec__DisplayClass389_._003C_003E4__this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\terraria_cat", new Microsoft.Xna.Framework.Rectangle(134, (m == 12) ? 54 : 41, 21, 12), 9999f, 1, 1, tempSprite2.position, false, false, 0.97f - (float)m * 0.01f, 0f, Color.White, 4f, 0f, 0f, 0f)
										{
											xPeriodic = true,
											xPeriodicLoopTime = 500 + Game1.random.Next(-50, 50),
											xPeriodicRange = 2f,
											motion = new Vector2(0f, -8f),
											delayBeforeAnimationStart = 220 + 80 * m
										});
									}
									TemporaryAnimatedSprite temporaryAnimatedSprite = new TemporaryAnimatedSprite(935, 9999f, 1, 1, tempSprite2.position + new Vector2(0f, -128f), false, false, false)
									{
										motion = new Vector2(-4f, -4f),
										acceleration = new Vector2(0f, 0.3f),
										yStopCoordinate = (int)(_003C_003Ec__DisplayClass389_.who.position.Y - 128f + 12f),
										id = 888
									};
									temporaryAnimatedSprite.reachedStopCoordinate = delegate
									{
										_003C_003Ec__DisplayClass389_.who.addItemByMenuIfNecessary(new Object("FarAwayStone", 1));
										_003C_003Ec__DisplayClass389_.who.currentLocation.removeTemporarySpritesWithID(888);
										_003C_003Ec__DisplayClass389_._003C_003E4__this.localSound("coin");
									};
									_003C_003Ec__DisplayClass389_.who.currentLocation.temporarySprites.Add(temporaryAnimatedSprite);
								}, 1000);
							};
							temporarySprites.Add(tempSprite2);
							return true;
						}
						if (CS_0024_003C_003E8__locals0.who?.ActiveObject != null && !CS_0024_003C_003E8__locals0.who.ActiveObject.questItem && CS_0024_003C_003E8__locals0.who.ActiveObject.QualifiedItemId != "(O)FarAwayStone" && CS_0024_003C_003E8__locals0.who.ActiveObject.Edibility <= 0 && !CS_0024_003C_003E8__locals0.who.ActiveObject.Name.Contains("Totem"))
						{
							ParsedItemData itemData = ItemRegistry.GetDataOrErrorItem(CS_0024_003C_003E8__locals0.who?.ActiveObject.QualifiedItemId);
							if (itemData != null)
							{
								_003C_003Ec__DisplayClass389_0 _003C_003Ec__DisplayClass389_2 = CS_0024_003C_003E8__locals0;
								localSound("throwDownITem");
								int _id = Game1.random.Next();
								TemporaryAnimatedSprite tempSprite = new TemporaryAnimatedSprite(itemData.GetTextureName(), itemData.GetSourceRect(), 9999f, 1, 1, _003C_003Ec__DisplayClass389_2.who.position.Value + new Vector2(0f, -128f), false, false)
								{
									motion = new Vector2(4f, -4f),
									acceleration = new Vector2(0f, 0.3f),
									yStopCoordinate = (int)_003C_003Ec__DisplayClass389_2.who.position.Y,
									id = _id,
									scale = 4f * ((itemData.GetSourceRect().Height > 32) ? 0.5f : 1f)
								};
								_003C_003Ec__DisplayClass389_2.who.reduceActiveItemByOne();
								tempSprite.reachedStopCoordinate = delegate
								{
									_003C_003Ec__DisplayClass389_2._003C_003E4__this.removeTemporarySpritesWithID(_id);
									_003C_003Ec__DisplayClass389_2._003C_003E4__this.temporarySprites.Add(new TemporaryAnimatedSprite(28, 300f, 2, 1, tempSprite.position, false, false)
									{
										color = Color.OrangeRed
									});
									_003C_003Ec__DisplayClass389_2._003C_003E4__this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(276, 1985, 12, 11), tempSprite.position + new Vector2(2f, 0f) * 4f, false, 0f, Color.White)
									{
										interval = 50f,
										totalNumberOfLoops = 99999,
										animationLength = 4,
									...
									for (int l = 0; l < 4; l++)
									{
										_003C_003Ec__DisplayClass389_2._003C_003E4__this.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(276, 1965, 8, 8), tempSprite.position + new Vector2(2f, 0f) * 4f, false, 0f, Color.White)
										{
											...
											layerDepth = 0.99f,
											alphaFade = 0.02f,
											delayBeforeAnimationStart = l * 30
										});
									}
									_003C_003Ec__DisplayClass389_2._003C_003E4__this.localSound("dropItemInWater");
									_003C_003Ec__DisplayClass389_2._003C_003E4__this.localSound("fireball");
								};
					...
					return false;
				case "ForestPylon":
					if (CS_0024_003C_003E8__locals0.who?.ActiveObject?.QualifiedItemId == "(O)FarAwayStone")
					{
						CS_0024_003C_003E8__locals0.who.reduceActiveItemByOne();
						...
						DelayedAction.functionAfterDelay(delegate
						{
							...
							{
								CS_0024_003C_003E8__locals0._003C_003E4__this.startEvent(new Event(Game1.content.LoadString("Strings\\1_6_Strings:ForestPylonEvent")));
							});
						}, 1000);
					}
					else if (CS_0024_003C_003E8__locals0.who.mailReceived.Contains("hasActivatedForestPylon"))
					{
				...
				{
					string id;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out id, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					CheckGarbage(id, new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y), CS_0024_003C_003E8__locals0.who, true, true, delegate(string garbageError)
					{
						IGameLogger log = Game1.log;
				...
				case "ObeliskWarp":
				{
					...
					Point targetTile;
					bool forceDismount;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out targetLocation, out error) || !ArgUtility.TryGetPoint(CS_0024_003C_003E8__locals0.action, 2, out targetTile, out error) || !ArgUtility.TryGetOptionalBool(CS_0024_003C_003E8__locals0.action, 4, out forceDismount, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					Building.PerformObeliskWarp(targetLocation, targetTile.X, targetTile.Y, forceDismount, CS_0024_003C_003E8__locals0.who);
					return true;
				}
				case "PlayEvent":
				{
					...
					bool checkSeen;
					string fallbackAction;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out eventId, out error) || !ArgUtility.TryGetOptionalBool(CS_0024_003C_003E8__locals0.action, 2, out checkPreconditions, out error, true) || !ArgUtility.TryGetOptionalBool(CS_0024_003C_003E8__locals0.action, 3, out checkSeen, out error, true) || !ArgUtility.TryGetOptionalRemainder(CS_0024_003C_003E8__locals0.action, 4, out fallbackAction))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					...
					{
						return performAction(fallbackAction, CS_0024_003C_003E8__locals0.who, CS_0024_003C_003E8__locals0.tileLocation);
					}
					return false;
				}
				case "OpenShop":
				{
					...
					int shopAreaWidth;
					int shopAreaHeight;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out shopId, out error) || !ArgUtility.TryGetOptional(CS_0024_003C_003E8__locals0.action, 2, out direction, out error) || !ArgUtility.TryGetOptionalInt(CS_0024_003C_003E8__locals0.action, 3, out openTime, out error, -1) || !ArgUtility.TryGetOptionalInt(CS_0024_003C_003E8__locals0.action, 4, out closeTime, out error, -1) || !ArgUtility.TryGetOptionalInt(CS_0024_003C_003E8__locals0.action, 5, out shopAreaX, out error, -1) || !ArgUtility.TryGetOptionalInt(CS_0024_003C_003E8__locals0.action, 6, out shopAreaY, out error, -1) || !ArgUtility.TryGetOptionalInt(CS_0024_003C_003E8__locals0.action, 7, out shopAreaWidth, out error, -1) || !ArgUtility.TryGetOptionalInt(CS_0024_003C_003E8__locals0.action, 8, out shopAreaHeight, out error, -1))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					...
					if (shopAreaX != -1 || shopAreaY != -1 || shopAreaWidth != -1 || shopAreaHeight != -1)
					{
						if (shopAreaX == -1 || shopAreaY == -1 || shopAreaWidth == -1 || shopAreaHeight == -1)
						{
							return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0("when specifying any of the shop area 'x y width height' arguments (indexes 5-8), all four must be specified");
						}
					...
					{
					case "down":
						if (CS_0024_003C_003E8__locals0.who.TilePoint.Y < CS_0024_003C_003E8__locals0.tileLocation.Y)
						{
							return false;
						}
						break;
					case "up":
						...
						break;
					case "left":
						if (CS_0024_003C_003E8__locals0.who.TilePoint.X > CS_0024_003C_003E8__locals0.tileLocation.X)
						{
							return false;
						}
						break;
				...
				case "Warp_Sunroom_Door":
					if (CS_0024_003C_003E8__locals0.who.getFriendshipHeartLevelForNPC("Caroline") >= 2)
					{
						playSound("doorClose", new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y));
				...
				case "WizardBook":
					if (CS_0024_003C_003E8__locals0.who.mailReceived.Contains("hasPickedUpMagicInk") || CS_0024_003C_003E8__locals0.who.hasMagicInk)
					{
						ShowConstructOptions("Wizard");
					}
					break;
				case "EvilShrineLeft":
					if (CS_0024_003C_003E8__locals0.who.getChildrenCount() == 0)
					{
				...
				case "EvilShrineCenter":
					if (CS_0024_003C_003E8__locals0.who.isDivorced())
					{
				...
				case "EvilShrineRight":
					...
					break;
				case "Tailoring":
					if (CS_0024_003C_003E8__locals0.who.eventsSeen.Contains("992559"))
					{
				...
				case "DyePot":
					...
					break;
				case "MagicInk":
					if (CS_0024_003C_003E8__locals0.who.mailReceived.Add("hasPickedUpMagicInk"))
					{
						CS_0024_003C_003E8__locals0.who.hasMagicInk = true;
						setMapTileIndex(4, 11, 113, "Buildings");
						CS_0024_003C_003E8__locals0.who.addItemByMenuIfNecessaryElseHoldUp(new SpecialItem(7));
					}
					break;
				case "LeoParrot":
				...
				{
					string which;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out which, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					doStarpoint(which);
				...
				case "IceCreamStand":
				{
					Microsoft.Xna.Framework.Rectangle npcArea = new Microsoft.Xna.Framework.Rectangle(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y - 3, 1, 3);
				...
				case "WizardShrine":
					...
					break;
				case "HMTGF":
					if (CS_0024_003C_003E8__locals0.who.ActiveObject != null && CS_0024_003C_003E8__locals0.who.ActiveObject.QualifiedItemId == "(O)155")
					{
				...
				case "HospitalShop":
				{
					Point playerTile = CS_0024_003C_003E8__locals0.who.TilePoint;
					...
					Utility.TryOpenShopMenu("Hospital", this, ownerSearchArea2);
					break;
				}
				case "BuyBackpack":
				{
					...
					{
						createQuestionDialogue(Game1.content.LoadString("Strings\\Locations:SeedShop_BuyBackpack_Question24"), new Response[2] { purchase10001, notNow }, "Backpack");
					}
				...
				case "BuyQiCoins":
					...
					break;
				case "LumberPile":
					if (!CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_LumberPile") && CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_SandDragon"))
					{
					...
					break;
				case "SandDragon":
					if (CS_0024_003C_003E8__locals0.who.ActiveObject?.QualifiedItemId == "(O)768" && !CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_SandDragon") && CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_MayorFridge"))
					{
						CS_0024_003C_003E8__locals0.who.reduceActiveItemByOne();
						Game1.player.CanMove = false;
						localSound("eat");
					...
					else if (CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_SandDragon"))
					{
					...
					break;
				case "RailroadBox":
					if (CS_0024_003C_003E8__locals0.who.ActiveObject?.QualifiedItemId == "(O)394" && !CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_Railroad") && CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_Tunnel"))
					{
						CS_0024_003C_003E8__locals0.who.reduceActiveItemByOne();
						Game1.player.CanMove = false;
						localSound("Ship");
					...
					else if (CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_Railroad"))
					{
					...
					break;
				case "TunnelSafe":
					if (CS_0024_003C_003E8__locals0.who.ActiveObject?.QualifiedItemId == "(O)787" && !CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_Tunnel"))
					{
						CS_0024_003C_003E8__locals0.who.reduceActiveItemByOne();
						Game1.player.CanMove = false;
						playSound("openBox");
					...
					else if (CS_0024_003C_003E8__locals0.who.hasOrWillReceiveMail("TH_Tunnel"))
					{
					...
					break;
				case "SkullDoor":
					if (CS_0024_003C_003E8__locals0.who.hasSkullKey || Utility.IsPassiveFestivalDay("DesertFestival"))
					{
						if (!CS_0024_003C_003E8__locals0.who.hasUnlockedSkullDoor && !Utility.IsPassiveFestivalDay("DesertFestival"))
						{
							...
							CS_0024_003C_003E8__locals0.who.hasUnlockedSkullDoor = true;
							CS_0024_003C_003E8__locals0.who.completeQuest("19");
						}
						else
						{
							CS_0024_003C_003E8__locals0.who.completelyStopAnimatingOrDoingAction();
							playSound("doorClose");
				...
				case "Crib":
					foreach (NPC k in characters)
					{
						...
						{
						case 1:
							child.toss(CS_0024_003C_003E8__locals0.who);
							return true;
						case 0:
							Game1.drawObjectDialogue(Game1.parseText(Game1.content.LoadString("Strings\\Locations:FarmHouse_Crib_NewbornSleeping", k.displayName)));
							return true;
						case 2:
							if (child.isInCrib())
							{
								return k.checkAction(CS_0024_003C_003E8__locals0.who, this);
							}
							break;
						}
					}
				...
				case "WarpGreenhouse":
					...
					{
						CS_0024_003C_003E8__locals0.who.faceGeneralDirection(new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y) * 64f);
						playSound("doorClose", new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y));
				...
				case "Arcade_Minecart":
					if (CS_0024_003C_003E8__locals0.who.hasSkullKey)
					{
				...
				case "Warp":
				{
					Point tile;
					string locationName;
					if (!ArgUtility.TryGetPoint(CS_0024_003C_003E8__locals0.action, 1, out tile, out error) || !ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 3, out locationName, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					bool num = CS_0024_003C_003E8__locals0.action.Length < 5;
					CS_0024_003C_003E8__locals0.who.faceGeneralDirection(new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y) * 64f);
				...
				case "WarpWomensLocker":
				{
					...
					if (!ArgUtility.TryGetPoint(CS_0024_003C_003E8__locals0.action, 1, out tile2, out error) || !ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 3, out locationName2, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					bool playDoorSound = CS_0024_003C_003E8__locals0.action.Length < 5;
					if (CS_0024_003C_003E8__locals0.who.IsMale)
					{
						if (CS_0024_003C_003E8__locals0.who.IsLocalPlayer)
						{
							Game1.drawObjectDialogue(Game1.content.LoadString("Strings\\Locations:WomensLocker_WrongGender"));
					...
					Game1.warpFarmer(locationName2, tile2.X, tile2.Y, false);
					break;
				}
				case "WarpMensLocker":
				{
					...
					if (!ArgUtility.TryGetPoint(CS_0024_003C_003E8__locals0.action, 1, out tile3, out error) || !ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 3, out locationName3, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					bool playDoorSound2 = CS_0024_003C_003E8__locals0.action.Length < 5;
					if (!CS_0024_003C_003E8__locals0.who.IsMale)
					{
						if (CS_0024_003C_003E8__locals0.who.IsLocalPlayer)
						{
				...
				case "LockedDoorWarp":
				{
					...
					string npcName;
					int minFriendship;
					if (!ArgUtility.TryGetPoint(CS_0024_003C_003E8__locals0.action, 1, out tile4, out error) || !ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 3, out locationName4, out error) || !ArgUtility.TryGetInt(CS_0024_003C_003E8__locals0.action, 4, out openTime2, out error) || !ArgUtility.TryGetInt(CS_0024_003C_003E8__locals0.action, 5, out closeTime2, out error) || !ArgUtility.TryGetOptional(CS_0024_003C_003E8__locals0.action, 6, out npcName, out error) || !ArgUtility.TryGetOptionalInt(CS_0024_003C_003E8__locals0.action, 7, out minFriendship, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					CS_0024_003C_003E8__locals0.who.faceGeneralDirection(new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y) * 64f);
					lockedDoorWarp(tile4, locationName4, openTime2, closeTime2, npcName, minFriendship);
					break;
				}
				case "ConditionalDoor":
				{
					if (CS_0024_003C_003E8__locals0.action.Length <= 1 || Game1.eventUp)
					{
						break;
					}
					StringBuilder s = new StringBuilder();
					for (int i = 1; i < CS_0024_003C_003E8__locals0.action.Length; i++)
					{
						s.Append(CS_0024_003C_003E8__locals0.action[i]);
						if (i < CS_0024_003C_003E8__locals0.action.Length - 1)
						{
							s.Append(" ");
						}
					}
					if (GameStateQuery.CheckConditions(s.ToString()))
					{
						openDoor(CS_0024_003C_003E8__locals0.tileLocation, true);
						return true;
					}
					string message = doesTileHaveProperty(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y, "LockedDoorMessage", "Buildings");
					if (message != null)
					{
				...
				case "Door":
					if (CS_0024_003C_003E8__locals0.action.Length > 1 && !Game1.eventUp)
					{
						for (int j = 1; j < CS_0024_003C_003E8__locals0.action.Length; j++)
						{
							string name = CS_0024_003C_003E8__locals0.action[j];
							string mailKey = "doorUnlock" + name;
							if (CS_0024_003C_003E8__locals0.who.getFriendshipHeartLevelForNPC(name) >= 2 || Game1.player.mailReceived.Contains(mailKey))
							{
						...
						NPC owner = Game1.getCharacterFromName(CS_0024_003C_003E8__locals0.action[1]);
						NPC secondOwner = (ArgUtility.HasIndex(CS_0024_003C_003E8__locals0.action, 2) ? Game1.getCharacterFromName(CS_0024_003C_003E8__locals0.action[2]) : null);
				...
				case "Message":
				{
					...
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out translationKey, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					string s2 = null;
					try
					{
						s2 = Game1.content.LoadStringReturnNullIfNotFound(translationKey);
					}
					catch (Exception)
					{
						s2 = null;
				...
				{
					string dialogue;
					if (!ArgUtility.TryGetRemainder(CS_0024_003C_003E8__locals0.action, 1, out dialogue, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
				...
				case "NPCSpeechMessageNoRadius":
				{
					...
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out npcName2, out error) || !ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 2, out translationKey2, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					...
					if (npc == null)
					{
						...
						{
							return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0("couldn't find or create a matching NPC");
						}
					}
					try
					{
						npc.setNewDialogue("Strings\\StringsFromMaps:" + translationKey2, true);
						Game1.drawDialogue(npc);
						return true;
					}
					catch (Exception e)
					{
						...
						defaultInterpolatedStringHandler.AppendFormatted(e);
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(defaultInterpolatedStringHandler.ToStringAndClear());
					}
				}
				case "NPCMessage":
				{
					string npcName3;
					string rawMessage;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out npcName3, out error) || !ArgUtility.TryGetRemainder(CS_0024_003C_003E8__locals0.action, 2, out rawMessage, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					string message2 = rawMessage.Replace("\"", "");
					NPC npc2 = Game1.getCharacterFromName(npcName3);
					if (npc2 != null && npc2.currentLocation == CS_0024_003C_003E8__locals0.who.currentLocation && Utility.tileWithinRadiusOfPlayer(npc2.TilePoint.X, npc2.TilePoint.Y, 14, CS_0024_003C_003E8__locals0.who))
					{
						try
						{
							string str_name = message2.Split('/')[0];
							string str_name_no_filePath = str_name.Substring(str_name.IndexOf(':') + 1);
							npc2.setNewDialogue(str_name, true);
							...
							case "SeedShop_Abigail_Drawers":
								if (CS_0024_003C_003E8__locals0.who != null)
								{
									Game1.multiplayer.globalChatInfoMessage("Caught_Snooping", CS_0024_003C_003E8__locals0.who.name, npc2.GetTokenizedDisplayName());
								}
								break;
							}
							return true;
					...
					try
					{
						Game1.drawDialogueNoTyping(Game1.content.LoadString(message2.Split('/')[1]));
						return false;
					}
					catch (Exception)
					{
				...
				{
					int key;
					if (!ArgUtility.TryGetInt(CS_0024_003C_003E8__locals0.action, 1, out key, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
				...
				{
					string box_id;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out box_id, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
				...
				{
					string audioName;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out audioName, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
				...
				case "Letter":
				{
					...
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out translationKey3, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					Game1.drawLetterMessage(Game1.content.LoadString("Strings\\StringsFromMaps:" + translationKey3.Replace("\"", "")));
					break;
				}
				case "MessageOnce":
				{
					string eventFlag;
					string dialogue3;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out eventFlag, out error) || !ArgUtility.TryGetRemainder(CS_0024_003C_003E8__locals0.action, 2, out dialogue3, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					if (CS_0024_003C_003E8__locals0.who.eventsSeen.Add(eventFlag))
					{
				...
				case "Lamp":
					...
					break;
				case "Billboard":
					Game1.activeClickableMenu = new Billboard(ArgUtility.Get(CS_0024_003C_003E8__locals0.action, 1) == "3");
					break;
				case "MinecartTransport":
				{
					string networkId = ArgUtility.Get(CS_0024_003C_003E8__locals0.action, 1) ?? "Default";
					string excludeDestinationId = ArgUtility.Get(CS_0024_003C_003E8__locals0.action, 2);
				...
				{
					int mineLevel;
					if (!ArgUtility.TryGetOptionalInt(CS_0024_003C_003E8__locals0.action, 1, out mineLevel, out error, 1))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
				...
				case "Saloon":
					if (CS_0024_003C_003E8__locals0.who.TilePoint.Y > CS_0024_003C_003E8__locals0.tileLocation.Y)
					{
						return saloon(CS_0024_003C_003E8__locals0.tileLocation);
					}
					return false;
				case "Carpenter":
					if (CS_0024_003C_003E8__locals0.who.TilePoint.Y > CS_0024_003C_003E8__locals0.tileLocation.Y)
					{
						return carpenters(CS_0024_003C_003E8__locals0.tileLocation);
					}
					return false;
				case "AnimalShop":
					if (CS_0024_003C_003E8__locals0.who.TilePoint.Y > CS_0024_003C_003E8__locals0.tileLocation.Y)
					{
						return animalShop(CS_0024_003C_003E8__locals0.tileLocation);
					}
					return false;
				case "Blacksmith":
					if (CS_0024_003C_003E8__locals0.who.TilePoint.Y > CS_0024_003C_003E8__locals0.tileLocation.Y)
					{
						return blacksmith(CS_0024_003C_003E8__locals0.tileLocation);
					}
					return false;
				case "Jukebox":
					Game1.activeClickableMenu = new ChooseFromListMenu(Utility.GetJukeboxTracks(Game1.player, Game1.player.currentLocation), ChooseFromListMenu.playSongAction, true);
					break;
				case "Buy":
				{
					string which2;
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out which2, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					if (CS_0024_003C_003E8__locals0.who.TilePoint.Y >= CS_0024_003C_003E8__locals0.tileLocation.Y)
					{
						return HandleBuyAction(which2);
					}
					return false;
				}
				case "Craft":
				...
				{
					string dialogue2;
					if (!ArgUtility.TryGetRemainder(CS_0024_003C_003E8__locals0.action, 1, out dialogue2, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
				...
				case "ClubCards":
				case "BlackJack":
					if (ArgUtility.Get(CS_0024_003C_003E8__locals0.action, 1) == "1000")
					{
					...
					break;
				case "QiCoins":
					if (CS_0024_003C_003E8__locals0.who.clubCoins > 0)
					{
						Game1.drawObjectDialogue(Game1.content.LoadString("Strings\\Locations:Club_QiCoins", CS_0024_003C_003E8__locals0.who.clubCoins));
					}
					else
					{
				...
				case "Mailbox":
					if (this is Farm)
					{
						FarmHouse farmhouse = getBuildingAt(new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y))?.GetIndoors() as FarmHouse;
				...
				{
					int noteId;
					if (!ArgUtility.TryGetInt(CS_0024_003C_003E8__locals0.action, 1, out noteId, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					readNote(noteId);
				...
				case "SpiritAltar":
					if (CS_0024_003C_003E8__locals0.who.ActiveObject != null && Game1.player.team.sharedDailyLuck.Value != -0.12 && Game1.player.team.sharedDailyLuck.Value != 0.12)
					{
						if (CS_0024_003C_003E8__locals0.who.ActiveObject.Price >= 60)
						{
							temporarySprites.Add(new TemporaryAnimatedSprite(352, 70f, 2, 2, new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X * 64, CS_0024_003C_003E8__locals0.tileLocation.Y * 64), false, false));
							Game1.player.team.sharedDailyLuck.Value = 0.12;
							playSound("money");
						}
						else
						{
							temporarySprites.Add(new TemporaryAnimatedSprite(362, 50f, 6, 1, new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X * 64, CS_0024_003C_003E8__locals0.tileLocation.Y * 64), false, false));
							Game1.player.team.sharedDailyLuck.Value = -0.12;
							playSound("thunder");
						}
						CS_0024_003C_003E8__locals0.who.ActiveObject = null;
						CS_0024_003C_003E8__locals0.who.showNotCarrying();
					}
					break;
				case "WizardHatch":
				{
					Friendship friendship;
					if (CS_0024_003C_003E8__locals0.who.friendshipData.TryGetValue("Wizard", out friendship) && friendship.Points >= 1000)
					{
						playSound("doorClose", new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y));
				...
				case "EnterSewer":
					if (CS_0024_003C_003E8__locals0.who.mailReceived.Contains("OpenedSewer"))
					{
						playSound("stairsdown", new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y));
						Game1.warpFarmer("Sewer", 16, 11, 2);
					}
					else if (CS_0024_003C_003E8__locals0.who.hasRustyKey)
					{
						playSound("openBox");
						Game1.drawObjectDialogue(Game1.parseText(Game1.content.LoadString("Strings\\Locations:Forest_OpenedSewer")));
						CS_0024_003C_003E8__locals0.who.mailReceived.Add("OpenedSewer");
					}
					else
					{
						Game1.drawObjectDialogue(Game1.content.LoadString("Strings\\Locations:LockedDoor"));
					...
					break;
				case "DwarfGrave":
					if (CS_0024_003C_003E8__locals0.who.canUnderstandDwarves)
					{
				...
				case "Yoba":
					...
					break;
				case "ElliottBook":
					if (CS_0024_003C_003E8__locals0.who.eventsSeen.Contains("41"))
					{
						Game1.drawObjectDialogue(Game1.parseText(Game1.content.LoadString("Strings\\Locations:ElliottHouse_ElliottBook_Filled", Game1.elliottBookName, CS_0024_003C_003E8__locals0.who.displayName)));
					}
					else
					{
				...
				case "BuildingChest":
				{
					...
					if (!ArgUtility.TryGet(CS_0024_003C_003E8__locals0.action, 1, out buildingAction, out error))
					{
						return CS_0024_003C_003E8__locals0._003CperformAction_003Eg__LogError_007C0(error);
					}
					bool flag = getBuildingAt(new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y))?.PerformBuildingChestAction(buildingAction, CS_0024_003C_003E8__locals0.who) ?? false;
					return true;
				}
				case "BuildingToggleAnimalDoor":
				{
					Building building = getBuildingAt(new Vector2(CS_0024_003C_003E8__locals0.tileLocation.X, CS_0024_003C_003E8__locals0.tileLocation.Y));
					if (building != null)
					{
						if (Game1.didPlayerJustRightClick(true))
						{
							building.ToggleAnimalDoor(CS_0024_003C_003E8__locals0.who);
						}
						return true;
					}
					break;
				...
				case "BuildingSilo":
					...
					if (CS_0024_003C_003E8__locals0.who.ActiveObject?.QualifiedItemId == "(O)178")
					{
						if (CS_0024_003C_003E8__locals0.who.ActiveObject.Stack == 0)
						{
							CS_0024_003C_003E8__locals0.who.ActiveObject.stack.Value = 1;
						}
						int old = CS_0024_003C_003E8__locals0.who.ActiveObject.Stack;
						int leftOver = tryToAddHay(CS_0024_003C_003E8__locals0.who.ActiveObject.Stack);
						CS_0024_003C_003E8__locals0.who.ActiveObject.stack.Value = leftOver;
						if ((int)CS_0024_003C_003E8__locals0.who.ActiveObject.stack < old)
						{
							Game1.playSound("Ship");
							DelayedAction.playSoundAfterDelay("grassyStep", 100);
							Game1.drawObjectDialogue(Game1.content.LoadString("Strings\\Buildings:AddedHay", old - CS_0024_003C_003E8__locals0.who.ActiveObject.Stack));
						}
						if (CS_0024_003C_003E8__locals0.who.ActiveObject.Stack <= 0)
						{
							CS_0024_003C_003E8__locals0.who.removeItemFromInventory(CS_0024_003C_003E8__locals0.who.ActiveObject);
						}
					}
					else
					{
		...
		public void ShowMineCartMenu(string networkId, string excludeDestinationId)
		{
			...
			{
				MinecartDestinationData destination2;
				if (destinationLookup.TryGetValue(destinationId, out destination2))
				{
					int price = destination2.Price;
					if (price < 1)
					{
						MinecartWarp(destination2);
					}
					else
					{
		...
		public void mailbox()
		{
			if (Game1.mailbox.Count > 0)
			{
				...
				string mail;
				if (!mails.TryGetValue(mailTitle, out mail))
				{
					mail = "";
				}
				if (mailTitle.StartsWith("passedOut "))
				{
					...
					switch (Utility.CreateDaySaveRandom(moneyTaken2).Next((Game1.player.getSpouse() != null && Game1.player.getSpouse().Name.Equals("Harvey")) ? 2 : 3))
					{
					case 0:
		...
		public int getTotalCrops()
		{
			...
			{
				HoeDirt dirt = value as HoeDirt;
				if (dirt != null && dirt.crop != null && !dirt.crop.dead)
				{
					amount++;
				}
			}
		...
		public int getTotalOpenHoeDirt()
		{
			...
			foreach (TerrainFeature t in terrainFeatures.Values)
			{
				...
				if (dirt != null && dirt.crop == null && !objects.ContainsKey(t.Tile))
				{
					amount++;
				}
			}
		...
		public int getNumberOfMachinesReadyForHarvest()
		{
			...
			else
			{
				...
				if (islandWest != null && islandWest.farmhouseRestored.Value)
				{
		...
		public virtual bool blacksmith(Location tileLocation)
		{
			foreach (NPC i in characters)
			{
				...
				if (i.Tile != new Vector2(tileLocation.X, tileLocation.Y - 1))
				{
					bool flag = i.Tile != new Vector2(tileLocation.X - 1, tileLocation.Y - 1);
				}
				i.faceDirection(2);
		...
		public virtual bool animalShop(Location tileLocation)
		{
			foreach (NPC i in characters)
			{
				...
				if (i.Tile != new Vector2(tileLocation.X, tileLocation.Y - 1) && i.Tile != new Vector2(tileLocation.X - 1, tileLocation.Y - 1))
				{
		...
		public void characterTrampleTile(Vector2 tile)
		{
			...
			{
				TerrainFeature tf;
				terrainFeatures.TryGetValue(tile, out tf);
				Tree tree = tf as Tree;
				if (tree != null && (int)tree.growthStage < 1 && tree.instantDestroy(tile))
				{
		...
		public bool characterDestroyObjectWithinRectangle(Microsoft.Xna.Framework.Rectangle rect, bool showDestroyedObject)
		{
			...
			{
				LargeTerrainFeature feature = largeTerrainFeatures[j];
				if (feature.isDestroyedByNPCTrample && feature.getBoundingBox().Intersects(rect))
				{
					feature.onDestroy();
					largeTerrainFeatures.RemoveAt(j);
					return true;
				}
			}
		...
		private bool checkDestroyItem(Object o, Vector2 tilePositionToTry, bool showDestroyedObject)
		{
			if (o != null && !o.isPassable() && !map.RequireLayer("Back").Tiles[(int)tilePositionToTry.X, (int)tilePositionToTry.Y].Properties.ContainsKey("NPCBarrier"))
			{
				...
				{
					TemporaryAnimatedSprite sprite = new TemporaryAnimatedSprite(0, 150f, 1, 3, new Vector2(tilePositionToTry.X * 64f, tilePositionToTry.Y * 64f), false, o.flipped)
					{
						alphaFade = 0.01f
					};
		...
		public Object removeObject(Vector2 location, bool showDestroyedObject)
		{
			...
			if (o != null && (o.CanBeGrabbed || showDestroyedObject))
			{
				...
				{
					TemporaryAnimatedSprite sprite = new TemporaryAnimatedSprite(0, 150f, 1, 3, new Vector2(location.X * 64f, location.Y * 64f), true, tmp.bigCraftable, tmp.flipped);
		...
		public virtual void cleanupBeforePlayerExit()
		{
			...
			critters?.Clear();
			for (int j = Game1.onScreenMenus.Count - 1; j >= 0; j--)
			{
				IClickableMenu menu = Game1.onScreenMenus[j];
				if (menu.destroy)
				{
					Game1.onScreenMenus.RemoveAt(j);
		...
		private void startSleep()
		{
			...
			if (Game1.IsMultiplayer)
			{
				...
				Game1.activeClickableMenu = new ReadyCheckDialog("sleep", true, delegate
				{
					doSleep();
				}, delegate(Farmer who)
				{
		...
		public virtual bool answerDialogueAction(string questionAndAnswer, string[] questionParams)
		{
			...
			case "SquidFestBooth_Rewards":
			{
				...
				if (availableRewards.Count > 0)
				{
					...
					if (rewards.Count > 0)
					{
						ItemGrabMenu itemGrabMenu = new ItemGrabMenu(rewards).setEssential(true, true);
			...
			case "evilShrineLeft_Yes":
				...
				{
					Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(536, 1945, 8, 8), new Vector2(156f, 388f), false, 0f, Color.White)
					{
						interval = 50f,
						totalNumberOfLoops = 99999,
						animationLength = 7,
					...
					for (int j = 0; j < 20; j++)
					{
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), new Vector2(2f, 6f) * 64f + new Vector2(Game1.random.Next(-32, 64), Game1.random.Next(16)), false, 0.002f, Color.LightGray)
						{
							alpha = 0.75f,
					...
					playSound("fireball");
					Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(388, 1894, 24, 22), 100f, 6, 9999, new Vector2(2f, 5f) * 64f, false, true, 1f, 0f, Color.White, 4f, 0f, 0f, 0f)
					{
					...
					string message = "";
					foreach (Child n2 in Game1.player.getChildren())
					{
						message += Game1.content.LoadString("Strings\\Locations:WitchHut_Goodbye", n2.getName());
					}
			...
			case "evilShrineCenter_Yes":
				if (Game1.player.Money >= 30000)
				{
					...
					Game1.multiplayer.globalChatInfoMessage("EvilShrine", Game1.player.name);
					Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(536, 1945, 8, 8), new Vector2(468f, 328f), false, 0f, Color.White)
					{
						interval = 50f,
						totalNumberOfLoops = 99999,
						animationLength = 7,
					...
					for (int l = 0; l < 20; l++)
					{
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), new Vector2(7f, 5f) * 64f + new Vector2(Game1.random.Next(-32, 64), Game1.random.Next(16)), false, 0.002f, Color.SlateGray)
						{
							alpha = 0.75f,
					...
					for (int k = 0; k < 16; k++)
					{
						foreach (Vector2 v in Utility.getBorderOfThisRectangle(Utility.getRectangleCenteredAt(new Vector2(7f, 5f), 2 + k * 2)))
						{
							if (count % 2 == 0)
							{
								Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(692, 1853, 4, 4), 25f, 1, 16, v * 64f + new Vector2(32f, 32f), false, false)
								{
									layerDepth = 1f,
			...
			case "evilShrineRightActivate_Yes":
				...
				{
					Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(536, 1945, 8, 8), new Vector2(780f, 388f), false, 0f, Color.White)
					{
						interval = 50f,
						totalNumberOfLoops = 99999,
						animationLength = 7,
					...
					for (int n = 0; n < 20; n++)
					{
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), new Vector2(12f, 6f) * 64f + new Vector2(Game1.random.Next(-32, 64), Game1.random.Next(16)), false, 0.002f, Color.DarkSlateBlue)
						{
							alpha = 0.75f,
					...
					for (int m = 0; m < 28; m++)
					{
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(540, 347, 13, 13), 50f, 4, 9999, new Vector2(12f, 5f) * 64f, false, true, 1f, 0f, Color.White, 4f, 0f, 0f, 0f)
						{
				...
				if (Game1.player.Items.ReduceId("(O)203", 1) > 0)
				{
					...
					for (int i3 = 0; i3 < 20; i3++)
					{
						Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), new Vector2(12f, 6f) * 64f + new Vector2(Game1.random.Next(-32, 64), Game1.random.Next(16)), false, 0.002f, Color.DarkSlateBlue)
						{
							...
							scaleChange = 0.01f,
							rotationChange = (float)Game1.random.Next(-5, 6) * (float)Math.PI / 256f,
							delayBeforeAnimationStart = i3 * 25
						});
					}
			...
			case "Backpack_Purchase":
				...
				else if ((int)Game1.player.maxItems < 36 && Game1.player.Money >= 10000)
				{
					...
					for (int i2 = 0; i2 < (int)Game1.player.maxItems; i2++)
					{
			...
			case "mariner_Buy":
				if (Game1.player.Money >= 5000)
				{
					...
					Item mermaidPendant2 = ItemRegistry.Create("(O)460");
					mermaidPendant2.specialItem = true;
					Game1.player.addItemByMenuIfNecessary(mermaidPendant2);
					if (Game1.activeClickableMenu == null)
					{
			...
			case "Blacksmith_Upgrade":
				...
				{
					NPC n3 = getCharacterFromName("Clint");
					if (n3 != null)
					{
						Game1.DrawDialogue(n3, "Data\\ExtraDialogue:Clint_StillWorking", Game1.player.toolBeingUpgraded.Value.DisplayName);
					}
				}
				else
				{
			...
			case "telephone_Carpenter_BuildingCost":
			{
				...
				CarpenterMenu menu5 = Game1.activeClickableMenu as CarpenterMenu;
				if (menu5 != null)
				{
					menu5.readOnly = true;
					menu5.behaviorBeforeCleanup = (Action<IClickableMenu>)Delegate.Combine(menu5.behaviorBeforeCleanup, (Action<IClickableMenu>)delegate
					{
						answerDialogueAction("HangUp", LegacyShims.EmptyArray<string>());
					});
				}
			...
			case "telephone_SeedShop_CheckSeedStock":
				if (Game1.getLocationFromName("SeedShop") is SeedShop)
				{
					...
					ShopMenu menu2 = Game1.activeClickableMenu as ShopMenu;
					if (menu2 != null)
					{
						menu2.readOnly = true;
			...
			case "ShrineOfChallenge_Yes":
				...
				DelayedAction.functionAfterDelay(delegate
				{
					if (!Game1.player.team.mineShrineActivated.Value)
					{
						...
						temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(536, 1945, 8, 8), new Vector2(8.75f, 5.8f) * 64f + new Vector2(32f, -32f), false, 0f, Color.White)
						{
							interval = 50f,
							totalNumberOfLoops = 99999,
							animationLength = 4,
						...
						temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(536, 1945, 8, 8), new Vector2(10.75f, 5.8f) * 64f + new Vector2(32f, -32f), false, 0f, Color.White)
						{
							interval = 50f,
							totalNumberOfLoops = 99999,
							animationLength = 4,
		...
		public virtual bool answerDialogue(Response answer)
		{
			...
			if (answer.responseKey.Equals("Move"))
			{
				...
				removeObject(actionObjectForQuestionDialogue.TileLocation, false);
		...
		{
			destroyObject(tileLocation, false, who);
		}

		public void destroyObject(Vector2 tileLocation, bool hardDestroy, Farmer who)
		{
			Object obj;
			if (!objects.TryGetValue(tileLocation, out obj) || (int)obj.fragility == 2 || obj is Chest || !(obj.QualifiedItemId != "(BC)165"))
			{
				return;
			}
			bool remove = false;
			if (obj.Type == "Fish" || obj.Type == "Cooking" || obj.Type == "Crafting")
			{
				...
				{
					TemporaryAnimatedSprite sprite = new TemporaryAnimatedSprite(0, 150f, 1, 3, new Vector2(tileLocation.X * 64f, tileLocation.Y * 64f), true, obj.bigCraftable, obj.flipped);
		...
		public void addOneTimeGiftBox(Item i, int x, int y, int whichGiftBox = 2)
		{
			...
			if (!Game1.player.mailReceived.Contains(id))
			{
				...
				Chest c = new Chest(new List<Item> { i }, v, true, whichGiftBox)
				{
		...
		public virtual string GetLocationContextId()
		{
			if (locationContextId == null)
			{
				...
				string contextId;
				if (map != null && map.Properties.TryGetValue("LocationContext", out contextId))
				{
		...
		public virtual bool sinkDebris(Debris debris, Vector2 chunkTile, Vector2 chunkPosition)
		{
			...
			if (debris.debrisType.Value == Debris.DebrisType.CHUNKS)
			{
				...
				TemporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Microsoft.Xna.Framework.Rectangle(0, 0, 64, 64), 150f, 3, 0, chunkPosition, false, Game1.random.NextBool(), 0.001f, 0.02f, Color.White, 0.75f, 0.003f, 0f, 0f));
				return true;
			}
			TemporarySprites.Add(new TemporaryAnimatedSprite(28, 300f, 2, 1, chunkPosition, false, false));
		...
		public virtual bool doesEitherTileOrTileIndexPropertyEqual(int xTile, int yTile, string propertyName, string layerName, string propertyValue)
		{
			...
			if (layer != null)
			{
				...
				string property2;
				if (tmp != null && tmp.TileIndexProperties.TryGetValue(propertyName, out property2) && property2 == propertyValue)
				{
					return true;
				}
				string property;
		...
		public virtual bool IsNoSpawnTile(Vector2 tile, string type = "All", bool ignoreTileSheetProperties = false)
		{
			...
			{
				bool isBanned;
				if (!bool.TryParse(noSpawn, out isBanned) || isBanned)
				{
					return true;
				}
				break;
		...
		public bool isCropAtTile(int tileX, int tileY)
		{
			Vector2 v = new Vector2(tileX, tileY);
			TerrainFeature terrainFeature;
			if (terrainFeatures.TryGetValue(v, out terrainFeature))
			{
		...
		public virtual bool dropObject(Object obj, Vector2 dropLocation, xTile.Dimensions.Rectangle viewport, bool initialPlacement, Farmer who = null)
		{
			...
			{
				Game1.multiplayer.broadcastSprites(this, new TemporaryAnimatedSprite(28, 300f, 2, 1, dropLocation, false, obj.flipped));
			...
			else
			{
				...
				if (obj.ParentSheetIndex >= 0 && obj.Type != null)
				{
					if (obj.Type == "Fish" || obj.Type == "Cooking" || obj.Type == "Crafting")
					{
						TemporaryAnimatedSprite sprite = new TemporaryAnimatedSprite(0, 150f, 1, 3, dropLocation, true, obj.flipped);
						sprite.CopyAppearanceFromItemId(obj.QualifiedItemId);
						Game1.multiplayer.broadcastSprites(this, sprite);
					}
					else
					{
						TemporaryAnimatedSprite sprite2 = new TemporaryAnimatedSprite(0, 150f, 1, 3, dropLocation, true, obj.flipped);
		...
		public void explode(Vector2 tileLocation, int radius, Farmer who, bool damageFarmers = true, int damage_amount = -1, bool destroyObjects = true)
		{
			...
			if (damage_amount > 0)
			{
				damageMonster(areaOfEffect, damage_amount, damage_amount, true, who);
			}
			else
			{
				damageMonster(areaOfEffect, radius * 6, radius * 8, true, who);
			}
			TemporaryAnimatedSpriteList sprites = new TemporaryAnimatedSpriteList();
			sprites.Add(new TemporaryAnimatedSprite(23, 9999f, 6, 1, new Vector2(currentTile.X * 64f, currentTile.Y * 64f), false, Game1.random.NextBool())
			{
				light = true,
				lightRadius = radius,
			...
			if (damageFarmers)
			{
				...
				damagePlayers(areaOfEffect, actualDamage, true);
			}
			for (int j = 0; j < radius * 2 + 1; j++)
			{
				for (int k = 0; k < radius * 2 + 1; k++)
				{
					if (j == 0 || k == 0 || j == radius * 2 || k == radius * 2)
					{
						insideCircle = (circleOutline[j, k] ? 1 : 0);
					}
					else if (circleOutline[j, k])
					{
						insideCircle += ((k <= radius) ? 1 : (-1));
						if (insideCircle <= 0)
						{
							if (destroyObjects)
							{
								Object obj2;
								if (objects.TryGetValue(currentTile, out obj2) && obj2.onExplosion(who))
								{
							...
							if (Game1.random.NextDouble() < 0.45)
							{
								if (Game1.random.NextBool())
								{
									sprites.Add(new TemporaryAnimatedSprite(362, Game1.random.Next(30, 90), 6, 1, new Vector2(currentTile.X * 64f, currentTile.Y * 64f), false, Game1.random.NextBool())
									{
					...
					if (insideCircle >= 1)
					{
						...
						{
							Object obj;
							if (objects.TryGetValue(currentTile, out obj) && obj.onExplosion(who))
							{
								destroyObject(currentTile, who);
							}
							if (terrainFeatures.ContainsKey(currentTile) && terrainFeatures[currentTile].performToolAction(null, radius / 2, currentTile))
			...
			for (int i = 0; i < radius * 2 + 1; i++)
			{
				...
				{
					if (i == 0 || l == 0 || i == radius * 2 || l == radius * 2)
					{
						insideCircle = (circleOutline[i, l] ? 1 : 0);
					}
					else if (circleOutline[i, l])
					{
						...
						{
							checkForBuriedItem((int)currentTile.X, (int)currentTile.Y, true, false, who);
		...
		public virtual void performTenMinuteUpdate(int timeOfDay)
		{
			...
			if (Game1.dayOfMonth % 7 == 0 && Game1.timeOfDay >= 1200 && Game1.timeOfDay <= 1500 && name.Equals("Saloon") && NetWorldState.checkAnywhereForWorldStateID("saloonSportsRoom"))
			{
				...
				else
				{
					...
					foreach (NPC l in characters)
					{
						if (l.TilePoint.Y < 12 && l.TilePoint.X > 26 && Game1.random.NextDouble() < ((goodEvent || badEvent) ? 0.66 : 0.25))
						{
							sportsBoys.Add(l);
						}
					}
					foreach (NPC k in sportsBoys)
					{
						k.showTextAboveHead(Game1.content.LoadString("Strings\\Characters:Saloon_" + (goodEvent ? "goodEvent" : (badEvent ? "badEvent" : "neutralEvent")) + "_" + Game1.random.Next(5)));
			...
			{
				characters.Add(new Fly(getRandomTile() * 64f, true));
			}
		}
		...
		public virtual bool performOrePanTenMinuteUpdate(Random r)
		{
			if (Game1.MasterPlayer.mailReceived.Contains("ccFishTank") && !(this is Beach) && orePanPoint.Value.Equals(Point.Zero) && r.NextBool())
			{
				...
				{
					Point p = new Point(r.Next(0, Map.RequireLayer("Back").LayerWidth), r.Next(0, Map.RequireLayer("Back").LayerHeight));
					if (isOpenWater(p.X, p.Y) && FishingRod.distanceToLand(p.X, p.Y, this, true) <= 1 && getTileIndexAt(p, "Buildings") == -1)
					{
						if (Game1.player.currentLocation.Equals(this))
						{
							playSound("slosh");
		...
		public virtual IList<string> GetCrabPotFishForTile(Vector2 tile)
		{
			...
			string id;
			FishAreaData data;
			if (TryGetFishAreaForTile(tile, out id, out data))
			{
		...
		public virtual string GetFishingAreaDisplayName(string id)
		{
			...
			if (data?.FishAreas == null || !data.FishAreas.TryGetValue(id, out fishArea) || fishArea.DisplayName == null)
			{
				return null;
			}
		...
		public virtual Item getFish(float millisecondsAfterNibble, string bait, int waterDepth, Farmer who, double baitPotency, Vector2 bobberTile, string locationName = null)
		{
			...
			return GetFishFromLocationData(Name, bobberTile, waterDepth, who, isTutorialCatch, false, this) ?? ItemRegistry.Create("(O)168");
		}
		...
		internal static Item GetFishFromLocationData(string locationName, Vector2 bobberTile, int waterDepth, Farmer player, bool isTutorialCatch, bool isInherited, GameLocation location, ItemQueryContext itemQueryContext)
		{
			...
			string fishAreaId;
			FishAreaData data;
			if (location == null || !location.TryGetFishAreaForTile(bobberTile, out fishAreaId, out data))
			{
				fishAreaId = null;
			}
			...
			for (int i = 0; i < 2; i++)
			{
				foreach (SpawnFishData spawn in possibleFish)
				{
					...
					Item item = ItemQueryResolver.TryResolveRandomItem(spawn, itemQueryContext, false, null, (string query) => query.Replace("BOBBER_X", ((int)bobberTile.X).ToString()).Replace("BOBBER_Y", ((int)bobberTile.Y).ToString()).Replace("WATER_DEPTH", waterDepth.ToString()), null, delegate(string query, string error)
					{
						IGameLogger log = Game1.log;
					...
					Item fish = item;
					int[] values;
					if ((spawn.CatchLimit <= -1 || !player.fishCaught.TryGetValue(fish.QualifiedItemId, out values) || values[0] < spawn.CatchLimit) && CheckGenericFishRequirements(fish, allFishData, location, player, spawn, waterDepth, usingMagicBait, hasCuriosityLure, spawn.ItemId == baitTargetFish, isTutorialCatch))
					{
		...
		{
			_003C_003Ec__DisplayClass496_0 _003C_003Ec__DisplayClass496_ = default(_003C_003Ec__DisplayClass496_0);
			_003C_003Ec__DisplayClass496_.fish = fish;
			string rawSpecificFishData;
			if (!_003C_003Ec__DisplayClass496_.fish.HasTypeObject() || !allFishData.TryGetValue(_003C_003Ec__DisplayClass496_.fish.ItemId, out rawSpecificFishData))
			{
			...
			if (isTrainingRod)
			{
				...
				else
				{
					int difficulty;
					string error6;
					if (!ArgUtility.TryGetInt(specificFishData, 1, out difficulty, out error6))
					{
						return _003CCheckGenericFishRequirements_003Eg__LogFormatError_007C496_0(error6, ref _003C_003Ec__DisplayClass496_);
					}
					if (difficulty >= 50)
					{
						return false;
			...
			if (isTutorialCatch)
			{
				bool isTutorialFish;
				string error5;
				if (!ArgUtility.TryGetOptionalBool(specificFishData, 13, out isTutorialFish, out error5))
				{
					return _003CCheckGenericFishRequirements_003Eg__LogFormatError_007C496_0(error5, ref _003C_003Ec__DisplayClass496_);
				}
				if (!isTutorialFish)
				{
					return false;
			...
			if (!spawn.IgnoreFishDataRequirements)
			{
				if (!usingMagicBait)
				{
					string rawTimeSpans;
					string error4;
					if (!ArgUtility.TryGet(specificFishData, 5, out rawTimeSpans, out error4))
					{
						return _003CCheckGenericFishRequirements_003Eg__LogFormatError_007C496_0(error4, ref _003C_003Ec__DisplayClass496_);
					}
					...
					for (int i = 0; i < timeSpans.Length; i += 2)
					{
						int startTime;
						int endTime;
						if (!ArgUtility.TryGetInt(timeSpans, i, out startTime, out error4) || !ArgUtility.TryGetInt(timeSpans, i + 1, out endTime, out error4))
						{
							return _003CCheckGenericFishRequirements_003Eg__LogFormatError_007C496_0("invalid time spans '" + rawTimeSpans + "': " + error4, ref _003C_003Ec__DisplayClass496_);
						}
				...
				if (!usingMagicBait)
				{
					string weather;
					string error3;
					if (!ArgUtility.TryGet(specificFishData, 7, out weather, out error3))
					{
						return _003CCheckGenericFishRequirements_003Eg__LogFormatError_007C496_0(error3, ref _003C_003Ec__DisplayClass496_);
					}
					if (!(weather == "rainy"))
					{
				...
				int minFishingLevel;
				string error2;
				if (!ArgUtility.TryGetInt(specificFishData, 12, out minFishingLevel, out error2))
				{
					return _003CCheckGenericFishRequirements_003Eg__LogFormatError_007C496_0(error2, ref _003C_003Ec__DisplayClass496_);
				}
				...
				float chance;
				if (!ArgUtility.TryGetInt(specificFishData, 9, out maxDepth, out error) || !ArgUtility.TryGetFloat(specificFishData, 10, out chance, out error) || !ArgUtility.TryGetFloat(specificFishData, 11, out depthMultiplier, out error))
				{
					return _003CCheckGenericFishRequirements_003Eg__LogFormatError_007C496_0(error, ref _003C_003Ec__DisplayClass496_);
				}
		...
		public virtual bool isActionableTile(int xTile, int yTile, Farmer who)
		{
			...
			{
				Object obj;
				if (objects.TryGetValue(new Vector2(xTile, yTile), out obj) && obj.isActionable(who))
				{
					isActionable = true;
				}
				TerrainFeature terrainFeature;
				if (!Game1.isFestival() && terrainFeatures.TryGetValue(new Vector2(xTile, yTile), out terrainFeature) && terrainFeature.isActionable())
				{
					isActionable = true;
				}
			}
		...
		{
			_003C_003Ec__DisplayClass501_0 _003C_003Ec__DisplayClass501_ = default(_003C_003Ec__DisplayClass501_0);
			_003C_003Ec__DisplayClass501_.rawData = DataLoader.Locations(Game1.content);
			if (name == "Farm")
			{
				return _003CGetData_003Eg__GetImpl_007C501_0("Farm_" + Game1.GetFarmTypeKey(), ref _003C_003Ec__DisplayClass501_) ?? _003CGetData_003Eg__GetImpl_007C501_0("Farm_Standard", ref _003C_003Ec__DisplayClass501_);
			}
			return _003CGetData_003Eg__GetImpl_007C501_0(name, ref _003C_003Ec__DisplayClass501_);
		}
		...
		{
			_003C_003Ec__DisplayClass504_0 _003C_003Ec__DisplayClass504_ = default(_003C_003Ec__DisplayClass504_0);
			_003C_003Ec__DisplayClass504_._003C_003E4__this = this;
			_003C_003Ec__DisplayClass504_.xLocation = xLocation;
			_003C_003Ec__DisplayClass504_.yLocation = yLocation;
			string property = doesTileHaveProperty(_003C_003Ec__DisplayClass504_.xLocation, _003C_003Ec__DisplayClass504_.yLocation, "Treasure", "Back");
			if (property == null)
			{
				return null;
			}
			...
			string type;
			string error;
			if (!ArgUtility.TryGet(fields, 0, out type, out error))
			{
				_003CHandleTreasureTileProperty_003Eg__LogError_007C504_0(property, error, ref _003C_003Ec__DisplayClass504_);
				return null;
			}
			if (detectOnly)
			{
			...
			{
				string itemId;
				if (ArgUtility.TryGet(fields, 1, out itemId, out error))
				{
					Game1.createObjectDebris(itemId, _003C_003Ec__DisplayClass504_.xLocation, _003C_003Ec__DisplayClass504_.yLocation);
				}
				else
				{
					_003CHandleTreasureTileProperty_003Eg__LogError_007C504_0(property, error, ref _003C_003Ec__DisplayClass504_);
			...
			case "CaveCarrot":
				Game1.createObjectDebris("(O)78", _003C_003Ec__DisplayClass504_.xLocation, _003C_003Ec__DisplayClass504_.yLocation);
				break;
			case "Coins":
				Game1.createObjectDebris("(O)330", _003C_003Ec__DisplayClass504_.xLocation, _003C_003Ec__DisplayClass504_.yLocation);
				break;
			case "Coal":
			case "Copper":
			case "Gold":
			...
			case "Iron":
			{
				...
				int itemId2;
				if (ArgUtility.TryGetInt(fields, 1, out itemId2, out error))
				{
					Game1.createDebris(debris, _003C_003Ec__DisplayClass504_.xLocation, _003C_003Ec__DisplayClass504_.yLocation, itemId2);
				}
				else
				{
					_003CHandleTreasureTileProperty_003Eg__LogError_007C504_0(property, error, ref _003C_003Ec__DisplayClass504_);
			...
			{
				string itemId3;
				if (ArgUtility.TryGet(fields, 1, out itemId3, out error))
				{
					Game1.createObjectDebris(itemId3, _003C_003Ec__DisplayClass504_.xLocation, _003C_003Ec__DisplayClass504_.yLocation);
			...
			{
				string itemId4;
				if (ArgUtility.TryGet(fields, 1, out itemId4, out error))
				{
					Item item = ItemRegistry.Create(itemId4);
					Game1.createItemDebris(item, new Vector2(_003C_003Ec__DisplayClass504_.xLocation, _003C_003Ec__DisplayClass504_.yLocation), -1, this);
			...
			default:
				type = null;
				_003CHandleTreasureTileProperty_003Eg__LogError_007C504_0(property, "invalid treasure type '" + type + "'", ref _003C_003Ec__DisplayClass504_);
				break;
			}
			map.RequireLayer("Back").Tiles[_003C_003Ec__DisplayClass504_.xLocation, _003C_003Ec__DisplayClass504_.yLocation].Properties["Treasure"] = null;
			return type;
		}
		...
		public virtual void shiftContents(int dx, int dy, Func<Vector2, object, bool> where = null)
		{
			...
			objects.Clear();
			foreach (KeyValuePair<Vector2, Object> v4 in list)
			{
				if (where == null || where(v4.Key, v4.Value))
				{
					if (v4.Value.lightSource != null)
					{
						removeLightSource(v4.Value.lightSource.identifier);
					}
					Vector2 tile2 = v4.Key + offset;
					objects.Add(tile2, v4.Value);
					v4.Value.initializeLightSource(tile2);
				}
				else
				{
					objects.Add(v4.Key, v4.Value);
				}
			}
			...
			foreach (KeyValuePair<Vector2, TerrainFeature> v3 in list2)
			{
				Vector2 tile = ((where == null || where(v3.Key, v3.Value)) ? (v3.Key + offset) : v3.Key);
				terrainFeatures.Add(tile, v3.Value);
			}
			foreach (LargeTerrainFeature v2 in largeTerrainFeatures)
			{
				if (where == null || where(v2.Tile, v2))
				{
					v2.Tile += offset;
				}
			}
		...
		public void OnStoneDestroyed(string stoneId, int x, int y, Farmer who)
		{
			...
			MineShaft mine = who?.currentLocation as MineShaft;
			if (mine != null && mine.mineLevel > 120 && !mine.isSideBranch())
			{
			...
			int level;
			if (!MineShaft.IsGeneratedLevel(this, out level))
			{
				...
				if (possibleForage.Any())
				{
					...
					for (int j = 0; j < numberToSpawn; j++)
					{
						for (int attempt = 0; attempt < 11; attempt++)
						{
							...
							if (objects.ContainsKey(location2) || IsNoSpawnTile(location2) || doesTileHaveProperty(xCoord2, yCoord2, "Spawnable", "Back") == null || doesEitherTileOrTileIndexPropertyEqual(xCoord2, yCoord2, "Spawnable", "Back", "F") || !CanItemBePlacedHere(location2) || getTileIndexAt(xCoord2, yCoord2, "AlwaysFront") != -1 || getTileIndexAt(xCoord2, yCoord2, "AlwaysFront2") != -1 || getTileIndexAt(xCoord2, yCoord2, "AlwaysFront3") != -1 || getTileIndexAt(xCoord2, yCoord2, "Front") != -1 || isBehindBush(location2) || (!r.NextBool(0.1) && isBehindTree(location2)))
							{
								continue;
							}
							...
							Item forageItem = ItemQueryResolver.TryResolveRandomItem(forage, itemQueryContext, false, null, null, null, delegate(string query, string error)
							{
								...
								defaultInterpolatedStringHandler2.AppendFormatted(NameOrUniqueName);
							...
							else
							{
								...
								if (dropObject(forageObj, location2 * 64f, Game1.viewport, true))
								{
									numberOfSpawnedObjectsOnMap++;
									break;
								}
		...
		public void spawnWeedsAndStones(int numDebris = -1, bool weedsOnly = false, bool spawnFromOldWeeds = true)
		{
			...
			for (int i = 0; i < numWeedsAndStones; i++)
			{
				...
				if (num == tile_is_diggable && !IsNoSpawnTile(checked_tile) && doesTileHaveProperty(checked_tile_x, checked_tile_y, "Type", "Back") != "Wood")
				{
					...
					{
						Object tileObj;
						if (objects.TryGetValue(checked_tile, out tileObj))
						{
							if (greenRain)
							{
								is_tile_clear = false;
						...
						TerrainFeature terrainFeature;
						if (!is_tile_clear && terrainFeatures.TryGetValue(checked_tile, out terrainFeature) && (terrainFeature is HoeDirt || terrainFeature is Flooring))
						{
							is_tile_clear = ((!greenRain) ? true : false);
						}
					}
					if (is_tile_clear)
					{
				...
				Object removedObj;
				if (objects.TryGetValue(v + baseVect, out removedObj))
				{
				...
				if (terrainFeatures.TryGetValue(v + baseVect, out removedFeature))
				{
					try
					{
		...
		public virtual void removeObjectsAndSpawned(int x, int y, int width, int height)
		{
			...
			for (int j = largeTerrainFeatures.Count - 1; j >= 0; j--)
			{
				if (largeTerrainFeatures[j].getBoundingBox().Intersects(pixelArea))
				{
					largeTerrainFeatures.RemoveAt(j);
				}
			}
		...
		public virtual void removeEverythingFromThisTile(int x, int y)
		{
			...
			for (int k = furniture.Count - 1; k >= 0; k--)
			{
				if (furniture[k].GetBoundingBox().Contains(v_position))
				{
					furniture.RemoveAt(k);
				}
			}
			for (int j = characters.Count - 1; j >= 0; j--)
			{
				if (characters[j].Tile == v && characters[j] is Monster)
				{
					characters.RemoveAt(j);
				}
			}
		...
		{
			int result;
			if (!key.Contains('/') && !int.TryParse(key, out result))
			{
				return false;
			}
		...
		public virtual void checkForEvents()
		{
			if (Game1.killScreen && !Game1.eventUp)
			{
				...
				if (name.Equals("Mine"))
				{
					...
					case 2:
						rescuer2 = "Maru";
						uniquemessage2 = ((Game1.player.spouse == "Maru") ? "Data\\ExtraDialogue:Mines_PlayerKilled_Maru_Spouse" : "Data\\ExtraDialogue:Mines_PlayerKilled_Maru_NotSpouse");
						break;
					default:
						rescuer2 = "Linus";
					...
					currentEvent = new Event(Game1.content.LoadString("Data\\Events\\Mine:PlayerKilled", rescuer2, uniquemessage2, ArgUtility.EscapeQuotes(Game1.player.Name)));
				}
				...
				else
				{
					try
					{
						...
						string eventScript;
						if (TryGetLocationEvents(out assetName, out events2) && events2.TryGetValue("PlayerKilled", out eventScript))
						{
			...
			else
			{
				...
				defaultInterpolatedStringHandler.AppendFormatted(Game1.dayOfMonth);
				...
				if (!Game1.eventUp && currentEvent == null && Game1.farmEvent == null && !IsGreenRainingHere())
				{
					...
					if (events != null)
					{
						...
						PetData data;
						if (currentEvent == null && Game1.IsMasterGame && Game1.stats.DaysPlayed >= 20 && !Game1.player.mailReceived.Contains("rejectedPet") && !Game1.player.hasPet() && Pet.TryGetData(Game1.player.whichPetType, out data) && Name == data.AdoptionEventLocation && !string.IsNullOrWhiteSpace(data.AdoptionEventId) && !Game1.player.eventsSeen.Contains(data.AdoptionEventId))
						{
		...
		public virtual void startEvent(Event evt)
		{
			...
			if (Game1.player.mount != null)
			{
				...
				if (mount.currentLocation != null && mount.currentLocation.isCollidingPosition(bbox, Game1.viewport, false, 0, false, mount, true))
				{
					bbox.X -= 64;
					if (!mount.currentLocation.isCollidingPosition(bbox, Game1.viewport, false, 0, false, mount, true))
					{
						position.X -= 64f;
			...
			if (!Game1.isFestival() && terrainFeatures.Length > 0)
			{
				...
				for (int y = Game1.viewport.Y / 64 - 1; y < (Game1.viewport.Y + Game1.viewport.Height) / 64 + 7; y++)
				{
					for (int x = Game1.viewport.X / 64 - 1; x < (Game1.viewport.X + Game1.viewport.Width) / 64 + 3; x++)
					{
						...
						tile.Y = y;
						TerrainFeature feat;
						if (terrainFeatures.TryGetValue(tile, out feat) && feat is Flooring)
						{
							feat.draw(b);
						}
					}
		...
		protected void drawDebris(SpriteBatch b)
		{
			...
			foreach (Debris d in debris)
			{
				...
				if (d.item != null)
				{
					...
					if (obj != null && (bool)obj.bigCraftable)
					{
						obj.drawInMenu(b, Utility.snapDrawPosition(Game1.GlobalToLocal(Game1.viewport, d.Chunks[0].position.Value + new Vector2(32f, 32f))), 1.6f, 1f, ((float)(d.chunkFinalYLevel + 64 + 8) + d.Chunks[0].position.X / 10000f) / 10000f, StackDrawType.Hide, Color.White, true);
					}
					else
					{
						d.item.drawInMenu(b, Utility.snapDrawPosition(Game1.GlobalToLocal(Game1.viewport, d.Chunks[0].position.Value + new Vector2(32f, 32f))), 0.8f + (float)d.itemQuality * 0.1f, 1f, ((float)(d.chunkFinalYLevel + 64 + 8) + d.Chunks[0].position.X / 10000f) / 10000f, StackDrawType.Hide, Color.White, true);
					}
					continue;
				}
				...
				if (d.itemId.Value != null)
				{
					...
					{
						Microsoft.Xna.Framework.Rectangle sourceRect2 = ((d.debrisType.Value == Debris.DebrisType.RESOURCE) ? itemData.GetSourceRect(d.Chunks[k].randomOffset) : itemData.GetSourceRect());
						SpriteEffects spriteEffect = (((bool)d.floppingFish && d.Chunks[k].bounces % 2 == 0) ? SpriteEffects.FlipHorizontally : SpriteEffects.None);
						b.Draw(texture, Utility.snapDrawPosition(Game1.GlobalToLocal(Game1.viewport, d.Chunks[k].position.Value)), sourceRect2, Color.White, 0f, Vector2.Zero, scale, spriteEffect, ((float)(d.chunkFinalYLevel + 32) + d.Chunks[k].position.X / 10000f) / 10000f);
				...
				else
				{
					...
					{
						Vector2 position = Utility.snapDrawPosition(Game1.GlobalToLocal(Game1.viewport, d.Chunks[j].position.Value));
						Microsoft.Xna.Framework.Rectangle sourceRect = Game1.getSourceRectForStandardTileSheet(Game1.debrisSpriteSheet, d.chunkType.Value + d.Chunks[j].randomOffset, 16, 16);
		...
		public virtual void draw(SpriteBatch b)
		{
			...
			foreach (Farmer farmer2 in farmers)
			{
				...
				_currentLocationFarmersForDisambiguating.Add(farmer2);
			}
			...
			for (int j = 0; j < _currentLocationFarmersForDisambiguating.Count; j++)
			{
				for (int k = j + 1; k < _currentLocationFarmersForDisambiguating.Count; k++)
				{
					Farmer farmer = _currentLocationFarmersForDisambiguating[j];
					Farmer other_farmer = _currentLocationFarmersForDisambiguating[k];
			...
			if ((!Game1.eventUp || (currentEvent != null && currentEvent.showGroundObjects)) && objects.Length > 0)
			{
				...
				for (int y = Game1.viewport.Y / 64 - 1; y < (Game1.viewport.Y + Game1.viewport.Height) / 64 + 3; y++)
				{
					for (int x = Game1.viewport.X / 64 - 1; x < (Game1.viewport.X + Game1.viewport.Width) / 64 + 1; x++)
					{
						...
						tile.Y = y;
						Object o;
						if (objects.TryGetValue(tile, out o))
						{
			...
			if (netCollection != null && netCollection.Count > 0)
			{
				foreach (LargeTerrainFeature f2 in largeTerrainFeatures)
				{
					if (f2.getRenderBounds().Intersects(viewportRect))
					{
						f2.draw(b);
					}
				}
		...
		public virtual void seasonUpdate(bool onLoad = false)
		{
			...
			if (IsOutdoors && !onLoad)
			{
				...
				for (int j = 0; j < array.Length; j++)
				{
					KeyValuePair<Vector2, Object> pair2 = array[j];
		...
		{
			return checkEventPrecondition(precondition, true);
		}
		...
		{
			Object hay;
			if (_003CGetHayFromAnySilo_003Eg__TryGetHayFrom_007C564_0(currentLocation, out hay))
			{
				return hay;
			}
			if (currentLocation.Name != "Farm" && _003CGetHayFromAnySilo_003Eg__TryGetHayFrom_007C564_0(Game1.getFarm(), out hay))
			{
				return hay;
			}
			Utility.ForEachLocation((GameLocation location) => !_003CGetHayFromAnySilo_003Eg__TryGetHayFrom_007C564_0(location, out hay), false);
			return hay;
		}
		...
		public bool buildStructure(Building building, Vector2 tileLocation, Farmer who, bool skipSafetyChecks = false)
		{
			if (!skipSafetyChecks)
			{
				for (int y3 = 0; y3 < (int)building.tilesHigh; y3++)
				{
					for (int x3 = 0; x3 < (int)building.tilesWide; x3++)
					{
						pokeTileForConstruction(new Vector2(tileLocation.X + (float)x3, tileLocation.Y + (float)y3));
					}
				}
				foreach (BuildingPlacementTile additionalPlacementTile in building.GetAdditionalPlacementTiles())
				{
					...
					{
						pokeTileForConstruction(new Vector2(tileLocation.X + (float)areaTile2.X, tileLocation.Y + (float)areaTile2.Y));
					}
				}
				for (int y5 = 0; y5 < (int)building.tilesHigh; y5++)
				{
					for (int x4 = 0; x4 < (int)building.tilesWide; x4++)
					{
						Vector2 currentGlobalTilePosition2 = new Vector2(tileLocation.X + (float)x4, tileLocation.Y + (float)y5);
						if (buildings.Contains(building) && building.occupiesTile(currentGlobalTilePosition2))
						{
							continue;
						}
						...
						foreach (Farmer farmer in farmers)
						{
							if (farmer.GetBoundingBox().Intersects(new Microsoft.Xna.Framework.Rectangle(x4 * 64, y5 * 64, 64, 64)))
							{
								return false;
							}
						}
				...
				foreach (BuildingPlacementTile additionalPlacementTile2 in building.GetAdditionalPlacementTiles())
				{
					...
					foreach (Point point in additionalPlacementTile2.TileArea.GetPoints())
					{
						int x5 = point.X;
						int y4 = point.Y;
						Vector2 currentGlobalTilePosition3 = new Vector2(tileLocation.X + (float)x5, tileLocation.Y + (float)y4);
						if (buildings.Contains(building) && building.occupiesTile(currentGlobalTilePosition3))
						{
							continue;
						}
						if (!isBuildable(currentGlobalTilePosition3, onlyNeedsToBePassable))
						{
							return false;
						}
						...
						foreach (Farmer farmer2 in farmers)
						{
							if (farmer2.GetBoundingBox().Intersects(new Microsoft.Xna.Framework.Rectangle(x5 * 64, y4 * 64, 64, 64)))
							{
								return false;
							}
						}
			...
			for (int y2 = 0; y2 < (int)building.tilesHigh; y2++)
			{
				for (int x = 0; x < (int)building.tilesWide; x++)
				{
					Vector2 currentGlobalTilePosition = new Vector2(tileLocation.X + (float)x, tileLocation.Y + (float)y2);
			...
			{
				for (int x2 = 0; x2 < (int)building.tilesWide; x2++)
				{
					_003CbuildStructure_003Eg__RemoveArtifactSpots_007C573_0(new Vector2(tileLocation.X + (float)x2, tileLocation.Y + (float)y));
				}
			}
			foreach (BuildingPlacementTile area in building.GetAdditionalPlacementTiles())
			{
				...
				{
					_003CbuildStructure_003Eg__RemoveArtifactSpots_007C573_0(new Vector2(tileLocation.X + (float)areaTile.X, tileLocation.Y + (float)areaTile.Y));
				}
			}
			return true;
		}
		...
		public bool buildStructure(string typeId, BuildingData data, Vector2 tileLocation, Farmer who, out Building constructed, bool magicalConstruction = false, bool skipSafetyChecks = false)
		{
			...
			if (!skipSafetyChecks)
			{
				for (int y4 = 0; y4 < tilesHigh; y4++)
				{
					for (int x2 = 0; x2 < tilesWide; x2++)
					{
						pokeTileForConstruction(new Vector2(tileLocation.X + (float)x2, tileLocation.Y + (float)y4));
					}
				}
				...
				for (int y3 = 0; y3 < tilesHigh; y3++)
				{
					for (int x3 = 0; x3 < tilesWide; x3++)
					{
				...
				if (data.HumanDoor != new Point(-1, -1))
				{
					...
					if (!isBuildable(doorPos, true) && !isPath(doorPos))
					{
						constructed = null;
						return false;
					}
		...
		{
			TerrainFeature terrainFeature;
			if (terrainFeatures.TryGetValue(tileLocation, out terrainFeature) && terrainFeature != null && terrainFeature.isPassable())
			{
				Object obj;
				if (objects.TryGetValue(tileLocation, out obj) && obj != null)
				{
		...
		public bool isBuildable(Vector2 tileLocation, bool onlyNeedsToBePassable = false)
		{
			...
			if (CanItemBePlacedHere(tileLocation, false, CollisionMask.All, ~CollisionMask.Objects, true) || getObjectAtTile((int)tileLocation.X, (int)tileLocation.Y)?.QualifiedItemId == "(O)590")
			{
		...
		public virtual void updateWarps()
		{
			...
			foreach (string propertyName in array)
			{
				...
				if (!map.Properties.TryGetValue(propertyName, out warpsUnparsed) || warpsUnparsed == null)
				{
					continue;
				}
				...
				for (int i = 0; i < fields.Length; i += 5)
				{
					...
					{
						warps.Add(new Warp(fromX, fromY, fields[i + 2], toX, toY, false, npcOnly));
					}
				}
			}
			if (warps.Count > 0)
		...
		public void loadObjects()
		{
			...
			for (int i = 0; i < trees.Length; i += 3)
			{
				...
				string error;
				int treeType;
				if (!ArgUtility.TryGetVector2(trees, i, out position, out error) || !ArgUtility.TryGetInt(trees, i + 2, out treeType, out error))
				{
					LogMapPropertyError("Trees", trees, error);
				}
				else
			...
			if (pathsLayer != null && TryGetMapProperty("LoadTreesFrom", out parentTreeLocation))
			{
				...
				if (parentTreeMap != null)
				{
					foreach (KeyValuePair<Vector2, TerrainFeature> pair in parentTreeMap.terrainFeatures.Pairs)
					{
						...
						if (tree != null)
						{
							...
							int? growthStageOnRegrow;
							bool isFruitTree;
							if (pathsLayer.GetTileIndexAt(p.X, p.Y) != -1 && TryGetTreeIdForTile(pathsLayer.Tiles[p.X, p.Y], out id, out growthStageOnLoad, out growthStageOnRegrow, out isFruitTree))
							{
		...
		public void loadPathsLayerObjectsInArea(int startingX, int startingY, int width, int height)
		{
			...
			for (int x = startingX; x < startingX + width; x++)
			{
				for (int y = startingY; y < startingY + height; y++)
				{
					...
					int? growthStageOnRegrow;
					bool isFruitTree;
					if (TryGetTreeIdForTile(t, out treeId, out growthStageOnLoad, out growthStageOnRegrow, out isFruitTree))
					{
		...
		public bool TryGetTreeIdForTile(Tile tile, out string treeId, out int? growthStageOnLoad, out int? growthStageOnRegrow, out bool isFruitTree)
		{
			...
			case 34:
			{
				...
				if (!tile.Properties.TryGetValue("SpawnTree", out property))
				{
					...
					defaultInterpolatedStringHandler.AppendFormatted(tile);
				...
				if (!ArgUtility.TryGet(args, 0, out rawType, out error) || !ArgUtility.TryGet(args, 1, out rawId, out error) || !ArgUtility.TryGetOptionalInt(args, 2, out rawGrowthStageOnLoad, out error, -1) || !ArgUtility.TryGetOptionalInt(args, 3, out rawGrowthStageOnRegrow, out error, -1))
				{
					IGameLogger log2 = Game1.log;
					defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(107, 4);
					defaultInterpolatedStringHandler.AppendLiteral("Location '");
					defaultInterpolatedStringHandler.AppendFormatted(NameOrUniqueName);
					defaultInterpolatedStringHandler.AppendLiteral("' ignored path tile index 34 (spawn tree) at position ");
					defaultInterpolatedStringHandler.AppendFormatted(tile);
				...
				defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(143, 4);
				defaultInterpolatedStringHandler.AppendLiteral("Location '");
				defaultInterpolatedStringHandler.AppendFormatted(NameOrUniqueName);
				defaultInterpolatedStringHandler.AppendLiteral("' ignored path tile index 34 (spawn tree) at position ");
				defaultInterpolatedStringHandler.AppendFormatted(tile);
		...
		public void BuildStartingCabins()
		{
			if (_startingCabinLocations.Count > 0)
			{
				...
				{
					for (int k = 0; k < _startingCabinLocations.Count; k++)
					{
						if (doesTileHavePropertyNoNull((int)_startingCabinLocations[k].X, (int)_startingCabinLocations[k].Y, "Order", "Paths").Equals((j + 1).ToString() ?? ""))
						{
							startingCabinsInOrder.Add(_startingCabinLocations[k]);
						}
					}
				}
				for (int i = 0; i < startingCabinsInOrder.Count; i++)
				{
					...
					b.load();
					buildStructure(b, startingCabinsInOrder[i], Game1.player, true);
		...
		public bool isTerrainFeatureAt(int x, int y)
		{
			Vector2 v = new Vector2(x, y);
			TerrainFeature terrainFeature;
			if (terrainFeatures.TryGetValue(v, out terrainFeature) && !terrainFeature.isPassable())
			{
				return true;
			}
			if (largeTerrainFeatures != null)
		...
		private void changeMapProperties(string propertyName, string toAdd)
		{
			...
			{
				string oldValue;
				if (!map.Properties.TryGetValue(propertyName, out oldValue))
				{
