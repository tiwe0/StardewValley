	...
	public class Raccoon : NPC
	{
		...
		private void addNextIngredient(List<BundleIngredientDescription> ingredients, int whichBundle, Random r)
		{
			...
			case 4:
			{
				...
				{
					string fruit3 = "";
					while (fruit3 == "" || fruit3.Split("_")[0] == ingredients[0].id)
					{
						fruit3 = r.ChooseFrom(items);
					}
					ingredients.Add(new BundleIngredientDescription(fruit3.Split('_')[0], Convert.ToInt32(fruit3.Split('_')[1]), 0, Game1.netWorldState.Value.raccoonBundles[1]));
					break;
				}
				}
				break;
		...
		public override void update(GameTime time, GameLocation location)
		{
			...
			{
				switch (getGeneralDirectionTowards(Game1.player.getStandingPosition(), 32, false, false))
				{
				case 0:
