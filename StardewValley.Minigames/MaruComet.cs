...
namespace StardewValley.Minigames
{
	public class MaruComet : IMinigame
	{
		...
		public void draw(SpriteBatch b)
		{
			...
			SpriteText.drawStringHorizontallyCenteredAt(b, currentString, (int)centerOfScreen.X, (int)text_draw_y, currentStringCharacter, -1, 99999, 1f, 0.99f, false, SpriteText.color_Purple, Game1.game1.localMultiplayerWindow.Width);
