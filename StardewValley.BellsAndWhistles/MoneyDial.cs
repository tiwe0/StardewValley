			...
			if (currentValue != target)
			{
				...
				if (soundTimer <= 0)
				{
					...
					if (Game1.random.NextDouble() < 0.4)
					{
						...
						{
							TemporaryAnimatedSprite sprite = TemporaryAnimatedSprite.GetTemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(356, 449, 1, 1), 999999f, 1, 44, position + new Vector2(Game1.random.Next(160), Game1.random.Next(-32, 32)), false, false, 1f, 0.01f, Color.White, Game1.random.Next(1, 3) * 4, -0.001f, 0f, 0f);
