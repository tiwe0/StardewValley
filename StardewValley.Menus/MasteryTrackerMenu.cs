...
namespace StardewValley.Menus
{
	public class MasteryTrackerMenu : IClickableMenu
	{
			...
			: base((int)Utility.getTopLeftPositionForCenteringOnScreen(800, 320).X, (int)Utility.getTopLeftPositionForCenteringOnScreen(800, 320).Y, 800, 320, true)
		{
			...
			{
			case 0:
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, Game1.content.Load<Texture2D>("TileSheets\\weapons"), new Rectangle(32, 128, 16, 16), 4f, true)
				{
				...
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, Game1.bigCraftableSpriteSheet, new Rectangle(32, 1152, 16, 32), 4f, true)
				{
				...
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, Game1.mouseCursors_1_6, new Rectangle(103, 90, 17, 16), 4f, true)
				{
					name = "",
				...
				break;
			case 3:
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, Game1.bigCraftableSpriteSheet, new Rectangle(64, 1152, 16, 32), 4f, true)
				{
				...
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, Game1.bigCraftableSpriteSheet, new Rectangle(0, 1152, 16, 32), 4f, true)
				{
				...
				break;
			case 1:
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, Game1.toolSpriteSheet, new Rectangle(272, 0, 16, 16), 4f, true)
				{
				...
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, objects2Tex, new Rectangle(0, 144, 16, 16), 4f, true)
				{
				...
				break;
			case 2:
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, objects2Tex, new Rectangle(80, 112, 16, 16), 4f, true)
				{
				...
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, objects2Tex, new Rectangle(112, 128, 16, 16), 4f, true)
				{
			...
			case 4:
				...
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, Game1.bigCraftableSpriteSheet, new Rectangle(80, 1152, 16, 32), 4f, true)
				{
				...
				rewards.Add(new ClickableTextureComponent(Rectangle.Empty, Game1.bigCraftableSpriteSheet, new Rectangle(96, 1152, 16, 32), 4f, true)
				{
		...
		{
			Game1.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(536, 1945, 8, 8), new Vector2(x, y) * 4f + new Vector2(-3f, -6f) * 4f, false, 0f, Color.White)
			{
		...
		public override void draw(SpriteBatch b)
		{
			...
			if (which == -1)
			{
				SpriteText.drawStringHorizontallyCenteredAt(b, Game1.content.LoadString("Strings\\1_6_Strings:FinalPath"), xPositionOnScreen + width / 2, yPositionOnScreen + 48, 9999, -1, 9999, 1f, 0.88f, false, Color.Black);
			...
			{
				SpriteText.drawStringHorizontallyCenteredAt(b, Game1.content.LoadString("Strings\\1_6_Strings:" + which + "_Mastery"), xPositionOnScreen + width / 2, yPositionOnScreen + 48, 9999, -1, 9999, 1f, 0.88f, false, Color.Black);
