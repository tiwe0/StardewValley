	...
	public class FishPond : Building
	{
		...
		public override bool doAction(Vector2 tileLocation, Farmer who)
		{
			if ((int)daysOfConstructionLeft <= 0 && occupiesTile(tileLocation))
			{
				...
				if (who.ActiveObject != null && performActiveObjectDropInAction(who, false))
				{
					return true;
				}
		...
		private void showObjectThrownIntoPondAnimation(Farmer who, Object whichObject, Action callback = null)
		{
			...
			if (who.FacingDirection == 1 || who.FacingDirection == 3)
			{
				...
				fishTossSprites.Add(new TemporaryAnimatedSprite(itemData.GetTextureName(), itemData.GetSourceRect(), who.Position + new Vector2(0f, -64f), false, 0f, Color.White)
				{
					scale = 4f,
					layerDepth = 1f,
				...
				fishTossSprites.Add(new TemporaryAnimatedSprite(28, 100f, 2, 1, GetCenterTile() * 64f, false, false)
				{
					delayBeforeAnimationStart = (int)t,
					layerDepth = (((float)(int)tileY + 0.5f) * 64f + 2f) / 10000f
				});
				fishTossSprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64, 64), 55f, 8, 0, GetCenterTile() * 64f, false, Game1.random.NextBool(), (((float)(int)tileY + 0.5f) * 64f + 1f) / 10000f, 0.01f, Color.White, 0.75f, 0.003f, 0f, 0f)
				{
					delayBeforeAnimationStart = (int)t
				});
				fishTossSprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64, 64), 65f, 8, 0, GetCenterTile() * 64f + new Vector2(Game1.random.Next(-32, 32), Game1.random.Next(-16, 32)), false, Game1.random.NextBool(), (((float)(int)tileY + 0.5f) * 64f + 1f) / 10000f, 0.01f, Color.White, 0.75f, 0.003f, 0f, 0f)
				{
					delayBeforeAnimationStart = (int)t
				});
				fishTossSprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64, 64), 75f, 8, 0, GetCenterTile() * 64f + new Vector2(Game1.random.Next(-32, 32), Game1.random.Next(-16, 32)), false, Game1.random.NextBool(), (((float)(int)tileY + 0.5f) * 64f + 1f) / 10000f, 0.01f, Color.White, 0.75f, 0.003f, 0f, 0f)
				{
					delayBeforeAnimationStart = (int)t
				});
			...
			fishTossSprites2.Add(new TemporaryAnimatedSprite(itemData2.GetTextureName(), itemData2.GetSourceRect(), who.Position + new Vector2(0f, -64f), false, 0f, Color.White)
			{
				scale = 4f,
				layerDepth = 1f,
				totalNumberOfLoops = 1,
			...
			fishTossSprites2.Add(new TemporaryAnimatedSprite(28, 100f, 2, 1, GetCenterTile() * 64f, false, false)
			{
				delayBeforeAnimationStart = (int)t2,
				layerDepth = (((float)(int)tileY + 0.5f) * 64f + 2f) / 10000f
			});
			fishTossSprites2.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64, 64), 55f, 8, 0, GetCenterTile() * 64f, false, Game1.random.NextBool(), (((float)(int)tileY + 0.5f) * 64f + 1f) / 10000f, 0.01f, Color.White, 0.75f, 0.003f, 0f, 0f)
			{
				delayBeforeAnimationStart = (int)t2
			});
			fishTossSprites2.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64, 64), 65f, 8, 0, GetCenterTile() * 64f + new Vector2(Game1.random.Next(-32, 32), Game1.random.Next(-16, 32)), false, Game1.random.NextBool(), (((float)(int)tileY + 0.5f) * 64f + 1f) / 10000f, 0.01f, Color.White, 0.75f, 0.003f, 0f, 0f)
			{
				delayBeforeAnimationStart = (int)t2
			});
			fishTossSprites2.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64, 64), 75f, 8, 0, GetCenterTile() * 64f + new Vector2(Game1.random.Next(-32, 32), Game1.random.Next(-16, 32)), false, Game1.random.NextBool(), (((float)(int)tileY + 0.5f) * 64f + 1f) / 10000f, 0.01f, Color.White, 0.75f, 0.003f, 0f, 0f)
			{
				delayBeforeAnimationStart = (int)t2
			});
			if (who.IsLocalPlayer)
		...
		public override void dayUpdate(int dayOfMonth)
		{
			...
			if ((int)currentOccupants > 0 && data != null)
			{
				...
				if (daysSinceSpawn.Value >= data.SpawnTime)
				{
					string itemId;
					int count;
					if (TryGetNeededItemData(out itemId, out count))
					{
		...
		public bool HasUnresolvedNeeds()
		{
			string itemId;
			int count;
			if (neededItem.Value != null && TryGetNeededItemData(out itemId, out count))
			{
		...
		private bool TryGetNeededItemData(out string itemId, out int count)
		{
			...
			if (_fishPondData?.PopulationGates != null)
			{
				...
				List<string> gate;
				if (_fishPondData.PopulationGates.TryGetValue(maxOccupants.Value + 1, out gate))
				{
		...
		public void ClearPond()
		{
			...
			for (int i = 0; i < (int)currentOccupants; i++)
			{
				...
				Game1.createItemDebris(CreateFishInstance(), pos, direction, Game1.currentLocation, -1, true);
			}
			_hasAnimatedSpawnedFish = false;
			hasSpawnedFish.Value = false;
			_fishSilhouettes.Clear();
		...
		public override void draw(SpriteBatch b)
		{
			...
			if (output.Value != null)
			{
				...
				ColoredObject coloredObj = output.Value as ColoredObject;
				if (coloredObj != null)
				{
