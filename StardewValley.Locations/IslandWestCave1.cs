	...
	public class IslandWestCave1 : IslandLocation
	{
		...
		public override bool performAction(string[] action, Farmer who, Location tileLocation)
		{
			if (who.IsLocalPlayer)
			{
				...
				if (!(text == "Crystal"))
				{
					if (text == "CrystalCaveActivate" && !isActivated && !completed.Value)
					{
				...
				else
				{
					int crystalId;
					string error;
					if (!ArgUtility.TryGetInt(action, 1, out crystalId, out error))
					{
		...
		public void addCompletionTorches()
		{
			if (completed.Value)
			{
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(276, 1985, 12, 11), new Vector2(5f, 1f) * 64f + new Vector2(0f, -20f), false, 0f, Color.White)
				{
					interval = 50f,
				...
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(276, 1985, 12, 11), new Vector2(7f, 1f) * 64f + new Vector2(8f, -20f), false, 0f, Color.White)
				{
					interval = 50f,
					totalNumberOfLoops = 99999,
					animationLength = 4,
