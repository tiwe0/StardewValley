	...
	public class AbigailGame : IMinigame
	{
		...
		public class CowboyMonster
		{
			...
			public virtual bool move(Vector2 playerPosition, GameTime time)
			{
				...
				case 6:
				{
					...
					Point targetPosition2 = targetPosition;
					...
					if (type == 6 && !invisible)
					{
						temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(352, 1728, 16, 16), 60f, 3, 0, new Vector2(position.X, position.Y) + topLeftScreenCoordinate, false, false, (float)position.Y / 10000f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
						{
				...
				case 4:
				{
					...
					Point targetPosition3 = targetPosition;
					Vector2 target = ((!targetPosition.Equals(Point.Zero)) ? new Vector2(targetPosition.X, targetPosition.Y) : playerPosition);
		...
		public class Dracula : CowboyMonster
		{
			...
			public void summonEnemies(Point origin, int which)
			{
				...
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 80f, 5, 0, topLeftScreenCoordinate + new Vector2(origin.X - TileSize - TileSize / 2, origin.Y), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
				{
				...
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 80f, 5, 0, topLeftScreenCoordinate + new Vector2(origin.X, origin.Y - TileSize - TileSize * 3 / 4), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
				{
					delayBeforeAnimationStart = Game1.random.Next(800)
				});
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 80f, 5, 0, topLeftScreenCoordinate + new Vector2(origin.X, origin.Y + TileSize + TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
				{
					delayBeforeAnimationStart = Game1.random.Next(800)
				});
				Game1.playSound("Cowboy_monsterDie");
		...
		public void reset(bool playingWithAbby)
		{
			...
			for (int j = 0; j < 16; j++)
			{
				for (int k = 0; k < 16; k++)
				{
					...
					{
						map[j, k] = ((Game1.random.NextDouble() < 0.15) ? 1 : 0);
					}
					...
					{
						map[j, k] = ((Game1.random.NextDouble() < 0.1) ? 4 : 3);
					}
				}
			}
		...
		public void usePowerup(int which)
		{
			...
			case 9:
			{
				...
				if (tries < 10)
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 120f, 5, 0, playerPosition + topLeftScreenCoordinate + new Vector2(TileSize / 2, TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true));
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 120f, 5, 0, new Vector2(teleportSpot.X, teleportSpot.Y) + topLeftScreenCoordinate + new Vector2(TileSize / 2, TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true));
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 120f, 5, 0, new Vector2(teleportSpot.X - TileSize / 2, teleportSpot.Y) + topLeftScreenCoordinate + new Vector2(TileSize / 2, TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
					{
					...
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 120f, 5, 0, new Vector2(teleportSpot.X, teleportSpot.Y - TileSize / 2) + topLeftScreenCoordinate + new Vector2(TileSize / 2, TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
					{
			...
			case 4:
			{
				...
				for (int j = 0; j < 30; j++)
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 80f, 5, 0, new Vector2(Game1.random.Next(1, 16), Game1.random.Next(1, 16)) * TileSize + topLeftScreenCoordinate + new Vector2(TileSize / 2, TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
					{
						delayBeforeAnimationStart = Game1.random.Next(800)
					});
				}
		...
		public static void addGuts(Point position, int whichGuts)
		{
			...
			case 6:
			case 7:
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(512, 1696, 16, 16), 80f, 6, 0, topLeftScreenCoordinate + new Vector2(position.X, position.Y), false, Game1.random.NextBool(), 0.001f, 0f, Color.White, 3f, 0f, 0f, 0f, true));
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(592, 1696, 16, 16), 10000f, 1, 0, topLeftScreenCoordinate + new Vector2(position.X, position.Y), false, Game1.random.NextBool(), 0.001f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
				{
					delayBeforeAnimationStart = 480
				});
				break;
			case 3:
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 80f, 5, 0, topLeftScreenCoordinate + new Vector2(position.X, position.Y), false, Game1.random.NextBool(), 0.001f, 0f, Color.White, 3f, 0f, 0f, 0f, true));
				break;
			case 1:
			case 4:
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(544, 1728, 16, 16), 80f, 4, 0, topLeftScreenCoordinate + new Vector2(position.X, position.Y), false, Game1.random.NextBool(), 0.001f, 0f, Color.White, 3f, 0f, 0f, 0f, true));
				break;
			}
		}
		...
		{
			temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(384, 1792, 16, 16), 120f, 4, 2, topLeftScreenCoordinate + new Vector2(gopherBox.X + TileSize / 2, gopherBox.Y + TileSize / 2), false, false, (float)gopherBox.Y / 10000f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
			{
		...
		public void updateBullets(GameTime time)
		{
			...
			{
				bullets[j].position.X += bullets[j].motion.X;
				bullets[j].position.Y += bullets[j].motion.Y;
				if (bullets[j].position.X <= 0 || bullets[j].position.Y <= 0 || bullets[j].position.X >= 768 || bullets[j].position.Y >= 768)
				{
					bullets.RemoveAt(j);
				}
				else if (map[bullets[j].position.X / 16 / 3, bullets[j].position.Y / 16 / 3] == 7)
				{
					bullets.RemoveAt(j);
				}
				else
				{
					...
					{
						if (monsters[m].position.Intersects(new Rectangle(bullets[j].position.X, bullets[j].position.Y, 12, 12)))
						{
							int monsterhealth = monsters[m].health;
							int monsterAfterDamageHealth;
							if (monsters[m].takeDamage(bullets[j].damage))
							{
								monsterAfterDamageHealth = monsters[m].health;
								addGuts(monsters[m].position.Location, monsters[m].type);
								int loot = monsters[m].getLootDrop();
								...
								{
									powerups.Add(new CowboyPowerup(loot, monsters[m].position.Location, lootDuration));
								}
								if (shootoutLevel)
								{
									if (whichWave == 12 && monsters[m].type == -2)
									{
										Game1.playSound("cowboy_explosion");
										...
										for (int l = 0; l < 30; l++)
										{
											temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(512, 1696, 16, 16), 70f, 6, 0, new Vector2(monsters[m].position.X + Game1.random.Next(-TileSize, TileSize), monsters[m].position.Y + Game1.random.Next(-TileSize, TileSize)) + topLeftScreenCoordinate + new Vector2(TileSize / 2, TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
											{
												delayBeforeAnimationStart = l * 75
											});
											if (l % 4 == 0)
											{
												addGuts(new Point(monsters[m].position.X + Game1.random.Next(-TileSize, TileSize), monsters[m].position.Y + Game1.random.Next(-TileSize, TileSize)), 7);
											}
											if (l % 4 == 0)
											{
												temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1792, 16, 16), 80f, 5, 0, new Vector2(monsters[m].position.X + Game1.random.Next(-TileSize, TileSize), monsters[m].position.Y + Game1.random.Next(-TileSize, TileSize)) + topLeftScreenCoordinate + new Vector2(TileSize / 2, TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
												{
													delayBeforeAnimationStart = l * 75
												});
											}
											if (l % 3 == 0)
											{
												temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(544, 1728, 16, 16), 100f, 4, 0, new Vector2(monsters[m].position.X + Game1.random.Next(-TileSize, TileSize), monsters[m].position.Y + Game1.random.Next(-TileSize, TileSize)) + topLeftScreenCoordinate + new Vector2(TileSize / 2, TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
												{
													delayBeforeAnimationStart = l * 75
												});
											}
							...
							bullets[j].damage -= monsterhealth - monsterAfterDamageHealth;
		...
		public void playerDie()
		{
			...
			temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1808, 16, 16), 120f, 5, 0, playerPosition + topLeftScreenCoordinate, false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true));
			...
			if (lives < 0)
			{
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1808, 16, 16), 550f, 5, 0, playerPosition + topLeftScreenCoordinate, false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
				{
					alpha = 0.001f,
		...
		{
			List<Keys> binds;
			if (_binds.TryGetValue(game_key, out binds))
			{
		...
		public bool tick(GameTime time)
		{
			...
			if (motionPause <= 0)
			{
				...
				for (int i3 = activePowerups.Count - 1; i3 >= 0; i3--)
				{
					int key = activePowerups.ElementAt(i3).Key;
				...
				if (deathTimer <= 0f && playerMovementDirections.Count > 0 && !scrollingMap)
				{
					...
					for (int i8 = powerups.Count - 1; i8 >= 0; i8--)
					{
						if (playerBoundingBox.Intersects(new Rectangle(powerups[i8].position.X, powerups[i8].position.Y, TileSize, TileSize)) && !playerBoundingBox.Intersects(noPickUpBox))
						{
							if (heldItem != null)
							{
								usePowerup(powerups[i8].which);
								powerups.RemoveAt(i8);
							}
							else if (getPowerUp(powerups[i8]))
							{
								powerups.RemoveAt(i8);
							}
						}
				...
				if (shopping)
				{
					...
					{
						for (int i7 = storeItems.Count - 1; i7 >= 0; i7--)
						{
							KeyValuePair<Rectangle, int> pair = storeItems.ElementAt(i7);
				...
				if (deathTimer <= 0f && playerShootingDirections.Count > 0 && shotTimer <= 0)
				{
					...
					for (int i4 = 0; i4 < fireSpeedLevel; i4++)
					{
				...
				else if (deathTimer <= 0f && !waitingForPlayerToMoveDownAMap && !shopping && !shootoutLevel)
				{
					if (waveTimer > 0)
					{
						...
						if (!hasGopherAppeared && monsters.Count > 6 && Game1.random.NextDouble() < 0.0004 && waveTimer > 7000 && waveTimer < 50000)
						{
							...
							if (tries2 < 10)
							{
								temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(256, 1664, 16, 32), 80f, 5, 0, topLeftScreenCoordinate + new Vector2(gopherBox.X + TileSize / 2, gopherBox.Y - TileSize + TileSize / 2), false, false, (float)gopherBox.Y / 10000f, 0f, Color.White, 3f, 0f, 0f, 0f, true)
								{
					...
					for (int p = 0; p < 4; p++)
					{
						...
						case 0:
						{
							for (int x = 7; x < 10; x++)
							{
								...
								{
									CowboyMonster monster2 = new CowboyMonster(spawnQueue[p][0].X, new Point(x * TileSize, 0));
									if (whichRound > 0)
									{
										monster2.health += whichRound * 2;
									}
						...
						case 1:
						{
							for (int y = 7; y < 10; y++)
							{
								...
								{
									CowboyMonster monster3 = new CowboyMonster(spawnQueue[p][0].X, new Point(15 * TileSize, y * TileSize));
									if (whichRound > 0)
									{
										monster3.health += whichRound * 2;
									}
						...
						case 2:
						{
							...
							{
								if (Game1.random.NextBool() && !isCollidingWithMonster(new Rectangle(x2 * 16 * 3, 15 * TileSize, 48, 48), null))
								{
									CowboyMonster monster4 = new CowboyMonster(spawnQueue[p][0].X, new Point(x2 * TileSize, 15 * TileSize));
									if (whichRound > 0)
									{
										monster4.health += whichRound * 2;
									}
						...
						case 3:
						{
							...
							{
								if (Game1.random.NextBool() && !isCollidingWithMonster(new Rectangle(0, y2 * TileSize, 48, 48), null))
								{
									CowboyMonster monster5 = new CowboyMonster(spawnQueue[p][0].X, new Point(0, y2 * TileSize));
									if (whichRound > 0)
									{
										monster5.health += whichRound * 2;
									}
					...
					if (waveTimer <= 0 && monsters.Count > 0 && isSpawnQueueEmpty())
					{
						...
						foreach (CowboyMonster monster6 in monsters)
						{
							if (monster6.type != 6)
							{
								onlySpikeys = false;
						...
						if (onlySpikeys)
						{
							foreach (CowboyMonster monster7 in monsters)
							{
								monster7.health = 1;
							}
						}
					...
					if (waveTimer <= 0 && monsters.Count == 0 && isSpawnQueueEmpty())
					{
						...
						if (whichRound > 0)
						{
							...
							{
								Vector2 vector = monsterChances[j];
				...
				for (int i = monsters.Count - 1; i >= 0; i--)
				{
					...
					if (playingWithAbigail && i < monsters.Count && monsters[i].position.Intersects(player2BoundingBox) && player2invincibletimer <= 0)
					{
						...
						temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(464, 1808, 16, 16), 120f, 5, 0, player2Position + topLeftScreenCoordinate + new Vector2(TileSize / 2, TileSize / 2), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, 0f, true));
		...
		public int[,] getMap(int wave)
		{
			...
			for (int i5 = 0; i5 < 16; i5++)
			{
				...
				{
					if ((i5 == 0 || i5 == 15 || j2 == 0 || j2 == 15) && (i5 <= 6 || i5 >= 10) && (j2 <= 6 || j2 >= 10))
					{
						newMap[i5, j2] = 5;
					}
					else if (i5 == 0 || i5 == 15 || j2 == 0 || j2 == 15)
					{
						newMap[i5, j2] = ((Game1.random.NextDouble() < 0.15) ? 1 : 0);
					}
					else if (i5 == 1 || i5 == 14 || j2 == 1 || j2 == 14)
					{
						newMap[i5, j2] = 2;
					}
					else
					{
						newMap[i5, j2] = ((Game1.random.NextDouble() < 0.1) ? 4 : 3);
					}
				}
			}
			switch (wave)
			...
			case -1:
			{
				for (int j = 0; j < 16; j++)
				{
					...
					{
						if (newMap[j, j3] == 0 || newMap[j, j3] == 1 || newMap[j, j3] == 2 || newMap[j, j3] == 5)
						{
							newMap[j, j3] = 3;
						}
					}
			...
			case 8:
			{
				for (int l = 0; l < 16; l++)
				{
					for (int j4 = 0; j4 < 16; j4++)
					{
						if (newMap[l, j4] == 5)
						{
							newMap[l, j4] = Game1.random.Choose(0, 1);
						}
					}
				}
				for (int k = 0; k < 16; k++)
				{
					newMap[k, 8] = Game1.random.Choose(8, 9);
				}
				newMap[8, 4] = 7;
				newMap[8, 12] = 7;
				newMap[9, 12] = 7;
			...
			case 7:
			{
				for (int m = 0; m < 16; m++)
				{
					newMap[m, 5] = ((m % 2 == 0) ? 9 : 8);
					newMap[m, 10] = ((m % 2 == 0) ? 9 : 8);
				}
				newMap[4, 5] = 10;
				newMap[8, 5] = 10;
				newMap[12, 5] = 10;
			...
			case 10:
			{
				for (int n = 0; n < 16; n++)
				{
					newMap[n, 1] = ((n % 2 == 0) ? 9 : 8);
					newMap[n, 14] = ((n % 2 == 0) ? 9 : 8);
				}
				newMap[8, 1] = 10;
				newMap[7, 1] = 10;
				newMap[9, 1] = 10;
			...
			case 12:
			{
				for (int i4 = 0; i4 < 16; i4++)
				{
					...
					{
						if (newMap[i4, j5] == 0 || newMap[i4, j5] == 1)
						{
							newMap[i4, j5] = 5;
						}
					}
				...
				{
					newMap[i3, 0] = ((i3 % 2 == 0) ? 9 : 8);
					newMap[i3, 15] = ((i3 % 2 == 0) ? 9 : 8);
				}
		...
		public void spawnBullets(IList<int> directions, Vector2 spawn)
		{
			...
			else if (directions.Contains(0) && directions.Contains(3))
			{
				...
				{
					int modifier3 = -2;
					bullets.Add(new CowboyBullet(bulletSpawn, new Point(-speed - modifier3, -speed + modifier3), bulletDamage));
					modifier3 = 2;
					bullets.Add(new CowboyBullet(bulletSpawn, new Point(-speed - modifier3, -speed + modifier3), bulletDamage));
				}
			}
		...
		private void addPlayerMovementDirection(int direction)
		{
			if (!gopherTrain && !playerMovementDirections.Contains(direction))
			{
				...
				{
					int num = (playerMovementDirections.ElementAt(0) + 2) % 4;
				}
		...
		public void draw(SpriteBatch b)
		{
			...
			else if (endCutscene)
			{
				...
				case 3:
				{
					for (int j = 0; j < 16; j++)
					{
						for (int n = 0; n < 16; n++)
						{
							b.Draw(Game1.mouseCursors, topLeftScreenCoordinate + new Vector2(j, n) * 16f * 3f + new Vector2(0f, newMapPosition - 16 * TileSize), new Rectangle(464 + 16 * map[j, n] + ((map[j, n] == 5 && cactusDanceTimer > 800f) ? 16 : 0), 1680 - world * 16, 16, 16), Color.White, 0f, Vector2.Zero, 3f, SpriteEffects.None, 0f);
						}
					}
			...
			else
			{
				...
				for (int k = 0; k < 16; k++)
				{
					for (int m = 0; m < 16; m++)
					{
						b.Draw(Game1.mouseCursors, topLeftScreenCoordinate + new Vector2(k, m) * 16f * 3f + new Vector2(0f, newMapPosition - 16 * TileSize), new Rectangle(464 + 16 * map[k, m] + ((map[k, m] == 5 && cactusDanceTimer > 800f) ? 16 : 0), 1680 - world * 16, 16, 16), Color.White, 0f, Vector2.Zero, 3f, SpriteEffects.None, 0f);
					}
				}
				if (scrollingMap)
				{
					for (int l = 0; l < 16; l++)
					{
						for (int j2 = 0; j2 < 16; j2++)
						{
							b.Draw(Game1.mouseCursors, topLeftScreenCoordinate + new Vector2(l, j2) * 16f * 3f + new Vector2(0f, newMapPosition), new Rectangle(464 + 16 * nextMap[l, j2] + ((nextMap[l, j2] == 5 && cactusDanceTimer > 800f) ? 16 : 0), 1680 - world * 16, 16, 16), Color.White, 0f, Vector2.Zero, 3f, SpriteEffects.None, 0f);
						}
					}
			...
			if (abigailPortraitTimer > 0)
			{
				...
				if (abigailPortraitTimer < 5500 && abigailPortraitTimer > 500)
				{
					...
					SpriteText.drawString(b, AbigailDialogue, x, (int)((double)abigailPortraitYposition - 80.0), 999999, width, 999999, 1f, 0.88f, false, -1, "", SpriteText.color_Purple);
				}
			}
			b.End();
