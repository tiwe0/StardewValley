	...
	public class MiniJukebox : Object
	{
		...
		public override bool checkForAction(Farmer who, bool justCheckingForActivity = false)
		{
			...
			else
			{
				...
				Game1.activeClickableMenu = new ChooseFromListMenu(jukeboxTracks, OnSongChosen, true, location.miniJukeboxTrack.Value);
			}
			return true;
		}
		...
		public override void updateWhenCurrentLocation(GameTime time)
		{
			...
			if (environment != null && environment.IsMiniJukeboxPlaying())
			{
				...
				if (showNote)
				{
					...
					for (int i = 0; i < 4; i++)
					{
						environment.temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(516, 1916, 7, 10), 9999f, 1, 1, tileLocation.Value * 64f + new Vector2(Game1.random.Next(48), -80f), false, false, (tileLocation.Value.Y + 1f) * 64f / 10000f, 0.01f, Color.White, 4f, 0f, 0f, 0f)
						{
							xPeriodic = true,
