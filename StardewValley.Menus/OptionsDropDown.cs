...
namespace StardewValley.Menus
{
	public class OptionsDropDown : OptionsElement
	{
		...
		public override void draw(SpriteBatch b, int slotX, int slotY, IClickableMenu context = null)
		{
			...
			if (clicked)
			{
				IClickableMenu.drawTextureBox(b, Game1.mouseCursors, dropDownBGSource, slotX + dropDownBounds.X, slotY + dropDownBounds.Y, dropDownBounds.Width, dropDownBounds.Height, Color.White * alpha, 4f, false, 0.97f);
			...
			{
				IClickableMenu.drawTextureBox(b, Game1.mouseCursors, dropDownBGSource, slotX + bounds.X, slotY + bounds.Y, bounds.Width - 48, bounds.Height, Color.White * alpha, 4f, false);
