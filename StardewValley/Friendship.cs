...
namespace StardewValley
{
	public class Friendship : INetObject<NetFields>
	{
		...
		public Friendship()
		{
			NetFields.SetOwner(this).AddField(points, "points").AddField(giftsThisWeek, "giftsThisWeek")
				.AddField(giftsToday, "giftsToday")
				.AddField(lastGiftDate, "lastGiftDate")
				.AddField(talkedToToday, "talkedToToday")
				.AddField(proposalRejected, "proposalRejected")
				.AddField(weddingDate, "weddingDate")
				.AddField(nextBirthingDate, "nextBirthingDate")
				.AddField(status, "status")
				.AddField(proposer, "proposer")
				.AddField(roommateMarriage, "roommateMarriage");
		}
