...
namespace StardewValley.ItemTypeDefinitions
{
	...
	public class FurnitureDataDefinition : BaseItemDataDefinition
	{
		...
		public override ParsedItemData GetData(string itemId)
		{
			...
			return new ParsedItemData(this, itemId, GetSpriteIndex(itemId, fields), ArgUtility.Get(fields, 9, "TileSheets\\furniture", false), ArgUtility.Get(fields, 0), TokenParser.ParseText(ArgUtility.Get(fields, 7)), null, -24, null, fields, false, ArgUtility.GetBool(fields, 10));
		}
		...
		{
			string raw;
			if (itemId == null || !GetDataSheet().TryGetValue(itemId, out raw))
			{
				return null;
			}
			return raw.Split('/');
