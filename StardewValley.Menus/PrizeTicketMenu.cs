	...
	public class PrizeTicketMenu : IClickableMenu
	{
		...
		public static Item getPrizeItem(int prizeLevel)
		{
			...
			default:
			{
				...
				case 0:
					return ItemRegistry.Create("(O)MysteryBox", 5);
				case 1:
					return ItemRegistry.Create("(O)872", r2.Next(1, 3));
				case 2:
					return ItemRegistry.Create(r2.Choose<string>("(O)337", "(O)226", "(O)253", "(O)732", "(O)275"), 5);
				case 3:
					return ItemRegistry.Create(r2.Choose("(F)FancyHousePlant1", "(F)FancyHousePlant2", "(F)FancyHousePlant3"));
				case 4:
					return ItemRegistry.Create("(O)StardropTea");
				case 5:
				...
				case 7:
					return ItemRegistry.Create(r2.Choose("(F)FancyTree1", "(F)FancyTree2", "(F)FancyTree3", "(F)PigPainting"));
				case 8:
					return r2.Choose(ItemRegistry.Create("(O)287", 15), ItemRegistry.Create("(O)288", 8));
				default:
		...
		public override void draw(SpriteBatch b)
		{
			...
			if (gettingReward)
			{
				...
				currentPrizeTrack[0].drawInMenu(b, base.Position + posOffset2, 1f, 1f, 0.9f, StackDrawType.Draw, Color.White, false);
			}
