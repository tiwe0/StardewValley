	...
	public static class Program
	{
		...
		public static string WriteLog(LogType logType, string message, bool append = false)
		{
			...
			if (logType == LogType.Disconnect)
			{
				...
				defaultInterpolatedStringHandler.AppendFormatted(DateTime.Now.Month);
				defaultInterpolatedStringHandler.AppendLiteral("-");
				defaultInterpolatedStringHandler.AppendFormatted(DateTime.Now.Day);
				defaultInterpolatedStringHandler.AppendLiteral(".txt");
				filename = text + defaultInterpolatedStringHandler.ToStringAndClear();
			}
			else
			{
				...
				DefaultInterpolatedStringHandler defaultInterpolatedStringHandler = new DefaultInterpolatedStringHandler(6, 2);
				defaultInterpolatedStringHandler.AppendLiteral("_");
				defaultInterpolatedStringHandler.AppendFormatted(Game1.uniqueIDForThisGame);
				defaultInterpolatedStringHandler.AppendLiteral("_");
				defaultInterpolatedStringHandler.AppendFormatted((Game1.player == null) ? ((ulong)Game1.random.Next(999999)) : Game1.player.millisecondsPlayed);
				defaultInterpolatedStringHandler.AppendLiteral(".txt");
				filename = text2 + defaultInterpolatedStringHandler.ToStringAndClear();
			}
