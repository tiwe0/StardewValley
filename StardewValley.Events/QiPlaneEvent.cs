	...
	public class QiPlaneEvent : BaseFarmEvent
	{
		...
		public override void draw(SpriteBatch b)
		{
			...
			if (qiPlanePos.X > (float)(Game1.graphics.GraphicsDevice.Viewport.Width - 480))
			{
				...
				SpriteText.drawStringHorizontallyCenteredAt(b, str, Game1.graphics.GraphicsDevice.Viewport.Width / 2, Game1.graphics.GraphicsDevice.Viewport.Height / 2 - 50, (int)(textTimer / 100f), -1, 999999, 1f, 0.9f, false, Color.White);
			}
		...
		public override bool tickUpdate(GameTime time)
		{
			...
			{
				tempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors_1_6", new Rectangle(112, 166, 14, 35), 50f, 10, 1, qiPlanePos + new Vector2(52f, -4f) * 4f, false, false)
				{
					holdLastFrame = true,
