...
namespace StardewValley
{
	public class InteriorDoor : NetField<bool, InteriorDoor>
	{
		...
		public void ResetLocalState()
		{
			...
			string doorAction;
			if (Tile.Properties.TryGetValue("Action", out doorAction) && doorAction.Contains("Door"))
			{
			...
			Sprite = new TemporaryAnimatedSprite("LooseSprites\\Cursors", sourceRect, 100f, 4, 1, new Vector2(x, y - 2) * 64f, false, flip, (float)((y + 1) * 64 - 12) / 10000f, 0f, Color.White, 4f, 0f, 0f, 0f)
			{
				holdLastFrame = true,
				paused = true
			};
