...
namespace StardewValley.Minigames
{
	public class RobotBlastoff : IMinigame
	{
		...
		public bool tick(GameTime time)
		{
			...
			{
				smokeTimer = 350;
				tempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(143, 1828, 15, 20), 1500f, 4, 0, robotPosition + new Vector2(0f, 72f), false, false)
				{
			...
			{
				tempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(256, 1680, 16, 16), 80f, 5, 0, new Vector2(Game1.random.Next(Game1.graphics.GraphicsDevice.Viewport.Width), Game1.random.Next(Game1.graphics.GraphicsDevice.Viewport.Height / 2)), false, false, 1f, 0f, Color.White, 4f, 0f, 0f, 0f)
				{
