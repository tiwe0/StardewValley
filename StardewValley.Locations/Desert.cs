...
namespace StardewValley.Locations
{
	public class Desert : GameLocation
	{
		...
		{
			Utility.TryOpenShopMenu("DesertTrade", this);
		}
		...
		public override void UpdateWhenCurrentLocation(GameTime time)
		{
			...
			if (IsTravelingDesertMerchantHere())
			{
				...
				if (chimneyTimer <= 0)
				{
					...
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), smokeSpot, false, 0.002f, new Color(255, 222, 198))
					{
						alpha = 0.05f,
						alphaFade = -0.01f,
