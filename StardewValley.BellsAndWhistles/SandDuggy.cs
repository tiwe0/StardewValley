...
namespace StardewValley.BellsAndWhistles
{
	public class SandDuggy : INetObject<NetFields>
	{
		...
		public virtual int FindRandomFreePoint()
		{
			...
			{
				return Game1.random.ChooseFrom(valid_hole_locations);
			}
			return -1;
		}
		...
		public virtual void OnWhackedChanged(NetBool field, bool old_value, bool new_value)
		{
			...
			if (Game1.IsMasterGame)
			{
				...
				Game1.createItemDebris(ItemRegistry.Create("(O)73"), new Vector2(holeLocations[index].X, holeLocations[index].Y) * 64f, -1, locationRef.Value);
			}
