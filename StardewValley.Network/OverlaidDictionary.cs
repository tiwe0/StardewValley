...
namespace StardewValley.Network
{
	...
	public class OverlaidDictionary : IEnumerable<SerializableDictionary<Vector2, Object>>, IEnumerable
	{
		...
		public Object this[Vector2 key]
		{
			...
			{
				Object overlaid;
				if (overlayDict.TryGetValue(key, out overlaid))
				{
					return overlaid;
				}
				Object o;
				if (_locked && _changes.TryGetValue(key, out o))
				{
					if (o == null)
					{
		...
		{
			Object o;
			if (overlayDict.TryGetValue(key, out o))
			{
				compositeDict[key] = o;
			}
		...
		public OverlaidDictionary(NetVector2Dictionary<Object, NetRef<Object>> baseDict, OverlayDictionary<Vector2, Object> overlayDict)
		{
			...
			{
				OnValueAdded(pair2.Key, pair2.Value);
			}
		...
		public void Add(Vector2 key, Object value)
		{
			if (_locked)
			{
				...
				if (_changes.TryGetValue(key, out existingValue))
				{
		...
		{
			Object value;
			if (_locked && _changes.TryGetValue(key, out value))
			{
				return value != null;
			}
		...
		public bool Remove(Vector2 key)
		{
			...
			{
				Object value;
				if (_changes.TryGetValue(key, out value))
				{
					_changes[key] = null;
					return value != null;
				}
