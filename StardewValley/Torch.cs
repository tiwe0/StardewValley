...
namespace StardewValley
{
	public class Torch : Object
	{
		...
		public override bool checkForAction(Farmer who, bool justCheckingForActivity = false)
		{
			if ((bool)bigCraftable)
			{
				...
				if (base.QualifiedItemId == "(BC)278")
				{
					...
					Game1.activeClickableMenu = new CraftingPage((int)center.X, (int)center.Y, 800 + IClickableMenu.borderWidth * 2, 600 + IClickableMenu.borderWidth * 2, true, true);
					return true;
				}
				isOn.Value = !isOn;
				if ((bool)isOn)
		...
		public override bool placementAction(GameLocation location, int x, int y, Farmer who)
		{
			...
			Torch toPlace = (bigCraftable ? new Torch(base.ItemId, true) : new Torch(1, base.ItemId));
			if ((bool)bigCraftable)
			{
		...
		public override void draw(SpriteBatch spriteBatch, int x, int y, float alpha = 1f)
		{
			...
			if (ItemContextTagManager.HasBaseTag(base.QualifiedItemId, "campfire_item"))
			{
				...
				if (base.QualifiedItemId == "(BC)278")
				{
					...
					Rectangle r = itemData2.GetSourceRect(1, base.ParentSheetIndex).Clone();
					r.Height -= 16;
					...
					spriteBatch.Draw(itemData2.GetTexture(), destination, r, Color.White * alpha, 0f, Vector2.Zero, SpriteEffects.None, draw_layer + 0.0028f);
				}
			}
			else
			{
