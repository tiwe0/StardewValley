...
namespace StardewValley.Quests
{
	public class ItemDeliveryQuest : Quest
	{
		...
		public void loadQuestInfo()
		{
			...
			{
				string rawId = Utility.getRandomItemFromSeason(Game1.season, 1000, true);
				if (!(rawId == "-5"))
				{
					if (rawId == "-6")
					{
				...
				if ((item as Object)?.Type == "Cooking" && target.Value != "Wizard")
				{
					if (random.NextDouble() < 0.33)
					{
						...
						parts.Clear();
						parts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs." + random.Choose("13333", "13334"), item, random.ChooseFrom(questStrings2)));
						parts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs.13620", actualTarget));
					}
					else
					{
						...
						{
						case 0:
							day = new DescriptionElement("Strings\\StringsFromCSFiles:Game1.cs.3042");
							break;
						case 1:
							day = new DescriptionElement("Strings\\StringsFromCSFiles:Game1.cs.3043");
							break;
						case 2:
							day = new DescriptionElement("Strings\\StringsFromCSFiles:Game1.cs.3044");
							break;
						case 3:
							day = new DescriptionElement("Strings\\StringsFromCSFiles:Game1.cs.3045");
							break;
						case 4:
							day = new DescriptionElement("Strings\\StringsFromCSFiles:Game1.cs.3046");
							break;
						case 5:
							day = new DescriptionElement("Strings\\StringsFromCSFiles:Game1.cs.3047");
							break;
						default:
							day = new DescriptionElement("Strings\\StringsFromCSFiles:Game1.cs.3048");
							break;
						}
					...
					parts.Clear();
					int rand5 = random.Next(questDescriptions.Length);
					parts.Add(questDescriptions[rand5]);
					parts.Add(questDescriptions2[rand5]);
					parts.Add(questDescriptions3[rand5]);
				...
				else
				{
					if (random.NextBool())
					{
						...
						if (obj != null && obj.Edibility > 0)
						{
							...
							{
								parts.Clear();
								int rand4 = random.Next(questDescriptions.Length);
								parts.Add(questDescriptions[rand4]);
								parts.Add(questDescriptions2[rand4]);
								parts.Add(questDescriptions3[rand4]);
							}
							switch (target.Value)
							{
							case "Demetrius":
					...
					parts.Add(questDescriptions[rand3]);
					parts.Add(questDescriptions2[rand3]);
					parts.Add(questDescriptions3[rand3]);
				}
			}
			goto IL_13f8;
			IL_13f8:
			...
			case "Abigail":
			{
				bool rand2 = random.NextBool();
				parts.Clear();
				parts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs." + (rand2 ? "13590" : "13593"), item));
				dialogueparts.Clear();
				dialogueparts.Add(new DescriptionElement("Strings\\StringsFromCSFiles:ItemDeliveryQuest.cs." + (rand2 ? "13597" : "13599")));
				break;
			}
			case "Sebastian":
				dialogueparts.Clear();
		...
		public override void reloadDescription()
		{
			...
			else if (HasId())
			{
				...
				targetMessage = ArgUtility.Get(fields, 9, targetMessage, false);
			}
		}
