	...
	public class SparklingText
	{
		...
		public bool update(GameTime time)
		{
			...
			if (millisecondsDuration > 500 && Game1.random.NextDouble() < sparkleFrequency)
			{
				...
				sparkles.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 704, 64, 64), speed / 6, 6, 0, new Vector2(Game1.random.Next(boundingBox.X, boundingBox.Right), Game1.random.Next(boundingBox.Y, boundingBox.Bottom)), false, false, layerDepth, 0f, rainbow ? color : sparkleColor, 1f, 0f, 0f, 0f));
			}
