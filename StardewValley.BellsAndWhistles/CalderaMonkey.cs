		...
		public override bool update(GameTime time, GameLocation environment)
		{
			...
			case 1:
				if (nextFrameTimer <= 0f)
				{
					...
					environment.TemporarySprites.Add(new TemporaryAnimatedSprite("TileSheets\\animations", new Rectangle(0, 0, 64, 64), 150f, 3, 0, position + new Vector2((currentFrame == 2) ? 32 : (-8), 48f), false, Game1.random.NextBool(), 0.001f, 0.02f, Color.White, 0.75f, 0.003f, 0f, 0f));
				}
				break;
			case 2:
				setFrame(4);
