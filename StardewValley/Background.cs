	...
	public class Background
	{
		...
		public virtual void draw(SpriteBatch b)
		{
			if (summitBG)
			{
				...
				{
					Random r2 = new Random((int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds - Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 1000.0));
					for (int l = 0; l < 20; l++)
					{
						Texture2D t = r2.Choose<Texture2D>(Game1.mouseCursors, Game1.mouseCursors2, Game1.objectSpriteSheet, Game1.menuTexture, Game1.uncoloredMenuTexture, Game1.mouseCursors_1_6, Game1.bigCraftableSpriteSheet, Game1.cropSpriteSheet);
						b.Draw(t, new Vector2(r2.Next(Game1.viewport.Width) - 100, r2.Next(Game1.viewport.Height) - 100) + new Vector2((float)(int)(Game1.currentGameTime.TotalGameTime.TotalMilliseconds % 1000.0) * 0.03f), new Microsoft.Xna.Framework.Rectangle(r2.Next(t.Width / 16) * 16, r2.Next(t.Height / 16) * 16, 16, 16), Utility.getRandomRainbowColor(r2), 0f, Vector2.Zero, 4f, SpriteEffects.None, 1E-06f);
					}
				}
				return;
			}
