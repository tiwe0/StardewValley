...
namespace StardewValley.Menus
{
	public class TitleMenu : IClickableMenu, IDisposable
	{
		...
		public static IClickableMenu subMenu
		{
			...
			set
			{
				if (_subMenu != null)
				{
					...
					IDisposable disposable = _subMenu as IDisposable;
					if (disposable != null && !subMenu.HasDependencies())
					{
						disposable.Dispose();
					}
				}
			...
			: base(0, 0, Game1.uiViewport.Width, Game1.uiViewport.Height)
		{
			...
			birds.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(296, 227, 26, 21), new Vector2(width - 210, height - 390), false, 0f, Color.White)
			{
				scale = 3f,
				pingPong = true,
				animationLength = 4,
			...
			birds.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(296, 227, 26, 21), new Vector2(width - 120, height - 360), false, 0f, Color.White)
			{
				scale = 3f,
				pingPong = true,
				animationLength = 4,
		...
		public void setUpIcons()
		{
			...
			buttons.Add(new ClickableTextureComponent("New", new Rectangle(curx, height - 174 - 24, buttonWidth * 3, 174), null, "", titleButtonsTexture, new Rectangle(0, 187, 74, 58), 3f)
			{
				myID = 81115,
			...
			buttons.Add(new ClickableTextureComponent("Load", new Rectangle(curx, height - 174 - 24, 222, 174), null, "", titleButtonsTexture, new Rectangle(74, 187, 74, 58), 3f)
			{
				myID = 81116,
			...
			curx += (buttonWidth + 8) * 3;
			buttons.Add(new ClickableTextureComponent("Co-op", new Rectangle(curx, height - 174 - 24, 222, 174), null, "", titleButtonsTexture, new Rectangle(148, 187, 74, 58), 3f)
			{
				myID = 81119,
			...
			curx += (buttonWidth + 8) * 3;
			buttons.Add(new ClickableTextureComponent("Exit", new Rectangle(curx, height - 174 - 24, 222, 174), null, "", titleButtonsTexture, new Rectangle(222, 187, 74, 58), 3f)
			{
				myID = 81117,
		...
		public override void receiveGamePadButton(Buttons b)
		{
			...
			if (subMenu != null)
			{
				LoadGameMenu loadGameMenu = subMenu as LoadGameMenu;
				if (loadGameMenu != null && loadGameMenu.deleteConfirmationScreen)
				{
					passThrough = false;
				}
				CharacterCustomization customizationMenu = subMenu as CharacterCustomization;
				if (customizationMenu != null && customizationMenu.showingCoopHelp)
				{
					passThrough = false;
				}
		...
		public void backButtonPressed()
		{
			...
			TitleTextInputMenu titleTextInputMenu = subMenu as TitleTextInputMenu;
			if ((titleTextInputMenu != null && titleTextInputMenu.context == "join_menu") || subMenu is FarmhandMenu)
			{
				buttonsDX = 0;
				((CoopMenu)(subMenu = new CoopMenu(false))).SetTab(CoopMenu.Tab.JOIN_TAB, false);
				if (Game1.options.SnappyMenus)
				{
					subMenu.snapToDefaultClickableComponent();
				}
			...
			{
				buttonsDX = 0;
				((CoopMenu)(subMenu = new CoopMenu(false))).SetTab(CoopMenu.Tab.HOST_TAB, false);
		...
		public override void receiveLeftClick(int x, int y, bool playSound = true)
		{
			...
			if (logoFadeTimer > 0 && skipButton.containsPoint(x, y))
			{
			...
			if (!alternativeTitleGraphic())
			{
				...
				if (titleInPosition && eRect.Contains(x, y) && clicksOnE < 10)
				{
					...
					if (clicksOnE == 10)
					{
						int zoom4 = (ShouldShrinkLogo() ? 2 : 3);
						Game1.playSound("openChest");
						tempSprites.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(0, 491, 42, 68), new Vector2(width / 2 - 200 * zoom4 + 251 * zoom4, -300 * zoom4 - (int)(viewportY / 3f) * zoom4 + 26 * zoom4), false, 0f, Color.White)
						{
							scale = zoom4,
							animationLength = 9,
							interval = 200f,
				...
				else if (titleInPosition)
				{
					...
					if (Game1.content.GetCurrentLanguage() != LocalizedContentManager.LanguageCode.zh)
					{
						...
						{
							int zoom3 = (ShouldShrinkLogo() ? 2 : 3);
							cornerClicks++;
							if (cornerClicks > 5)
							{
							...
							else
							{
								...
								for (int j = 0; j < 3; j++)
								{
									tempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(280 + Game1.random.Choose(8, 0), 1954, 8, 8), 1000f, 1, 99, new Vector2(width / 2 - 190 * zoom3, -300 * zoom3 - (int)(viewportY / 3f) * zoom3 + 175 * zoom3), false, false, 1f, 0f, Color.White, 3f, 0f, 0f, (float)Game1.random.Next(-10, 11) / 100f)
									{
					...
					if (clicked)
					{
						...
						if (clicksOnLeaf == 10)
						{
							int zoom2 = (ShouldShrinkLogo() ? 2 : 3);
							Game1.playSound("discoverMineral");
							tempSprites.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(264, 464, 16, 16), new Vector2(width / 2 - 200 * zoom2 + 80 * zoom2, -300 * zoom2 - (int)(viewportY / 3f) * zoom2 + 10 * zoom2 + 2), false, 0f, Color.White)
							{
								scale = zoom2,
								animationLength = 8,
								interval = 80f,
							...
							tempSprites.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(136, 448, 16, 16), new Vector2(width / 2 - 200 * zoom2 + 80 * zoom2, -300 * zoom2 - (int)(viewportY / 3f) * zoom2 + 10 * zoom2), false, 0f, Color.White)
							{
								scale = zoom2,
								animationLength = 8,
								interval = 50f,
							...
							tempSprites.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(200, 464, 16, 16), new Vector2(width / 2 - 200 * zoom2 + 178 * zoom2, -300 * zoom2 - (int)(viewportY / 3f) * zoom2 + 141 * zoom2 + 2), false, 0f, Color.White)
							{
								scale = zoom2,
								animationLength = 4,
								interval = 150f,
							...
							tempSprites.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(136, 448, 16, 16), new Vector2(width / 2 - 200 * zoom2 + 178 * zoom2, -300 * zoom2 - (int)(viewportY / 3f) * zoom2 + 141 * zoom2), false, 0f, Color.White)
							{
								scale = zoom2,
								animationLength = 8,
								interval = 50f,
							...
							tempSprites.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(136, 464, 16, 16), new Vector2(width / 2 - 200 * zoom2 + 294 * zoom2, -300 * zoom2 - (int)(viewportY / 3f) * zoom2 + 89 * zoom2 + 2), false, 0f, Color.White)
							{
								scale = zoom2,
								animationLength = 4,
								interval = 150f,
							...
							tempSprites.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(136, 448, 16, 16), new Vector2(width / 2 - 200 * zoom2 + 294 * zoom2, -300 * zoom2 - (int)(viewportY / 3f) * zoom2 + 89 * zoom2), false, 0f, Color.White)
							{
								scale = zoom2,
								animationLength = 8,
								interval = 50f,
		...
		private void addRightLeafGust()
		{
			...
			{
				int zoom = (ShouldShrinkLogo() ? 2 : 3);
				tempSprites.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(296, 187, 27, 21), new Vector2(width / 2 - 200 * zoom + 327 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(107 * zoom)), false, 0f, Color.White)
				{
					scale = zoom,
					pingPong = true,
					animationLength = 3,
		...
		private void addLeftLeafGust()
		{
			...
			{
				int zoom = (ShouldShrinkLogo() ? 2 : 3);
				tempSprites.Add(new TemporaryAnimatedSprite("Minigames\\TitleButtons", new Rectangle(296, 208, 22, 18), new Vector2(width / 2 - 200 * zoom + 16 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(16 * zoom)), false, 0f, Color.White)
				{
					scale = zoom,
					pingPong = true,
					animationLength = 3,
		...
		public override void update(GameTime time)
		{
			...
			if (titleInPosition)
			{
				...
				if (cornerClickParrotTimer > 0f)
				{
					...
					{
						int zoom = (ShouldShrinkLogo() ? 2 : 3);
						behindSignTempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(120, 0, 24, 24), 100f, 3, 999, new Vector2(globalXOffset + width / 2 - 200 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(100 * zoom)), false, false, 0.2f, 0f, Color.White, zoom, 0.01f, 0f, 0f, true)
						{
							pingPong = true,
							motion = new Vector2(-6f, -1f),
							acceleration = new Vector2(0.02f, 0.02f)
						});
						behindSignTempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(120, 48, 24, 24), 95f, 3, 999, new Vector2(globalXOffset + width / 2 - 200 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(120 * zoom)), false, false, 0.2f, 0f, Color.White, zoom, 0.01f, 0f, 0f, true)
						{
							pingPong = true,
							motion = new Vector2(-6f, -1f),
							acceleration = new Vector2(0.02f, 0.02f),
						...
						behindSignTempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(120, 24, 24, 24), 100f, 3, 999, new Vector2(globalXOffset + width / 2 - 200 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(100 * zoom)), false, false, 0.2f, 0f, Color.White, zoom, 0.01f, 0f, 0f, true)
						{
							pingPong = true,
							motion = new Vector2(-6f, -1f),
							acceleration = new Vector2(0.02f, 0.02f),
						...
						behindSignTempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(120, 72, 24, 24), 95f, 3, 999, new Vector2(globalXOffset + width / 2 - 200 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(120 * zoom)), false, false, 0.2f, 0f, Color.White, zoom, 0.01f, 0f, 0f, true)
						{
							pingPong = true,
							motion = new Vector2(-6f, -1f),
							acceleration = new Vector2(0.02f, 0.02f),
						...
						behindSignTempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(120, 0, 24, 24), 100f, 3, 999, new Vector2(globalXOffset + width / 2 + 200 * zoom - 24 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(100 * zoom)), false, true, 0.2f, 0f, Color.White, zoom, 0.01f, 0f, 0f, true)
						{
							pingPong = true,
							motion = new Vector2(6f, -1f),
							acceleration = new Vector2(-0.02f, -0.02f),
						...
						behindSignTempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(120, 48, 24, 24), 95f, 3, 999, new Vector2(globalXOffset + width / 2 + 200 * zoom - 24 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(120 * zoom)), false, true, 0.2f, 0f, Color.White, zoom, 0.01f, 0f, 0f, true)
						{
							pingPong = true,
							motion = new Vector2(6f, -1f),
							acceleration = new Vector2(-0.02f, -0.02f),
						...
						behindSignTempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(120, 24, 24, 24), 100f, 3, 999, new Vector2(globalXOffset + width / 2 + 200 * zoom - 24 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(100 * zoom)), false, true, 0.2f, 0f, Color.White, zoom, 0.01f, 0f, 0f, true)
						{
							pingPong = true,
							motion = new Vector2(6f, -1f),
							acceleration = new Vector2(-0.02f, -0.02f),
						...
						behindSignTempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\parrots", new Rectangle(120, 72, 24, 24), 95f, 3, 999, new Vector2(globalXOffset + width / 2 + 200 * zoom - 24 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(120 * zoom)), false, true, 0.2f, 0f, Color.White, zoom, 0.01f, 0f, 0f, true)
						{
							pingPong = true,
							motion = new Vector2(6f, -1f),
							acceleration = new Vector2(-0.02f, -0.02f),
						...
						{
							tempSprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Rectangle(355, 1199, 16, 16), new Vector2(globalXOffset + width / 2 - 220 * zoom, (float)(-300 * zoom) - viewportY / 3f * (float)zoom + (float)(60 * zoom) + (float)(Game1.random.Next(100) * zoom)), Game1.random.NextBool(), 0f, new Color(180, 180, 240))
							{
								scale = zoom,
								animationLength = 11,
								interval = 50 + Game1.random.Next(50),
		...
		public override void draw(SpriteBatch b)
		{
			...
			{
				for (int x4 = -10; x4 < width; x4 += 638)
				{
					b.Draw(Game1.mouseCursors, new Vector2(x4 * 3, -1080f - viewportY * 0.66f), new Rectangle(0, 1453, 638, 195), Color.White * (1f - (float)globalXOffset / 1200f), 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.8f);
				}
			}
			...
			for (int y3 = 0; y3 < height; y3 += 195)
			{
				for (int x = 0; x < width; x += 638)
				{
					b.Draw(Game1.mouseCursors, new Vector2(x, y3) * 4f, new Rectangle(0, 1453, 638, 195), Color.White * ((float)globalXOffset / 1200f), 0f, Vector2.Zero, 4f, effect, 0.8f);
				}
			...
			else if (subMenu == null && isTransitioningButtons && (whichSubMenu.Equals("Load") || whichSubMenu.Equals("New")))
			{
				...
				SpriteText.drawStringWithScrollBackground(b, Game1.content.LoadString("Strings\\StringsFromCSFiles:Game1.cs.3689"), x3, y2);
			}
			...
			else if (logoFadeTimer > 0 || fadeFromWhiteTimer > 0)
			{
				...
				if (specialSurprised)
				{
					...
					for (int x2 = 64; x2 < width + 1000; x2 += 192)
					{
						for (int y = -1000; y < height; y += 192)
						{
							b.Draw(Game1.mouseCursors, new Vector2(x2, y) + new Vector2((float)(-time) / 20f, (float)time / 20f), new Rectangle(355 + (time + x2 * 77 + y * 77) / 12 % 110 / 11 * 16, 1200, 16, 16), Color.White * 0.66f * ((float)(fadeFromWhiteTimer - (2000 - fadeFromWhiteTimer)) / 2000f), 0f, Vector2.Zero, 3f, SpriteEffects.None, 0.18f);
						}
					}
					b.Draw(titleButtonsTexture, new Vector2(width / 2, height / 2 - 90), new Rectangle(171 + ((time / 200 % 2 == 0) ? 111 : 0), 563, 111, 60), Color.White * ((float)(fadeFromWhiteTimer - (2000 - fadeFromWhiteTimer)) / 2000f), 0f, Vector2.Zero, 3f, SpriteEffects.None, 0.2f);
					specialSurprisedTimeStamp += (float)Game1.currentGameTime.ElapsedGameTime.TotalSeconds;
					Utility.drawWithShadow(b, titleButtonsTexture, new Vector2(width / 2 - 261, height / 2 - 102), new Rectangle((time / 200 % 2 == 0) ? 85 : 0, 559, 85, 69), Color.White * ((float)(fadeFromWhiteTimer - (2000 - fadeFromWhiteTimer)) / 2000f), 0f, Vector2.Zero, 3f, false, 0.2f, -4, -4, 0f);
				}
			...
			{
				int whichCursor = -1;
				if (subMenu != null && subMenu is LoadGameMenu)
				{
					whichCursor = ((subMenu as LoadGameMenu).IsDoingTask() ? 1 : (-1));
				}
				drawMouse(b, false, whichCursor);
		...
		private void showButterflies()
		{
			...
			int zoom = (ShouldShrinkLogo() ? 2 : 3);
			tempSprites.Add(new TemporaryAnimatedSprite("TileSheets\\critters", new Rectangle(128, 96, 16, 16), new Vector2(width / 2 - 240 * zoom, -300 * zoom - (int)(viewportY / 3f) * zoom + 86 * zoom), false, 0f, Color.White)
			{
				scale = zoom,
				animationLength = 4,
				totalNumberOfLoops = 999999,
			...
			TemporaryAnimatedSpriteList i = Utility.sparkleWithinArea(new Rectangle(width / 2 - 240 * zoom - 8 * zoom, -300 * zoom - (int)(viewportY / 3f) * zoom + 86 * zoom - 8 * zoom, 80, 64), 2, Color.White * 0.75f);
			foreach (TemporaryAnimatedSprite item in i)
			{
				item.local = true;
				item.scale = (float)zoom / 4f;
			}
			tempSprites.AddRange(i);
			tempSprites.Add(new TemporaryAnimatedSprite("TileSheets\\critters", new Rectangle(192, 96, 16, 16), new Vector2(width / 2 + 220 * zoom, -300 * zoom - (int)(viewportY / 3f) * zoom + 15 * zoom), false, 0f, Color.White)
			{
				scale = zoom,
				animationLength = 4,
				totalNumberOfLoops = 999999,
			...
			i = Utility.sparkleWithinArea(new Rectangle(width / 2 + 220 * zoom - 8 * zoom, -300 * zoom - (int)(viewportY / 3f) * zoom + 15 * zoom - 8 * zoom, 80, 64), 2, Color.White * 0.75f);
			...
			tempSprites.AddRange(i);
			tempSprites.Add(new TemporaryAnimatedSprite("TileSheets\\critters", new Rectangle(256, 96, 16, 16), new Vector2(width / 2 - 250 * zoom, -300 * zoom - (int)(viewportY / 3f) * zoom + 35 * zoom), false, 0f, Color.White)
			{
				scale = zoom,
				animationLength = 4,
				totalNumberOfLoops = 999999,
			...
			i = Utility.sparkleWithinArea(new Rectangle(width / 2 - 250 * zoom - 8 * zoom, -300 * zoom - (int)(viewportY / 3f) * zoom + 35 * zoom - 8 * zoom, 80, 64), 2, Color.White * 0.75f);
			...
			tempSprites.AddRange(i);
			tempSprites.Add(new TemporaryAnimatedSprite("TileSheets\\critters", new Rectangle(256, 112, 16, 16), new Vector2(width / 2 + 250 * zoom, -300 * zoom - (int)(viewportY / 3f) * zoom + 60 * zoom), false, 0f, Color.White)
			{
				scale = zoom,
				animationLength = 4,
				totalNumberOfLoops = 999999,
			...
			i = Utility.sparkleWithinArea(new Rectangle(width / 2 + 250 * zoom - 8 * zoom, -300 * zoom - (int)(viewportY / 3f) * zoom + 60 * zoom - 8 * zoom, 80, 64), 2, Color.White * 0.75f);
