...
namespace StardewValley.Menus
{
	public class StorageContainer : MenuWithInventory
	{
			...
			: base(highlightMethod, true, true)
		{
			...
			ItemsToGrabMenu = new InventoryMenu(Game1.uiViewport.Width / 2 - containerWidth / 2, yPositionOnScreen + 64, false, inventory, null, capacity, rows);
		...
		public override void gameWindowSizeChanged(Rectangle oldBounds, Rectangle newBounds)
		{
			...
			ItemsToGrabMenu = new InventoryMenu(Game1.uiViewport.Width / 2 - containerWidth / 2, yPositionOnScreen + 64, false, ItemsToGrabMenu.actualInventory, null, ItemsToGrabMenu.capacity, ItemsToGrabMenu.rows);
		}
		...
		public override void receiveLeftClick(int x, int y, bool playSound = true)
		{
			...
			if (ItemsToGrabMenu.isWithinBounds(x, y))
			{
				...
				if ((base.heldItem != null && old == null) || (base.heldItem != null && old != null && !base.heldItem.Equals(old)))
				{
					...
					{
						sound = itemChangeBehavior(base.heldItem, ItemsToGrabMenu.getInventoryPositionOfClick(x, y), old, this, true);
					}
					if (sound)
					{
		...
		public override void receiveRightClick(int x, int y, bool playSound = true)
		{
			...
			{
				itemChangeBehavior?.Invoke(base.heldItem, ItemsToGrabMenu.getInventoryPositionOfClick(x, y), old, this, true);
				Game1.playSound("dwop");
			}
			if ((base.heldItem == null && old != null) || (base.heldItem != null && old != null && !base.heldItem.Equals(old)))
			{
