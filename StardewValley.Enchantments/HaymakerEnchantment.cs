	...
	public class HaymakerEnchantment : BaseWeaponEnchantment
	{
		...
		protected override void _OnCutWeed(Vector2 tile_location, GameLocation location, Farmer who)
		{
			...
			if (Game1.random.NextDouble() < 0.33)
			{
				...
				{
					TemporaryAnimatedSprite tmpSprite = new TemporaryAnimatedSprite("Maps\\springobjects", Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, 178, 16, 16), 750f, 1, 0, who.Position - new Vector2(0f, 128f), false, false, who.Position.Y / 10000f, 0.005f, Color.White, 4f, -0.005f, 0f, 0f);
