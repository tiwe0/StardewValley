	...
	public class Forest : GameLocation
	{
		...
		public override void MakeMapModifications(bool force = false)
		{
			...
			if (Game1.IsSummer && Game1.dayOfMonth >= 20 && Game1.dayOfMonth <= 21)
			{
				...
				{
					NPC npc10 = getCharacterFromName("derby_contestent0");
					npc10.drawOffset = new Vector2(0f, 96f);
					npc10.shouldShadowBeOffset = true;
					if (npc10.Sprite == null || npc10.Sprite.Texture == null)
					{
						npc10.Sprite = new AnimatedSprite("Characters\\Assorted_Fishermen", 0, 16, 64);
					}
				...
				{
					NPC npc9 = getCharacterFromName("derby_contestent1");
					npc9.drawOffset = new Vector2(0f, 96f);
					npc9.shouldShadowBeOffset = true;
					if (npc9.Sprite == null || npc9.Sprite.Texture == null)
					{
						npc9.Sprite = new AnimatedSprite("Characters\\Assorted_Fishermen", 2, 16, 64);
					}
					npc9.Sprite.CurrentFrame = 2;
				...
				{
					NPC npc8 = getCharacterFromName("derby_contestent2");
					if (npc8.Sprite == null || npc8.Sprite.Texture == null)
					{
						npc8.Sprite = new AnimatedSprite("Characters\\Assorted_Fishermen", 3, 16, 64);
					}
					npc8.Sprite.CurrentFrame = 3;
				...
				{
					NPC npc7 = getCharacterFromName("derby_contestent3");
					if (npc7.Sprite == null || npc7.Sprite.Texture == null)
					{
						npc7.Sprite = new AnimatedSprite("Characters\\Assorted_Fishermen", 1, 16, 64);
					}
					npc7.Sprite.CurrentFrame = 1;
					npc7.drawOffset = new Vector2(0f, 96f);
				...
				{
					NPC npc6 = getCharacterFromName("derby_contestent4");
					if (npc6.Sprite == null || npc6.Sprite.Texture == null)
					{
						npc6.Sprite = new AnimatedSprite("Characters\\Assorted_Fishermen", 2, 32, 64);
					}
					npc6.Sprite.CurrentFrame = 2;
					npc6.drawOffset = new Vector2(0f, 96f);
				...
				{
					NPC npc5 = getCharacterFromName("derby_contestent5");
					if (npc5.Sprite == null || npc5.Sprite.Texture == null)
					{
						npc5.Sprite = new AnimatedSprite("Characters\\Assorted_Fishermen", 8, 32, 32);
					}
					npc5.Sprite.CurrentFrame = 8;
				...
				{
					NPC npc4 = getCharacterFromName("derby_contestent6");
					if (npc4.Sprite == null || npc4.Sprite.Texture == null)
					{
						npc4.Sprite = new AnimatedSprite("Characters\\Assorted_Fishermen", 9, 32, 32);
					}
					npc4.Sprite.CurrentFrame = 9;
				...
				{
					NPC npc3 = getCharacterFromName("derby_contestent7");
					if (npc3.Sprite == null || npc3.Sprite.Texture == null)
					{
						npc3.Sprite = new AnimatedSprite("Characters\\Assorted_Fishermen", 10, 32, 32);
					}
					npc3.Sprite.CurrentFrame = 10;
				...
				{
					NPC npc2 = getCharacterFromName("derby_contestent8");
					if (npc2.Sprite == null || npc2.Sprite.Texture == null)
					{
						npc2.Sprite = new AnimatedSprite("Characters\\Assorted_Fishermen", 11, 32, 32);
					}
					npc2.Sprite.CurrentFrame = 11;
		...
		private void showCommunityUpgradeShortcuts()
		{
			...
			warps.Add(new Warp(120, 35, "Beach", 0, 6, false));
			warps.Add(new Warp(120, 36, "Beach", 0, 6, false));
		}
		...
		protected override void resetSharedState()
		{
			...
			if (Game1.MasterPlayer.mailReceived.Contains("raccoonMovedIn"))
			{
				...
				{
					characters.Add(new Raccoon(true));
				}
			}
		}
		...
		{
			Point tile;
			if (!TryGetMapPropertyAs("TravelingCartPosition", out tile, false))
			{
			...
			if (IsSpringHere())
			{
				for (int j = 0; j < 7; j++)
				{
					...
					foreach (Vector2 v in Utility.recursiveFindOpenTiles(this, origin, 16))
					{
						...
						{
							terrainFeatures.Add(v, new HoeDirt(0, new Crop(true, "1", (int)v.X, (int)v.Y, this)));
						}
					}
				}
			}
		...
		public override void UpdateWhenCurrentLocation(GameTime time)
		{
			...
			if (travelingMerchantDay)
			{
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(99, 1423, 13, 19), new Vector2(cartOrigin.X * 64, cartOrigin.Y * 64 + 32 - 4), false, 0f, Color.White)
					{
				...
				if (Game1.random.NextDouble() < 0.001)
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(51, 1444, 5, 5), new Vector2(cartOrigin.X * 64 + 32 - 4, (cartOrigin.Y + 1) * 64 + 32 + 8), false, 0f, Color.White)
					{
						interval = 500f,
						animationLength = 1,
						layerDepth = 0.07682f,
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(89, 1445, 6, 3), new Vector2((cartOrigin.X + 4) * 64 + 32 + 4, cartOrigin.Y * 64 + 24), false, 0f, Color.White)
					{
						interval = 50f,
						animationLength = 3,
						pingPong = true,
			...
			if (chimneyTimer <= 0)
			{
				...
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), smokeSpot, false, 0.002f, Color.Gray)
				{
					alpha = 0.75f,
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(372, 1956, 10, 10), new Vector2(57.33f, 1.75f) * 64f, false, 0.002f, Color.Gray)
					{
						alpha = 0.75f,
						motion = new Vector2(0f, -0.5f),
						acceleration = new Vector2(0.002f, 0f),
				...
				if (travelingMerchantDay)
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(225, 1388, 7, 5), new Vector2((cartOrigin.X + 6) * 64 + 12, (cartOrigin.Y - 2) * 64 + 24), false, 0f, Color.White)
					{
		...
		public override void performTenMinuteUpdate(int timeOfDay)
		{
			...
			{
				temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(57, 1430, 4, 12), new Vector2(1792f, 656f), false, 0f, Color.White)
				{
					interval = 50f,
					animationLength = 10,
					pingPong = true,
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite("LooseSprites\\Cursors", new Microsoft.Xna.Framework.Rectangle(89, 1445, 6, 3), new Vector2(1764f, 664f), false, 0f, Color.White)
					{
						interval = 50f,
						animationLength = 3,
						pingPong = true,
			...
			NPC i = getCharacterFromName("derby_contestent" + r.Next(10));
			if (i == null)
			{
				return;
			}
			...
			if (r.NextBool(0.25))
			{
				...
				{
					temporarySprites.Add(new TemporaryAnimatedSprite(138, 1500f, 1, 1, i.Position, false, false, false, 0f)
					{
