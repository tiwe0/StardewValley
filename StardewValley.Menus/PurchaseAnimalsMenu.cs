	...
	public class PurchaseAnimalsMenu : IClickableMenu
	{
		...
		public override void receiveLeftClick(int x, int y, bool playSound = true)
		{
			...
			if (onFarm)
			{
				...
				if (!namingAnimal)
				{
					AnimalHouse animalHouse = selection?.GetIndoors() as AnimalHouse;
					if (animalHouse != null && !selection.isUnderConstruction())
					{
		...
		public override void draw(SpriteBatch b)
		{
			...
			if (hovered != null)
			{
				...
				{
					string displayName = FarmAnimal.GetDisplayName(hovered.hoverText, true);
