	...
	public class Serpent : Monster
	{
		...
		protected override void localDeathAnimation()
		{
			...
			if (IsRoyalSerpent())
			{
				...
				for (int i = -1; i < segments.Count; i++)
				{
					...
					TemporaryAnimatedSprite current_sprite = new TemporaryAnimatedSprite(Sprite.textureName, source_rect, 800f, 1, 0, segment_position, false, false, 0.9f, 0.001f, segment_color, 4f * scale.Value, 0.01f, current_rotation + (float)Math.PI, (float)((double)Game1.random.Next(3, 5) * Math.PI / 64.0))
					{
					...
					current_sprite = new TemporaryAnimatedSprite(5, Utility.PointToVector2(bb.Center) + new Vector2(-32f, 0f), Color.LightGreen * 0.9f, 10, false, 70f)
					{
					...
					base.currentLocation.temporarySprites.Add(current_sprite);
					current_sprite = new TemporaryAnimatedSprite(5, Utility.PointToVector2(bb.Center) + new Vector2(32f, 0f), Color.LightGreen * 0.8f, 10, false, 70f)
					{
					...
					base.currentLocation.temporarySprites.Add(current_sprite);
					current_sprite = new TemporaryAnimatedSprite(5, Utility.PointToVector2(bb.Center), Color.LightGreen * 0.6f, 10, false, 70f)
					{
			...
			else
			{
				...
				base.currentLocation.localSound("serpentDie");
				base.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(Sprite.textureName, new Rectangle(0, 64, 32, 32), 200f, 4, 0, base.Position, false, false, 0.9f, 0.001f, Color.White, 4f * scale.Value, 0.01f, rotation + (float)Math.PI, (float)((double)Game1.random.Next(3, 5) * Math.PI / 64.0))
				{
					motion = new Vector2(xTrajectory, yTrajectory),
					layerDepth = 1f
				});
				base.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(5, standingPixel + new Vector2(-32f, 0f), Color.LightGreen * 0.9f, 10, false, 70f)
				{
					delayBeforeAnimationStart = 50,
					startSound = "cowboy_monsterhit",
					motion = new Vector2(xTrajectory, yTrajectory),
				...
				base.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(5, standingPixel + new Vector2(32f, 0f), Color.LightGreen * 0.8f, 10, false, 70f)
				{
					delayBeforeAnimationStart = 100,
					startSound = "cowboy_monsterhit",
					motion = new Vector2(xTrajectory, yTrajectory) * 0.8f,
				...
				base.currentLocation.temporarySprites.Add(new TemporaryAnimatedSprite(5, standingPixel, Color.LightGreen * 0.6f, 10, false, 70f)
				{
					delayBeforeAnimationStart = 200,
					startSound = "cowboy_monsterhit",
					motion = new Vector2(xTrajectory, yTrajectory) * 0.4f,
		...
		protected override void updateAnimation(GameTime time)
		{
			if (IsRoyalSerpent())
			{
				...
				{
					for (int j = 0; j < segmentCount.Value; j++)
					{
						Vector2 position = base.Position;
