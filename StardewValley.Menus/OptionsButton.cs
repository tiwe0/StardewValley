...
namespace StardewValley.Menus
{
	public class OptionsButton : OptionsElement
	{
		...
		public override void draw(SpriteBatch b, int slotX, int slotY, IClickableMenu context = null)
		{
			...
			IClickableMenu.drawTextureBox(b, Game1.mouseCursors, new Rectangle(432, 439, 9, 9), slotX + bounds.X, slotY + bounds.Y, bounds.Width, bounds.Height, Color.White * (greyedOut ? 0.33f : 1f), 4f, true, draw_layer);
